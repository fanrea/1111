...
public final class k1 {
    ...
    public static String d(Context context) {
        ...
        try {
            ...
            Method declaredMethod = wifiManager.getClass().getDeclaredMethod(new String(pbla.d("6765745363616e526573756c7473")), new Class[0]);
        ...
        for (i = 0; i < list.size() && i < 10; i++) {
            ...
            try {
                jSONObject.put("ss", q1.d(((ScanResult) list.get(i)).SSID));
                jSONObject.put("bs", q1.d(((ScanResult) list.get(i)).BSSID));
