...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2098deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2100deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int iHashCode = (bu.g + (strArr != null ? Arrays.hashCode(strArr) : 0)) * 31;
