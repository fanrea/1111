...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType get(String str) {
            ...
            while (iEnd < str.length()) {
                ...
                if (!matcher2.lookingAt()) {
                    ...
                    throw new IllegalArgumentException(sbAppend.append(strSubstring).append("\" for: \"").append(str).append('\"').toString().toString());
                }
        ...
        public final MediaType m2150deprecated_get(String mediaType) {
        ...
        public final MediaType m2151deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
