...
public final class Route {
    ...
    public Route(Address address, Proxy proxy, InetSocketAddress inetSocketAddress) {
        ...
        Intrinsics.checkNotNullParameter(proxy, c.t);
    ...
    public int hashCode() {
        return ((((bu.g + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
