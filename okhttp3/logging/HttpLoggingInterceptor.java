 ...
 */
    ...
    public interface a {
        public static final a EL = new a() { // from class: okhttp3.logging.HttpLoggingInterceptor.a.1
            @Override // okhttp3.logging.HttpLoggingInterceptor.a
            public final void log(String str) {
                e.hl().a(4, str, (Throwable) null);
            }
        };
    ...
    /* compiled from: HttpLoggingInterceptor.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\bf\u0018\u0000 \u00062\u00020\u0001:\u0001\u0006J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&\u0082\u0002\u0007\n\u0005\b\u0091F0\u0001¨\u0006\u0007"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "", com.baidu.mobads.container.components.j.a.b, "", cm.V, "", "Companion", "okhttp-logging-interceptor"}, k = 1, mv = {1, 1, 16})
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        String str3 = "--> " + request.method() + ' ' + request.url() + (connection != null ? " " + connection.protocol() : "");
        if (!z2 && requestBodyBody != null) {
            str3 = str3 + " (" + requestBodyBody.contentLength() + "-byte body)";
        }
        ...
        try {
            ...
            if (responseProceed.message().length() == 0) {
                ...
                str = "-byte body omitted)";
                c = ' ';
                str2 = String.valueOf(' ') + responseProceed.message();
            }
            logger.log(sbAppend.append(str2).append(c).append(responseProceed.request().url()).append(" (").append(millis).append("ms").append(!z2 ? ", " + str4 + " body" : "").append(')').toString());
            if (z2) {
