...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    static class AnonymousClass1 extends a {
        ...
        @Override // okhttp3.internal.a
        public final void setCache(Builder builder, f fVar) {
            builder.setInternalCache(fVar);
        }

        @Override // okhttp3.internal.a
        public final boolean connectionBecameIdle(ConnectionPool connectionPool, okhttp3.internal.connection.c cVar) {
            return connectionPool.connectionBecameIdle(cVar);
        }

        @Override // okhttp3.internal.a
        public final okhttp3.internal.connection.c get(ConnectionPool connectionPool, Address address, okhttp3.internal.connection.f fVar) {
            return connectionPool.get(address, fVar);
        }

        @Override // okhttp3.internal.a
        public final Socket deduplicate(ConnectionPool connectionPool, Address address, okhttp3.internal.connection.f fVar) {
            return connectionPool.deduplicate(address, fVar);
        }

        @Override // okhttp3.internal.a
        public final void put(ConnectionPool connectionPool, okhttp3.internal.connection.c cVar) {
            connectionPool.put(cVar);
        }

        @Override // okhttp3.internal.a
        public final d routeDatabase(ConnectionPool connectionPool) {
        ...
        @Override // okhttp3.internal.a
        public final okhttp3.internal.connection.f streamAllocation(Call call) {
    ...
    public final List<Interceptor> m2172deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m2173deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = c.t, imports = {}))
    ...
    public final SSLSocketFactory m2182deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m2164deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "protocols", imports = {}))
    /* renamed from: -deprecated_protocols, reason: not valid java name */
    public final List<Protocol> m2175deprecated_protocols() {
        return this.protocols;
    }
 ...
 */
    ...
    public static final class Builder {
        ...
        public final Builder m2184addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m2185addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder pingInterval(long interval, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            this.pingInterval = Util.checkDuration(MetricsSQLiteCacheKt.METRICS_INTERVAL, interval, unit);
            return this;
        }
