...
public final class Address {
    ...
    public final List<Protocol> m2074deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m2071deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public int hashCode() {
        return ((((((((((((((((((bu.g + this.url.hashCode()) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31) + Objects.hashCode(this.proxy)) * 31) + Objects.hashCode(this.sslSocketFactory)) * 31) + Objects.hashCode(this.hostnameVerifier)) * 31) + Objects.hashCode(this.certificatePinner);
    }
    ...
    public String toString() {
        ...
        return sbAppend2.append(sbAppend.append(obj).toString()).append(i.d).toString();
    }
}
