...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = cm.V, imports = {}))
    ...
    public final CacheControl m2192deprecated_cacheControl() {
        return cacheControl();
    }
