...
public final class ConnectionSpecSelector {
    ...
    public final ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException, CloneNotSupportedException {
        ...
        if (connectionSpec == null) {
            StringBuilder sbAppend = new StringBuilder().append("Unable to find acceptable protocols. isFallback=").append(this.isFallback).append(StringUtil.COMMA).append(" modes=").append(this.connectionSpecs).append(StringUtil.COMMA).append(" supported protocols=");
