...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response userResponse, String method) {
        ...
        if (!this.client.followRedirects() || (strHeader$default = Response.header$default(userResponse, AgentWebPermissions.ACTION_LOCATION, null, 2, null)) == null || (httpUrlResolve = userResponse.request().url().resolve(strHeader$default)) == null) {
            return null;
        }
