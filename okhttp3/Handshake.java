...
public final class Handshake {
    ...
    public final List<Certificate> m2115deprecated_peerCertificates() {
    ...
    public final Principal m2116deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m2113deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m2114deprecated_localPrincipal() {
    ...
    public int hashCode() {
        return ((((((bu.g + this.tlsVersion.hashCode()) * 31) + this.cipherSuite.hashCode()) * 31) + peerCertificates().hashCode()) * 31) + this.localCertificates.hashCode();
    }
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder().append("Handshake{").append("tlsVersion=").append(this.tlsVersion).append(' ').append("cipherSuite=").append(this.cipherSuite).append(' ').append("peerCertificates=").append(arrayList.toString()).append(' ').append("localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake m2118deprecated_get(SSLSession sslSession) throws IOException {
