...
public abstract class CronetProvider {
    ...
    private static final String JAVA_CRONET_PROVIDER_CLASS = "aegon.chrome.net.impl.JavaCronetProvider";
    private static final String NATIVE_CRONET_PROVIDER_CLASS = "aegon.chrome.net.impl.NativeCronetProvider";
