...
public abstract class Completable implements CompletableSource {
    ...
    public final Completable doOnComplete(Action action) {
        ...
        return doOnLifecycle(consumerEmptyConsumer, consumerEmptyConsumer2, action, action2, action2, Functions.EMPTY_ACTION);
    }
    ...
    public final Completable doOnDispose(Action action) {
        ...
        Consumer<? super Throwable> consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return doOnLifecycle(consumerEmptyConsumer, consumerEmptyConsumer2, action2, action2, Functions.EMPTY_ACTION, action);
    }
    ...
    public final Completable doOnError(Consumer<? super Throwable> consumer) {
        ...
        Action action2 = Functions.EMPTY_ACTION;
        return doOnLifecycle(consumerEmptyConsumer, consumer, action, action, action2, action2);
    }
    ...
    public final Completable doOnSubscribe(Consumer<? super Disposable> consumer) {
        ...
        Action action = Functions.EMPTY_ACTION;
        Action action2 = Functions.EMPTY_ACTION;
        return doOnLifecycle(consumer, consumerEmptyConsumer, action, action, action2, action2);
    }
    ...
    public final Completable doOnTerminate(Action action) {
        ...
        return doOnLifecycle(consumerEmptyConsumer, consumerEmptyConsumer2, action2, action, action3, action3);
    }
    ...
    public final Completable doAfterTerminate(Action action) {
        ...
        Consumer<? super Throwable> consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return doOnLifecycle(consumerEmptyConsumer, consumerEmptyConsumer2, action2, action2, action, Functions.EMPTY_ACTION);
    }
