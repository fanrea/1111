...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final Maybe<T> doOnError(Consumer<? super Throwable> consumer) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumer2, action, action, Functions.EMPTY_ACTION));
    }
    ...
    public final Maybe<T> doOnSubscribe(Consumer<? super Disposable> consumer) {
        ...
        Consumer consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumer2, consumerEmptyConsumer, consumerEmptyConsumer2, action, action, Functions.EMPTY_ACTION));
    }
    ...
    public final Maybe<T> doOnSuccess(Consumer<? super T> consumer) {
        ...
        Consumer consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumerEmptyConsumer, consumer2, consumerEmptyConsumer2, action, action, Functions.EMPTY_ACTION));
    }
