...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    final boolean add(BehaviorDisposable<T> behaviorDisposable) {
    ...
    final void remove(BehaviorDisposable<T> behaviorDisposable) {
        BehaviorDisposable<T>[] behaviorDisposableArr;
        BehaviorDisposable<T>[] behaviorDisposableArr2;
        do {
            behaviorDisposableArr = this.subscribers.get();
    ...
    final BehaviorDisposable<T>[] terminate(Object obj) {
