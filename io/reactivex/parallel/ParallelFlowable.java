...
public abstract class ParallelFlowable<T> {
    ...
    public static <T> ParallelFlowable<T> from(Publisher<? extends T> publisher, int i, int i2) {
        ObjectHelper.requireNonNull(publisher, n.l);
    ...
    public final ParallelFlowable<T> doOnNext(Consumer<? super T> consumer) {
        ...
        return RxJavaPlugins.onAssembly(new ParallelPeek(this, consumer, consumerEmptyConsumer, consumerEmptyConsumer2, action, action, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doAfterNext(Consumer<? super T> consumer) {
        ...
        Consumer consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new ParallelPeek(this, consumerEmptyConsumer, consumer, consumerEmptyConsumer2, action, action, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnError(Consumer<Throwable> consumer) {
        ...
        Consumer consumerEmptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new ParallelPeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumer, action, action, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnSubscribe(Consumer<? super Subscription> consumer) {
        ...
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new ParallelPeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumerEmptyConsumer3, action, action, consumer, Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnRequest(LongConsumer longConsumer) {
        ...
        Consumer consumerEmptyConsumer3 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new ParallelPeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumerEmptyConsumer3, action, action, Functions.emptyConsumer(), longConsumer, Functions.EMPTY_ACTION));
    }
