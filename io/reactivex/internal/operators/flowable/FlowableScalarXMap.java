...
public final class FlowableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(Publisher<T> publisher, Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function) {
        ...
        try {
            C$r8$twr$utility c$r8$twr$utility = (Object) ((Callable) publisher).call();
            if (c$r8$twr$utility == null) {
                EmptySubscription.complete(subscriber);
                return true;
            }
            try {
                Publisher publisher2 = (Publisher) ObjectHelper.requireNonNull(function.apply(c$r8$twr$utility), "The mapper returned a null Publisher");
