...
public final class ObservableFlatMapSingle<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        */
        final void innerSuccess(io.reactivex.internal.operators.observable.ObservableFlatMapSingle.FlatMapSingleObserver<T, R>.InnerObserver r3, R r4) {
            /*
                r2 = this;
        ...
        final void drainLoop() {
            ...
            while (!this.cancelled) {
                ...
                C$r8$twr$utility c$r8$twr$utilityPoll = spscLinkedArrayQueue != null ? spscLinkedArrayQueue.poll() : null;
