    ...
    static final class ConcatMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        */
        final void drain() {
            ...
            L5a:
                if (r8 != 0) goto L97
                io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> r6 = r10.mapper     // Catch: java.lang.Throwable -> L72
                ...
                io.reactivex.MaybeSource r6 = (io.reactivex.MaybeSource) r6     // Catch: java.lang.Throwable -> L72
                r10.state = r4
