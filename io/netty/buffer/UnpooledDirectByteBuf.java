...
public class UnpooledDirectByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    public ByteBuf capacity(int i) {
        ...
        if (i <= i3) {
            if (i < i3) {
                ...
                ByteBuffer byteBufferAllocateDirect2 = allocateDirect(i);
                if (i2 < i) {
                    if (iWriterIndex > i) {
                        writerIndex(i);
                    } else {
                    ...
                    byteBufferAllocateDirect2.position(i2).limit(i);
                    byteBufferAllocateDirect2.put(byteBuffer);
        ...
        ByteBuffer byteBuffer2 = this.buffer;
        byteBufferAllocateDirect = allocateDirect(i);
        byteBuffer2.position(0).limit(byteBuffer2.capacity());
        byteBufferAllocateDirect.position(0).limit(byteBuffer2.capacity());
        byteBufferAllocateDirect.put(byteBuffer2);
        byteBufferAllocateDirect.clear();
        setByteBuffer(byteBufferAllocateDirect);
        return this;
    }
    ...
    private void getBytes(int i, ByteBuffer byteBuffer, boolean z) {
        ...
        byteBufferDuplicate.clear().position(i).limit(i + iMin);
