...
public class SwappedByteBuf extends ByteBuf {
    ...
    public ByteBuffer[] nioBuffers() {
        ...
        for (int i = 0; i < byteBufferArrNioBuffers.length; i++) {
            byteBufferArrNioBuffers[i] = byteBufferArrNioBuffers[i].order(this.order);
        }
    ...
    public ByteBuffer[] nioBuffers(int i, int i2) {
        ByteBuffer[] byteBufferArrNioBuffers = this.buf.nioBuffers(i, i2);
        for (int i3 = 0; i3 < byteBufferArrNioBuffers.length; i3++) {
            byteBufferArrNioBuffers[i3] = byteBufferArrNioBuffers[i3].order(this.order);
        }
        return byteBufferArrNioBuffers;
    }
