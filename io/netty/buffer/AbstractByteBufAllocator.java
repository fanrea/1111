...
public abstract class AbstractByteBufAllocator implements ByteBufAllocator {
    ...
    protected static ByteBuf toLeakAwareBuffer(ByteBuf byteBuf) {
        ResourceLeak resourceLeakOpen;
        int i = AnonymousClass1.$SwitchMap$io$netty$util$ResourceLeakDetector$Level[ResourceLeakDetector.getLevel().ordinal()];
        if (i == 1) {
            ResourceLeak resourceLeakOpen2 = AbstractByteBuf.leakDetector.open(byteBuf);
            if (resourceLeakOpen2 != null) {
                return new SimpleLeakAwareByteBuf(byteBuf, resourceLeakOpen2);
            }
        } else if ((i == 2 || i == 3) && (resourceLeakOpen = AbstractByteBuf.leakDetector.open(byteBuf)) != null) {
            return new AdvancedLeakAwareByteBuf(byteBuf, resourceLeakOpen);
        }
        return byteBuf;
    }
    ...
    protected static CompositeByteBuf toLeakAwareBuffer(CompositeByteBuf compositeByteBuf) {
        ...
        int i = AnonymousClass1.$SwitchMap$io$netty$util$ResourceLeakDetector$Level[ResourceLeakDetector.getLevel().ordinal()];
        if (i == 1) {
            ResourceLeak resourceLeakOpen2 = AbstractByteBuf.leakDetector.open(compositeByteBuf);
            if (resourceLeakOpen2 != null) {
                return new SimpleLeakAwareCompositeByteBuf(compositeByteBuf, resourceLeakOpen2);
            }
        } else if ((i == 2 || i == 3) && (resourceLeakOpen = AbstractByteBuf.leakDetector.open(compositeByteBuf)) != null) {
            return new AdvancedLeakAwareCompositeByteBuf(compositeByteBuf, resourceLeakOpen);
        }
