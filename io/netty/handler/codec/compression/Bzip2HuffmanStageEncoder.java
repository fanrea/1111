...
final class Bzip2HuffmanStageEncoder {
    ...
    Bzip2HuffmanStageEncoder(Bzip2BitWriter bzip2BitWriter, char[] cArr, int i, int i2, int[] iArr) {
        ...
        this.huffmanCodeLengths = (int[][]) Array.newInstance((Class<?>) int.class, iSelectTableCount, i2);
        this.huffmanMergedCodeSymbols = (int[][]) Array.newInstance((Class<?>) int.class, iSelectTableCount, i2);
    ...
    final void encode(ByteBuf byteBuf) {
