...
public final class ShortCollections {
    ...
    static final class EmptyMap implements ShortObjectMap<Object> {
        ...
        @Override // io.netty.util.collection.ShortObjectMap
        public final Object remove(short s) {
            return null;
        }
        ...
        @Override // io.netty.util.collection.ShortObjectMap
        public final Object put(short s, Object obj) {
    ...
    static final class UnmodifiableMap<V> implements ShortObjectMap<V> {
        ...
        @Override // java.util.Map
        public final /* bridge */ /* synthetic */ Object put(Short sh, Object obj) {
        ...
        @Override // io.netty.util.collection.ShortObjectMap
        public final V put(short s, V v) {
            throw new UnsupportedOperationException("put");
        }

        @Override // io.netty.util.collection.ShortObjectMap
        public final V remove(short s) {
        ...
        public final V put2(Short sh, V v) {
            throw new UnsupportedOperationException("put");
        }
        ...
        class IteratorImpl implements Iterator<ShortObjectMap.PrimitiveEntry<V>> {
        ...
        class EntryImpl implements ShortObjectMap.PrimitiveEntry<V> {
