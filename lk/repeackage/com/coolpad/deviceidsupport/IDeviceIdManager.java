package lk.repeackage.com.coolpad.deviceidsupport;
...
public interface IDeviceIdManager extends IInterface {
    ...
    public static class Default implements IDeviceIdManager {
        ...
        @Override // lk.repeackage.com.coolpad.deviceidsupport.IDeviceIdManager
            ...
            public String getCoolOsVersion() {
                ...
                try {
                    ...
                    if (this.mRemote.transact(7, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        string = Stub.getDefaultImpl().getCoolOsVersion();
                    }
                    return string;
                } finally {
                    parcelObtain2.recycle();
            ...
            public String getIMEI(String str) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(5, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        string = Stub.getDefaultImpl().getIMEI(str);
                    }
                    return string;
                } finally {
                    parcelObtain2.recycle();
            ...
            public String getOAID(String str) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(2, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        string = Stub.getDefaultImpl().getOAID(str);
                    }
                    return string;
                } finally {
                    parcelObtain2.recycle();
            ...
            public String getUDID(String str) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(1, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        string = Stub.getDefaultImpl().getUDID(str);
                    }
                    return string;
                } finally {
                    parcelObtain2.recycle();
