...
public final class LongSparseArrayKt {
    ...
    public static final class C08611<T> implements Iterator<T>, KMappedMarker {
        ...
        C08611(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C08611(longSparseArray);
    }
