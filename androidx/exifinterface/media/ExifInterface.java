...
public class ExifInterface {
    ...
    private static final byte[] HEIF_BRAND_MIF1 = {109, 105, 102, e.I};
    private static final byte[] HEIF_BRAND_HEIC = {104, 101, 105, 99};
    private static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, e.P, 89, 77, 80, 0};
    private static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, e.P, 89, 77, 80, 85, e.Q, 0, 73, 73};
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, 13, 10, 26, 10};
    private static final byte[] PNG_CHUNK_TYPE_EXIF = {101, e.S, 73, 102};
    private static final byte[] PNG_CHUNK_TYPE_IHDR = {73, 72, 68, 82};
    private static final byte[] PNG_CHUNK_TYPE_IEND = {73, 69, 78, 68};
    private static final byte[] WEBP_SIGNATURE_1 = {82, 73, 70, 70};
    private static final byte[] WEBP_SIGNATURE_2 = {87, 69, 66, 80};
    private static final byte[] WEBP_CHUNK_TYPE_EXIF = {69, e.S, 73, 70};
    ...
    static final byte[] EXIF_ASCII_PREFIX = {65, e.Q, 67, 73, 73, 0, 0, 0};
    ...
    */
    ...
    public static boolean isSupportedMimeType(String str) {
        ...
        switch (lowerCase.hashCode()) {
            ...
            case -985160897:
                ...
                break;
            case -879258763:
                if (lowerCase.equals(PictureMimeType.PNG_Q)) {
                    c = '\t';
                    break;
                }
                break;
            ...
            if ((i6 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i6].get(str3)) != null) {
                if (strReplaceAll == null) {
                    ...
                    if (exifTag.primaryFormat == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) pairGuessDataFormat.second).intValue()) {
                        ...
                        StringBuilder sbAppend = new StringBuilder().append("Given tag (").append(str3).append(") value didn't match with one of expected formats: ");
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x0104 A[Catch: all -> 0x0130, Exception -> 0x0132, TryCatch #18 {Exception -> 0x0132, all -> 0x0130, blocks: (B:74:0x0100, B:76:0x0104, B:78:0x0108, B:81:0x011f, B:79:0x0117), top: B:140:0x0100 }] */
    /* JADX WARN: Removed duplicated region for block: B:79:0x0117 A[Catch: all -> 0x0130, Exception -> 0x0132, TryCatch #18 {Exception -> 0x0132, all -> 0x0130, blocks: (B:74:0x0100, B:76:0x0104, B:78:0x0108, B:81:0x011f, B:79:0x0117), top: B:140:0x0100 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:69:0x01a8, code lost:
        ...
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:34:0x00c3 A[FALL_THROUGH] */
    /* JADX WARN: Removed duplicated region for block: B:63:0x018d A[LOOP:0: B:10:0x003a->B:63:0x018d, LOOP_END] */
    ...
    private void copyChunksUpToGivenChunkType(ByteOrderedDataInputStream byteOrderedDataInputStream, ByteOrderedDataOutputStream byteOrderedDataOutputStream, byte[] bArr, byte[] bArr2) throws IOException {
        while (true) {
            ...
            if (byteOrderedDataInputStream.read(bArr3) != 4) {
                ...
                throw new IOException(sbAppend.append(new String(bArr, charset)).append(bArr2 == null ? "" : " or " + new String(bArr2, charset)).toString());
            }
