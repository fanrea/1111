...
public final class CameraX {
    ...
    public CameraX(Context context, CameraXConfig.Provider provider) throws PackageManager.NameNotFoundException {
        if (provider != null) {
    ...
    /* synthetic */ void m112lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final CallbackToFutureAdapter.Completer completer, final long j) throws InitializationException {
        try {
