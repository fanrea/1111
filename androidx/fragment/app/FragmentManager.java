...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = iFindBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            if (!hashSet2.isEmpty()) {
                StringBuilder sbAppend = new StringBuilder().append("saveBackStack(\"").append(str).append("\") must be self contained and not reference fragments from non-saved FragmentTransactions. Found reference to fragment");
                if (hashSet2.size() == 1) {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
                ...
                public final Bundle saveState() {
                    return this.f$0.m254lambda$attachController$0$androidxfragmentappFragmentManager();
                }
            });
    ...
    /* synthetic */ Bundle m254lambda$attachController$0$androidxfragmentappFragmentManager() {
