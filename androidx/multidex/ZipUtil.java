    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                centralDirectory.size = Integer.reverseBytes(randomAccessFile.readInt()) & C00oOOo.f362O8oO888;
                centralDirectory.offset = Integer.reverseBytes(randomAccessFile.readInt()) & C00oOOo.f362O8oO888;
