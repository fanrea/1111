...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo289clone = transition.mo289clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo289clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo289clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo289clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo289clone = transition.mo289clone();
        sceneChangeSetup(viewGroup, transitionMo289clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo289clone);
    }
