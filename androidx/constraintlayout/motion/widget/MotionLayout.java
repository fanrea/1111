    ...
    */
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            Log.v(MotionLayout.TAG, str + sbAppend4.append(str5).toString() + " ---  " + child);
        }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                StringBuilder sbAppend2 = new StringBuilder().append((sbAppend.append(constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : Config.replace).toString() + (constraintWidget.mBottom.mTarget != null ? "B" : Config.replace)) + (constraintWidget.mLeft.mTarget != null ? "L" : Config.replace));
                if (constraintWidget.mRight.mTarget != null) {
                    str3 = "R";
                }
                String string = sbAppend2.append(str3).toString();
                View view = (View) constraintWidget.getCompanionWidget();
                String name = Debug.getName(view);
                if (view instanceof TextView) {
                    name = name + "(" + ((Object) ((TextView) view).getText()) + ")";
                }
                Log.v(MotionLayout.TAG, str2 + "  " + name + " " + constraintWidget + " " + string);
            }
