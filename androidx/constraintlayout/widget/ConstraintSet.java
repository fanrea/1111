...
public class ConstraintSet {
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m216clone());
            }
        }
    }
    ...
    */
    ...
    static String getDebugName(int v) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(Config.replace) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                String[] strArr = {"spread", "wrap", ILogConst.Keys.KEY_PERCENT};
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{j.d, j.e, j.f, j.g, "start", PointCategory.END}, -1);
        ...
        String lookup(int id) {
            try {
                ...
                StringBuilder sbAppend = new StringBuilder().append("unknown");
                int i = this.unknownCount + 1;
                this.unknownCount = i;
                return sbAppend.append(i).toString();
            } catch (Exception unused) {
                StringBuilder sbAppend2 = new StringBuilder().append("unknown");
        ...
        void writeCircle(int circleConstraint, float circleAngle, int circleRadius) throws IOException {
            ...
            this.writer.write(Config.TRACE_CIRCLE);
            this.writer.write(":[");
