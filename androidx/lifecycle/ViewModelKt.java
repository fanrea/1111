...
public final class ViewModelKt {
    ...
    public static final CoroutineScope getViewModelScope(ViewModel viewModel) throws IOException {
        ...
        Object tagIfAbsent = viewModel.setTagIfAbsent(JOB_KEY, new CloseableCoroutineScope(SupervisorKt.SupervisorJob$default((Job) null, 1, (Object) null).plus((CoroutineContext) Dispatchers.getMain().getImmediate())));
