...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        Configuration configurationCreateOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(context, iMapNightMode, configurationGenerateConfigDelta, true);
    ...
    */
    ...
    private boolean updateForNightMode(int i, boolean z) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        boolean z2 = false;
        Configuration configurationCreateOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(this.mContext, i, null, false);
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & SocketMessages.PayloadType.SC_LIVE_PK_KO_MODE) != (configuration2.screenLayout & SocketMessages.PayloadType.SC_LIVE_PK_KO_MODE)) {
                configuration3.screenLayout |= configuration2.screenLayout & SocketMessages.PayloadType.SC_LIVE_PK_KO_MODE;
            }
            if (Build.VERSION.SDK_INT >= 26) {
