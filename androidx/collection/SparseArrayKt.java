...
public final class SparseArrayKt {
    ...
    public static final class C08571<T> implements Iterator<T>, KMappedMarker {
        ...
        C08571(SparseArrayCompat<T> sparseArrayCompat) {
    ...
    public static final <T> Iterator<T> valueIterator(SparseArrayCompat<T> sparseArrayCompat) {
        Intrinsics.checkParameterIsNotNull(sparseArrayCompat, "receiver$0");
        return new C08571(sparseArrayCompat);
    }
}
