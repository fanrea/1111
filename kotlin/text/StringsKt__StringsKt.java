...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence trim(CharSequence charSequence, Function1<? super Character, Boolean> function1) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean zBooleanValue = ((Boolean) function1.invoke(Character.valueOf(charSequence.charAt(!z ? i : length)))).booleanValue();
            if (z) {
                if (!zBooleanValue) {
                    break;
                }
    ...
    public static final String trim(String str, Function1<? super Character, Boolean> function1) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean zBooleanValue = ((Boolean) function1.invoke(Character.valueOf(str2.charAt(!z ? i : length)))).booleanValue();
            if (z) {
                if (!zBooleanValue) {
                    break;
                }
    ...
    public static final String trimStart(String str, Function1<? super Character, Boolean> function1) {
        ...
        while (true) {
            if (i < length) {
                if (!((Boolean) function1.invoke(Character.valueOf(str2.charAt(i)))).booleanValue()) {
    ...
    public static final String trimEnd(String str, Function1<? super Character, Boolean> function1) {
        ...
        if (length >= 0) {
            while (true) {
                int i = length - 1;
                if (!((Boolean) function1.invoke(Character.valueOf(str2.charAt(length)))).booleanValue()) {
    ...
    private static final String replaceFirstCharWithChar(String str, Function1<? super Character, Character> function1) {
        ...
        char cCharValue = ((Character) function1.invoke(Character.valueOf(str.charAt(0)))).charValue();
    ...
    private static final String replaceFirstCharWithCharSequence(String str, Function1<? super Character, ? extends CharSequence> function1) {
        ...
        StringBuilder sbAppend = new StringBuilder().append(function1.invoke(Character.valueOf(str.charAt(0))));
        String strSubstring = str.substring(1);
        Intrinsics.checkNotNullExpressionValue(strSubstring, "substring(...)");
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        ...
        if (!z2) {
            intProgressionDownTo = (IntProgression) new IntRange(RangesKt.coerceAtLeast(i, 0), RangesKt.coerceAtMost(i2, charSequence.length()));
        } else {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        IntProgression intProgressionDownTo = !z2 ? (IntProgression) new IntRange(RangesKt.coerceAtLeast(i, 0), charSequence.length()) : RangesKt.downTo(RangesKt.coerceAtMost(i, StringsKt.getLastIndex(charSequence)), 0);
