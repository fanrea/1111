...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.toString-impl(ULong.constructor-impl(j))));
    }
    ...
    */
    ...
    public static final int parsedByteArrayMaxSize(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        return (int) ((j4 - ((j + ((long) i5)) * jWholeElementsPerSet3) > 0 ? 1 : 0) + (jWholeElementsPerSet * i2) + (jWholeElementsPerSet2 * i3) + jWholeElementsPerSet3);
    }
    ...
    private static final int decimalFromHexDigitAt(String str, int i) throws KotlinNothingValueException {
        int i2;
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    private static final long longDecimalFromHexDigitAt(String str, int i) throws KotlinNothingValueException {
        char cCharAt = str.charAt(i);
        if ((cCharAt >>> '\b') == 0) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    private static final byte parseByteAt(String str, int i) throws KotlinNothingValueException {
        int[] iArr;
        int i2;
        int i3;
        char cCharAt = str.charAt(i);
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    private static final int parseInt(String str, int i, int i2) throws KotlinNothingValueException {
        int i3;
        int i4 = 0;
        while (i < i2) {
            int i5 = i4 << 4;
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    private static final long parseLong(String str, int i, int i2) throws KotlinNothingValueException {
        long j = 0;
        while (i < i2) {
            long j2 = j << 4;
            char cCharAt = str.charAt(i);
