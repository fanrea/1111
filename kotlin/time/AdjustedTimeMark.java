...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1794minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1941minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1793elapsedNowUwyO8pc() {
        return Duration.m1839minusLRDsOJo(this.mark.mo1793elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1796plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1840plusLRDsOJo(this.adjustment, duration), null);
    }
}
