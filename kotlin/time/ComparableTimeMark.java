...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1794minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1795minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1796plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1799minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1796plusLRDsOJo(Duration.m1857unaryMinusUwyO8pc(j));
        }
        ...
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark comparableTimeMark2) {
            ...
            return Duration.m1803compareToLRDsOJo(comparableTimeMark.mo1795minusUwyO8pc(comparableTimeMark2), Duration.INSTANCE.m1907getZEROUwyO8pc());
        }
    }
}
