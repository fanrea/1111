...
public interface TimeMark {
    ...
    TimeMark mo1794minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1796plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1942plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1941minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1796plusLRDsOJo(Duration.m1857unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1837isNegativeimpl(timeMark.mo1793elapsedNowUwyO8pc());
        }
