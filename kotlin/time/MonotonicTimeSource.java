...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1944boximpl(m1938markNowz9LOYto());
    }
    ...
    public long m1938markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1947constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1937elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1936differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1935adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1947constructorimpl(LongSaturatedMathKt.m1933saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
