...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return (T) action.invoke(ULong.box-impl(ULong.constructor-impl(getMostSignificantBits())), ULong.box-impl(ULong.constructor-impl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1967fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid uuid, Uuid uuid2) {
        ...
        if (j != uuid2.mostSignificantBits) {
            return UByte$.ExternalSyntheticBackport4.m(ULong.constructor-impl(j), ULong.constructor-impl(uuid2.mostSignificantBits));
        }
        return UByte$.ExternalSyntheticBackport4.m(ULong.constructor-impl(uuid.leastSignificantBits), ULong.constructor-impl(uuid2.leastSignificantBits));
    }
}
