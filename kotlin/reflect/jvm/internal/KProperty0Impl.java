...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements KProperty0<V> {
    ...
    public KProperty0Impl(KDeclarationContainerImpl kDeclarationContainerImpl, PropertyDescriptor propertyDescriptor) {
        ...
        this.delegateValue = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<Object>(this) { // from class: kotlin.reflect.jvm.internal.KProperty0Impl$delegateValue$1
            final /* synthetic */ KProperty0Impl<V> this$0;
    ...
    public Getter<V> m1569getGetter() {
    ...
    public V get() {
        return m1569getGetter().call(new Object[0]);
    }
