...
public abstract class KDeclarationContainerImpl implements ClassBasedDeclarationContainer {
    ...
    public abstract class Data {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {(KProperty) Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(Data.class), "moduleData", "getModuleData()Lorg/jetbrains/kotlin/descriptors/runtime/components/RuntimeModuleData;"))};
    ...
    */
    ...
    public final PropertyDescriptor findPropertyDescriptor(String name, String signature) {
        ...
        if (arrayList2.size() == 1) {
            return (PropertyDescriptor) CollectionsKt.single(arrayList2);
        }
        ...
        Collection collectionValues = MapsKt.toSortedMap(linkedHashMap, new Comparator() { // from class: kotlin.reflect.jvm.internal.KDeclarationContainerImpl$findPropertyDescriptor$mostVisibleProperties$2
        ...
        String strJoinToString$default = CollectionsKt.joinToString$default(getProperties(nameIdentifier2), "\n", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, new Function1<PropertyDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.KDeclarationContainerImpl$findPropertyDescriptor$allMembers$1
        ...
        throw new KotlinReflectionInternalError("Property '" + name + "' (JVM signature: " + signature + ") not resolved in " + this + ':' + (strJoinToString$default.length() == 0 ? " no members found" : Intrinsics.stringPlus("\n", strJoinToString$default)));
    }
    ...
    public final FunctionDescriptor findFunctionDescriptor(String name, String signature) {
        ...
        if (arrayList2.size() != 1) {
            ...
            throw new KotlinReflectionInternalError("Function '" + name + "' (JVM signature: " + signature + ") not resolved in " + this + ':' + (strJoinToString$default.length() == 0 ? " no members found" : Intrinsics.stringPlus("\n", strJoinToString$default)));
        }
        return (FunctionDescriptor) CollectionsKt.single(arrayList2);
    }
    ...
    private final Method lookupMethod(Class<?> cls, String str, Class<?>[] clsArr, Class<?> cls2, boolean z) throws NoSuchMethodException, SecurityException {
        ...
        if (methodTryGetMethod != null || ((superclass = cls.getSuperclass()) != null && (methodTryGetMethod = lookupMethod(superclass, str, clsArr, cls2, z)) != null)) {
        ...
        while (i < length) {
            ...
            Method methodLookupMethod = lookupMethod(cls3, str, clsArr, cls2, z);
            if (methodLookupMethod == null) {
                if (z && (clsTryLoadClass = ReflectJavaClassFinderKt.tryLoadClass(ReflectClassUtilKt.getSafeClassLoader(cls3), Intrinsics.stringPlus(cls3.getName(), "$DefaultImpls"))) != null) {
                    clsArr[0] = cls3;
                    methodLookupMethod = tryGetMethod(clsTryLoadClass, str, clsArr, cls2);
                    if (methodLookupMethod == null) {
                    }
                }
            }
    ...
    public final Method findMethodBySignature(String name, String desc) throws NoSuchMethodException, SecurityException {
        ...
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(desc, RemoteRewardActivity.JSON_BANNER_DESC_ID);
        if (Intrinsics.areEqual(name, "<init>")) {
            return null;
        }
    ...
    public final Method findDefaultMethod(String name, String desc, boolean isMember) {
        ...
        if (array != null) {
            return lookupMethod(methodOwner, strStringPlus, (Class[]) array, loadReturnType(desc), isMember);
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.ArraysKt__ArraysJVMKt.toTypedArray>");
    }
    ...
    private final List<Class<?>> loadParameterTypes(String desc) {
        ...
        while (desc.charAt(i) != ')') {
            ...
            if (StringsKt.contains$default((CharSequence) "VZCBSIFJD", cCharAt, false, 2, (Object) null)) {
                ...
                throw new KotlinReflectionInternalError(Intrinsics.stringPlus("Unknown type prefix in the method signature: ", desc));
            }
