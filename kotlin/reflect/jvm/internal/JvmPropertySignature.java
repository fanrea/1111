    ...
    public static final class KotlinProperty extends JvmPropertySignature {
        ...
        public KotlinProperty(PropertyDescriptor propertyDescriptor, ProtoBuf.Property property, JvmProtoBuf.JvmPropertySignature jvmPropertySignature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            if (jvmPropertySignature.hasGetter()) {
                strStringPlus = Intrinsics.stringPlus(nameResolver.getString(jvmPropertySignature.getGetter().getName()), nameResolver.getString(jvmPropertySignature.getGetter().getDesc()));
            } else {
                ...
                if (jvmFieldSignature$default != null) {
                    strStringPlus = JvmAbi.getterName(jvmFieldSignature$default.component1()) + getManglingSuffix() + "()" + jvmFieldSignature$default.component2();
                } else {
                    throw new KotlinReflectionInternalError(Intrinsics.stringPlus("No field signature for property: ", propertyDescriptor));
                }
            }
            this.string = strStringPlus;
        }
        ...
        private final String getManglingSuffix() {
            ...
            if (Intrinsics.areEqual(this.descriptor.getVisibility(), DescriptorVisibilities.INTERNAL) && (containingDeclaration instanceof DeserializedClassDescriptor)) {
                ...
                return Intrinsics.stringPlus(j.a, NameUtils.sanitizeAsJavaIdentifier(num == null ? LiveConfigKey.MAIN : this.nameResolver.getString(num.intValue())));
            }
            ...
            return jvmPackagePartSource.getFacadeClassName() != null ? Intrinsics.stringPlus(j.a, jvmPackagePartSource.getSimpleName().asString()) : "";
        }
