...
public final class ReflectionObjectRenderer {
    ...
    private final String renderCallable(CallableDescriptor descriptor) {
        ...
        throw new IllegalStateException(Intrinsics.stringPlus("Illegal callable: ", descriptor).toString());
    }
    ...
    public final String renderFunction(FunctionDescriptor descriptor) {
        ...
        CollectionsKt.joinTo$default(valueParameters, sb, ", ", "(", ")", 0, (CharSequence) null, new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderFunction$1$1
    ...
    public final String renderLambda(FunctionDescriptor invoke) {
        ...
        CollectionsKt.joinTo$default(valueParameters, sb, ", ", "(", ")", 0, (CharSequence) null, new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderLambda$1$1
            public final CharSequence invoke(ValueParameterDescriptor valueParameterDescriptor) {
                ReflectionObjectRenderer reflectionObjectRenderer2 = ReflectionObjectRenderer.INSTANCE;
                KotlinType type = valueParameterDescriptor.getType();
                Intrinsics.checkNotNullExpressionValue(type, "it.type");
