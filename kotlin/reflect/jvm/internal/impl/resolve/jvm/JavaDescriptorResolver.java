...
public final class JavaDescriptorResolver {
    ...
    public final ClassDescriptor resolveClass(JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            MemberScope unsubstitutedInnerClassesScope = classDescriptorResolveClass == null ? null : classDescriptorResolveClass.getUnsubstitutedInnerClassesScope();
            ClassifierDescriptor contributedClassifier = unsubstitutedInnerClassesScope == null ? null : unsubstitutedInnerClassesScope.mo1678getContributedClassifier(javaClass.getName(), NoLookupLocation.FROM_JAVA_LOADER);
