...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    protected List<FunctionDescriptor> computeDeclaredFunctions() {
        ...
        simpleFunctionDescriptorImplCreate.initialize((ReceiverParameterDescriptor) null, getContainingClass().getThisAsReceiverParameter(), CollectionsKt.emptyList(), CollectionsKt.emptyList(), (KotlinType) DescriptorUtilsKt.getBuiltIns(getContainingClass()).getAnyType(), Modality.OPEN, DescriptorVisibilities.PROTECTED);
