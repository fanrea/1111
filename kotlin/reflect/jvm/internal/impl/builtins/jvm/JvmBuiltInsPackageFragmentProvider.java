...
public final class JvmBuiltInsPackageFragmentProvider extends AbstractDeserializedPackageFragmentProvider {
    ...
    protected DeserializedPackageFragment findPackage(FqName fqName) {
        ...
        return inputStreamFindBuiltInsData == null ? null : BuiltInsPackageFragmentImpl.Companion.create(fqName, getStorageManager(), getModuleDescriptor(), inputStreamFindBuiltInsData, false);
    }
