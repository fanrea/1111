...
public final class ReflectionTypes {
    ...
    public ReflectionTypes(final ModuleDescriptor moduleDescriptor, NotFoundClasses notFoundClasses) {
        ...
        this.kotlinReflectScope$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.ReflectionTypes$kotlinReflectScope$2
            {
                super(0);
            }
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor contributedClassifier = getKotlinReflectScope().mo1678getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
