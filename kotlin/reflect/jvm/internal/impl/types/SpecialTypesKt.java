...
public final class SpecialTypesKt {
    ...
    public static final UnwrappedType makeDefinitelyNotNullOrNotNull(UnwrappedType unwrappedType, boolean z) {
        ...
        if (unwrappedTypeMakeDefinitelyNotNull != null || (unwrappedTypeMakeDefinitelyNotNull = makeIntersectionTypeDefinitelyNotNullOrNotNull(unwrappedType)) != null) {
            return unwrappedTypeMakeDefinitelyNotNull;
        }
    ...
    private static final IntersectionTypeConstructor makeDefinitelyNotNullOrNotNull(IntersectionTypeConstructor intersectionTypeConstructor) {
        ...
        Collection<KotlinType> collectionMo1674getSupertypes = intersectionTypeConstructor.mo1674getSupertypes();
