...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public NewCapturedTypeConstructor(TypeProjection typeProjection, Function0<? extends List<? extends UnwrappedType>> function0, NewCapturedTypeConstructor newCapturedTypeConstructor, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        this._supertypes$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<List<? extends UnwrappedType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.NewCapturedTypeConstructor$_supertypes$2
            {
                super(0);
            }
    ...
    public List<UnwrappedType> mo1674getSupertypes() {
    ...
    public NewCapturedTypeConstructor refine(final KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Function0<List<? extends UnwrappedType>> function0 = this.supertypesComputation == null ? null : new Function0<List<? extends UnwrappedType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.NewCapturedTypeConstructor$refine$1$1
            ...
            public final List<UnwrappedType> invoke() {
                List<UnwrappedType> listMo1674getSupertypes = this.this$0.mo1674getSupertypes();
                KotlinTypeRefiner kotlinTypeRefiner2 = kotlinTypeRefiner;
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo1674getSupertypes, 10));
                Iterator<T> it = listMo1674getSupertypes.iterator();
                while (it.hasNext()) {
