...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    */
    ...
    public SimpleType getDefaultType() {
        SimpleType simpleTypeSimpleTypeWithNonTrivialMemberScope = KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(getAnnotations(), getTypeConstructor(), TypeUtils.getDefaultTypeProjections(getTypeConstructor().getParameters()), false, getUnsubstitutedMemberScope());
    ...
    public ClassDescriptor mo1604getCompanionObjectDescriptor() {
        return this.original.mo1604getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo1605getUnsubstitutedPrimaryConstructor() {
        return this.original.mo1605getUnsubstitutedPrimaryConstructor();
    }
    ...
    public InlineClassRepresentation<SimpleType> getInlineClassRepresentation() {
        ...
        return new InlineClassRepresentation<>(inlineClassRepresentation.getUnderlyingPropertyName(), substituteSimpleType((SimpleType) getInlineClassRepresentation().getUnderlyingType()));
    }
