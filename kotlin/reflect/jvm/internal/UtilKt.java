...
public final class UtilKt {
    ...
    public static final Class<?> toJavaClass(ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(source, n.l);
    ...
    public static final List<Annotation> computeAnnotations(Annotated annotated) throws NoWhenBranchMatchedException {
    ...
    private static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (Annotation annotation : list2) {
            ...
            if (Intrinsics.areEqual(javaClass.getSimpleName(), "Container") && javaClass.getAnnotation(RepeatableContainer.class) != null) {
                Object objInvoke = javaClass.getDeclaredMethod(b.d, new Class[0]).invoke(annotation, new Object[0]);
                if (objInvoke == null) {
    ...
    private static final Annotation toAnnotationInstance(AnnotationDescriptor annotationDescriptor) throws NoWhenBranchMatchedException {
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) throws NoWhenBranchMatchedException {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassId classId = (ClassId) value.component1();
            Name name = (Name) value.component2();
        ...
        if (constantValue instanceof KClassValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo1672getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1672getDeclarationDescriptor();
    ...
    */
    private static final java.lang.Object arrayToRuntimeValue(kotlin.reflect.jvm.internal.impl.resolve.constants.ArrayValue r6, java.lang.ClassLoader r7) throws kotlin.NoWhenBranchMatchedException, java.lang.NegativeArraySizeException {
        /*
    ...
    public static final KFunctionImpl asKFunctionImpl(Object obj) {
        ...
        KCallable kCallableCompute = functionReference == null ? null : functionReference.compute();
    ...
    public static final KPropertyImpl<?> asKPropertyImpl(Object obj) {
        ...
        KCallable kCallableCompute = propertyReference == null ? null : propertyReference.compute();
    ...
    public static final KCallableImpl<?> asKCallableImpl(Object obj) {
        ...
        return kFunctionImplAsKFunctionImpl == null ? asKPropertyImpl(obj) : kFunctionImplAsKFunctionImpl;
    }
