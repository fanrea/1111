...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(Object result) throws KotlinNothingValueException {
        resumeImpl$default(this, CompletionStateKt.toState(result, this), this.resumeMode, null, 4, null);
    }

    @Override // kotlinx.coroutines.CancellableContinuation
    public void resume(T value, Function1<? super Throwable, Unit> onCancellation) throws KotlinNothingValueException {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ void resumeImpl$default(CancellableContinuationImpl cancellableContinuationImpl, Object obj, int i, Function1 function1, int i2, Object obj2) throws KotlinNothingValueException {
        if (obj2 != null) {
    ...
    @Override // kotlinx.coroutines.CancellableContinuation
    public void resumeUndispatched(CoroutineDispatcher coroutineDispatcher, T t) throws KotlinNothingValueException {
        Continuation<T> continuation = this.delegate;
        DispatchedContinuation dispatchedContinuation = continuation instanceof DispatchedContinuation ? (DispatchedContinuation) continuation : null;
    ...
    @Override // kotlinx.coroutines.CancellableContinuation
    public void resumeUndispatchedWithException(CoroutineDispatcher coroutineDispatcher, Throwable th) throws KotlinNothingValueException {
        Continuation<T> continuation = this.delegate;
        DispatchedContinuation dispatchedContinuation = continuation instanceof DispatchedContinuation ? (DispatchedContinuation) continuation : null;
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object state) {
        ...
        CoroutineStackFrame coroutineStackFrame = this.delegate;
        return (DebugKt.getRECOVER_STACK_TRACES() && (coroutineStackFrame instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(exceptionalResult$kotlinx_coroutines_core, coroutineStackFrame) : exceptionalResult$kotlinx_coroutines_core;
    }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) throws KotlinNothingValueException {
        Object obj;
        do {
            obj = this._state;
            if (obj instanceof NotCompleted) {
