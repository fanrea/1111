...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1987trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m2007successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m2006failurePtdJZtk() : ChannelResult.INSTANCE.m2005closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m2005closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.constructor-impl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo2043remove()) {
                receive.helpRemove();
            } else {
                objM2035constructorimpl$default = InlineList.m2040plusFjFbRPM(objM2035constructorimpl$default, receive);
            }
        }
        if (objM2035constructorimpl$default != null) {
            if (!(objM2035constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM2035constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM2035constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM2035constructorimpl$default;
