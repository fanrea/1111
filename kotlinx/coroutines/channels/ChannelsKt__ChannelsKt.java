...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> anonymousClass2 = new AnonymousClass2(this.$this_trySendBlocking, this.$element, continuation);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m1992boximpl(Result.isSuccess-impl(obj2) ? ChannelResult.INSTANCE.m2007successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2005closedJP2dKIU(Result.exceptionOrNull-impl(obj2)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1987trySendJP2dKIU = sendChannel.mo1987trySendJP2dKIU(e);
        if (objMo1987trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        if (ChannelResult.m2002isSuccessimpl(sendChannel.mo1987trySendJP2dKIU(e))) {
            return;
        }
