...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    private final Symbol updateBufferSize(int currentSize) throws NoWhenBranchMatchedException {
    ...
    private final void ensureCapacity(int currentSize) {
        ...
        if (currentSize >= objArr.length) {
            ...
            ArraysKt.fill(objArr2, AbstractChannelKt.EMPTY, currentSize, iMin);
            this.buffer = objArr2;
            this.head = 0;
        }
    }
