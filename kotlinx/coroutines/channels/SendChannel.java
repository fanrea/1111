...
public interface SendChannel<E> {
    ...
    Object mo1987trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2002isSuccessimpl(objMo1987trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1996exceptionOrNullimpl = ChannelResult.m1996exceptionOrNullimpl(objMo1987trySendJP2dKIU);
