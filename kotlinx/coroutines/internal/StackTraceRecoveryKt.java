...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.constructor-impl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        try {
            ...
            obj2 = Result.constructor-impl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
