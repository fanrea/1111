...
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), (Continuation) this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), (Continuation) this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
