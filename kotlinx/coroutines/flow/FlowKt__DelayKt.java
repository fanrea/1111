...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> debounce(Flow<? extends T> flow, final long j) {
        if (j >= 0) {
            return j == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.2
                ...
                public /* bridge */ /* synthetic */ Object m2019invoke(Object obj) {
    ...
    public static final <T> Flow<T> m2017debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1970toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            /* JADX WARN: Multi-variable type inference failed */
            /* renamed from: invoke, reason: collision with other method in class */
            public /* bridge */ /* synthetic */ Object m2020invoke(Object obj) {
                return invoke((AnonymousClass3<T>) obj);
            }

            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1970toDelayMillisLRDsOJo(((Duration) function1.invoke(t)).getRawValue()));
            }
        });
    }
    ...
    static final class C10692<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C10692(long j, Flow<? extends T> flow, Continuation<? super C10692> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C10692 c10692 = new C10692(this.$periodMillis, this.$this_sample, continuation);
            c10692.L$0 = coroutineScope;
            c10692.L$1 = flowCollector;
            return c10692.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                ...
                SelectInstance selectBuilderImpl = new SelectInstance(continuation);
                try {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C10692(j, flow, null));
    }
    ...
    static final class C10683 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10683(long j, long j2, Continuation<? super C10683> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c10683 = new C10683(this.$initialDelayMillis, this.$delayMillis, continuation);
            c10683.L$0 = obj;
            return c10683;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L57:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C10683.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C10683(j2, j, null), 1, null);
    }

    /* renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m2018sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1970toDelayMillisLRDsOJo(j));
    }
}
