...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final <T> Flow<T> observeOn(Flow<? extends T> flow, CoroutineContext coroutineContext) throws KotlinNothingValueException {
        FlowKt.noImpl();
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    @Deprecated(level = DeprecationLevel.ERROR, message = "Collect flow in the desired context instead")
    public static final <T> Flow<T> publishOn(Flow<? extends T> flow, CoroutineContext coroutineContext) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> subscribeOn(Flow<? extends T> flow, CoroutineContext coroutineContext) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> onErrorResume(Flow<? extends T> flow, Flow<? extends T> flow2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'onErrorXxx' is 'catch'. Use 'catch { emitAll(fallback) }'", replaceWith = @ReplaceWith(expression = "catch { emitAll(fallback) }", imports = {}))
    public static final <T> Flow<T> onErrorResumeNext(Flow<? extends T> flow, Flow<? extends T> flow2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> void subscribe(Flow<? extends T> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    @Deprecated(level = DeprecationLevel.ERROR, message = "Use 'launchIn' with 'onEach', 'onCompletion' and 'catch' instead")
    public static final <T> void subscribe(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    @Deprecated(level = DeprecationLevel.ERROR, message = "Use 'launchIn' with 'onEach', 'onCompletion' and 'catch' instead")
    public static final <T> void subscribe(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2, Function2<? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function22) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T, R> Flow<R> flatMap(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T, R> Flow<R> concatMap(Flow<? extends T> flow, Function1<? super T, ? extends Flow<? extends R>> function1) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> merge(Flow<? extends Flow<? extends T>> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> flatten(Flow<? extends Flow<? extends T>> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T, R> Flow<R> compose(Flow<? extends T> flow, Function1<? super Flow<? extends T>, ? extends Flow<? extends R>> function1) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> skip(Flow<? extends T> flow, int i) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> void forEach(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T, R> Flow<R> scanFold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m2014catch(flow, new AnonymousClass2(function1, t, null));
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'startWith' is 'onStart'. Use 'onStart { emit(value) }'", replaceWith = @ReplaceWith(expression = "onStart { emit(value) }", imports = {}))
    public static final <T> Flow<T> startWith(Flow<? extends T> flow, T t) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> startWith(Flow<? extends T> flow, Flow<? extends T> flow2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> concatWith(Flow<? extends T> flow, T t) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> concatWith(Flow<? extends T> flow, Flow<? extends T> flow2) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    static final class C10731<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10731(long j, Continuation<? super C10731> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C10731<>(this.$timeMillis, continuation);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C10731(j, null));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Migration.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1", f = "Migration.kt", i = {}, l = {SocketMessages.PayloadType.SC_RED_PACK_RAIN_RESOURCE}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return invoke((AnonymousClass1<T>) obj, (Continuation<? super Unit>) obj2);
        }
    ...
    public static final <T> Flow<T> publish(Flow<? extends T> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> publish(Flow<? extends T> flow, int i) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> replay(Flow<? extends T> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> replay(Flow<? extends T> flow, int i) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> cache(Flow<? extends T> flow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
