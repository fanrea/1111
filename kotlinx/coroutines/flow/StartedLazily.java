...
final class StartedLazily implements SharingStarted {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> anonymousClass1 = new AnonymousClass1(this.$subscriptionCount, continuation);
        ...
        public final Object invokeSuspend(Object obj) throws KotlinNothingValueException {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C08351(booleanRef, flowCollector), (Continuation) this) == coroutine_suspended) {
        ...
        static final class C08351<T> implements FlowCollector {
            final /* synthetic */ FlowCollector<SharingCommand> $$this$flow;
            final /* synthetic */ Ref.BooleanRef $started;

            /* JADX WARN: Multi-variable type inference failed */
            C08351(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
            ...
            */
            public final java.lang.Object emit(int r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
                ...
                L51:
                    ...
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C08351.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
            }
