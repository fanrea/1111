...
final /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final class AnonymousClass6<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> anonymousClass6 = new AnonymousClass6<>(this.$flows, this.$transform, continuation);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal(flowCollector, flowArr, anonymousClass1, new AnonymousClass2(this.$transform, null), (Continuation) this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            ...
            Intrinsics.needClassReification();
            InlineMarker.mark(0);
            CombineKt.combineInternal(flowCollector, flowArr, anonymousClass1, new AnonymousClass2(this.$transform, null), (Continuation) this);
            InlineMarker.mark(1);
            return Unit.INSTANCE;
        }
    }
    ...
    public static final class AnonymousClass7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> anonymousClass7 = new AnonymousClass7<>(this.$flowArray, this.$transform, continuation);
