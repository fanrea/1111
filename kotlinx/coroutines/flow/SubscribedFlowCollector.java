...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedFlowCollector", f = "Share.kt", i = {0, 0}, l = {SocketMessages.PayloadType.SC_POP_COMMODITY, 423}, m = "onSubscription", n = {"this", "safeCollector"}, s = {"L$0", "L$1"})
