...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedSharedFlow", f = "Share.kt", i = {}, l = {bu.l}, m = "collect", n = {}, s = {})
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<?> r7) throws kotlin.KotlinNothingValueException {
        /*
            r5 = this;
