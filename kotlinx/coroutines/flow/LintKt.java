...
public final class LintKt {
    ...
    public static final <T> Flow<T> cancellable(SharedFlow<? extends T> sharedFlow) throws KotlinNothingValueException {
        FlowKt.noImpl();
    ...
    public static final <T> Flow<T> flowOn(SharedFlow<? extends T> sharedFlow, CoroutineContext coroutineContext) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> conflate(StateFlow<? extends T> stateFlow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final <T> Flow<T> distinctUntilChanged(StateFlow<? extends T> stateFlow) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    public static final boolean isActive(FlowCollector<?> flowCollector) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final void cancel(FlowCollector<?> flowCollector, CancellationException cancellationException) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }

    public static /* synthetic */ void cancel$default(FlowCollector flowCollector, CancellationException cancellationException, int i, Object obj) throws KotlinNothingValueException {
        if ((i & 1) != 0) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    public static final CoroutineContext getCoroutineContext(FlowCollector<?> flowCollector) throws KotlinNothingValueException {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    private static final <T> Flow<T> m2030catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m2014catch(sharedFlow, function3);
    }
