...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowMerge(Flow flow, int i, CoroutineContext coroutineContext, int i2, BufferOverflow bufferOverflow, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(flow, i, (i3 & 4) != 0 ? (CoroutineContext) EmptyCoroutineContext.INSTANCE : coroutineContext, (i3 & 8) != 0 ? -2 : i2, (i3 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                try {
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (this.$inner.collect(this.$collector, (Continuation) this) == coroutine_suspended) {
