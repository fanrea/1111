...
public final class DelayKt {
    ...
    */
    public static final java.lang.Object awaitCancellation(kotlin.coroutines.Continuation<?> r4) throws kotlin.KotlinNothingValueException {
        /*
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LocationRequestCompat.PASSIVE_INTERVAL) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2045scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1969delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1970toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1970toDelayMillisLRDsOJo(long j) {
        if (Duration.m1803compareToLRDsOJo(j, Duration.INSTANCE.m1907getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1822getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
