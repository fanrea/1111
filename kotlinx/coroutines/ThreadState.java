...
final class ThreadState implements Function1<Throwable, Unit> {
    ...
    public final void setup() throws KotlinNothingValueException {
        int i;
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    public final void clearInterrupt() throws KotlinNothingValueException {
        while (true) {
            int i = this._state;
            if (i != 0) {
                if (i != 2) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.KotlinNothingValueException */
    public void invoke(Throwable cause) throws KotlinNothingValueException {
        int i;
        do {
            i = this._state;
            if (i != 0) {
