...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo2044dispatch((CoroutineContext) EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo2044dispatch(CoroutineContext context, Runnable block) {
        default.mo2044dispatch(context, block);
    }
