...
public final class DebugProbesImpl {
    ...
    private final void startWeakRefCleanerThread() {
        weakRefCleanerThread = ThreadsKt.thread$default(false, true, (ClassLoader) null, "Coroutines Debugger Cleaner", 0, new Function0<Unit>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl.startWeakRefCleanerThread.1
            ...
            public final void m2013invoke() throws InterruptedException {
    ...
    private final void build(Job job, Map<Job, DebugCoroutineInfo> map, StringBuilder sb, String str) {
        ...
        if (debugCoroutineInfo == null) {
            ...
            sb.append(str + getDebugString(job) + ", continuation is " + debugCoroutineInfo.get_state() + " at line " + ((StackTraceElement) CollectionsKt.firstOrNull(debugCoroutineInfo.lastObservedStackTrace())) + '\n');
            str = str + '\t';
        }
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), new DebugProbesImpl$dumpCoroutinesInfoImpl$lambda12$$inlined$sortedBy$1()), new Function1<CoroutineOwner<?>, R>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$1$3
                ...
                public final R invoke(DebugProbesImpl.CoroutineOwner<?> coroutineOwner) {
                    ...
                    return (R) create.invoke(coroutineOwner, context);
                }
            }));
        } finally {
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        for (DebugCoroutineInfo debugCoroutineInfo : listDumpCoroutinesInfo) {
            ...
            CoroutineName coroutineName = context.get(CoroutineName.INSTANCE);
            Long lValueOf = null;
            String stringWithQuotes = (coroutineName == null || (name = coroutineName.getName()) == null) ? null : toStringWithQuotes(name);
            CoroutineDispatcher coroutineDispatcher = context.get(CoroutineDispatcher.INSTANCE);
        ...
        objArr[0] = '[' + CollectionsKt.joinToString$default(arrayList3, (CharSequence) null, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 63, (Object) null) + ']';
    ...
    private final void updateRunningState(CoroutineStackFrame frame, String state) {
        ...
        try {
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                ((Map) concurrentWeakMap).put(coroutineStackFrameRealCaller2, debugCoroutineInfo);
                Unit unit = Unit.INSTANCE;
            }
        } finally {
            lock.unlock();
