    ...
    public static final void processUtf8Bytes(String str, int i, int i2, Function1<? super Byte, Unit> function1) {
        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare(cCharAt2, 128) < 0) {
                ...
                if (Intrinsics.compare(cCharAt2, 2048) < 0) {
                    ...
                    function1.invoke(Byte.valueOf((byte) ((cCharAt2 & '?') | 128)));
                } else if (Intrinsics.compare(cCharAt2, 56319) > 0 || i2 <= (i3 = i + 1) || 56320 > (cCharAt = str.charAt(i3)) || 57343 < cCharAt) {
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 > i5) {
                        ...
                        if ((b3 & 192) == 128) {
                            int i6 = (b << 6) ^ (b3 ^ 3968);
                            function1.invoke(i6 < 128 ? Integer.valueOf(REPLACEMENT_CODE_POINT) : Integer.valueOf(i6));
                    ...
                    if (i2 <= i7) {
                        ...
                        if ((b4 & 192) == 128) {
                            ...
                            if ((b5 & 192) == 128) {
                                ...
                                function1.invoke((i9 >= 2048 && (55296 > i9 || 57343 < i9)) ? Integer.valueOf(i9) : Integer.valueOf(REPLACEMENT_CODE_POINT));
                        ...
                        if ((b6 & 192) == 128) {
                            ...
                            if ((b7 & 192) == 128) {
                                ...
                                if ((b8 & 192) == 128) {
                                    ...
                                    function1.invoke((i13 <= 1114111 && (55296 > i13 || 57343 < i13) && i13 >= 65536) ? Integer.valueOf(i13) : Integer.valueOf(REPLACEMENT_CODE_POINT));
