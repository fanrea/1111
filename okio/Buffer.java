...
public final class buffer implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        if (j < LocationRequestCompat.PASSIVE_INTERVAL && request(j) && this.bufferField.getByte(j - 1) == ((byte) 13) && request(1 + j) && this.bufferField.getByte(j) == b) {
