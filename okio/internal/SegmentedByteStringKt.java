...
public final class SegmentedByteStringKt {
    ...
    public static final void forEachSegment(SegmentedByteString segmentedByteString, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        ...
        while (i < length) {
            ...
            function3.invoke(segmentedByteString.getSegments()[i], Integer.valueOf(i3), Integer.valueOf(i4 - i2));
            i++;
            i2 = i4;
        }
    }
    ...
    public static final ByteString commonSubstring(SegmentedByteString segmentedByteString, int i, int i2) {
        ...
        if (iSegment <= iSegment2) {
            ...
            int i5 = iSegment;
            while (true) {
                iArr[i4] = Math.min(segmentedByteString.getDirectory()[i5] - i, i3);
                int i6 = i4 + 1;
                iArr[i4 + bArr2.length] = segmentedByteString.getDirectory()[segmentedByteString.getSegments().length + i5];
                if (i5 == iSegment2) {
                    break;
                }
                i5++;
    ...
    public static final byte commonInternalGet(SegmentedByteString segmentedByteString, int i) {
        ...
        Util.checkOffsetAndCount(segmentedByteString.getDirectory()[segmentedByteString.getSegments().length - 1], i, 1L);
        int iSegment = segment(segmentedByteString, i);
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, ByteString byteString, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            if (!byteString.rangeEquals(i2, segmentedByteString.getSegments()[iSegment], i7 + (i - i5), iMin)) {
                return false;
            }
            i2 += iMin;
            i += iMin;
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int i7 = segmentedByteString.getDirectory()[segmentedByteString.getSegments().length + iSegment];
            int iMin = Math.min(i4, i6 + i5) - i;
            if (!Util.arrayRangeEquals(segmentedByteString.getSegments()[iSegment], i7 + (i - i5), bArr, i2, iMin)) {
                return false;
            }
            i2 += iMin;
            i += iMin;
