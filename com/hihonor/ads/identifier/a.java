...
public class a implements ServiceConnection {
    ...
    public Context b;
    public BinderC0393a c = new BinderC0393a();
    public b d = new b();
    ...
    public class BinderC0393a extends a.AbstractBinderC0394a {
        public BinderC0393a() {
        }
    ...
    public class b extends a.AbstractBinderC0394a {
        public b() {
        }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        com.hihonor.cloudservice.oaid.b c0395a;
        ...
        try {
            ...
            if (iBinder == null) {
                ...
                c0395a = (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof com.hihonor.cloudservice.oaid.b)) ? new b.a.C0395a(iBinder) : (com.hihonor.cloudservice.oaid.b) iInterfaceQueryLocalInterface;
            }
            c0395a.b(this.c);
            c0395a.a(this.d);
        } catch (Exception e) {
