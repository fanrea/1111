...
public final class NetworkUtils {
    ...
    public static WifiScanResults getWifiScanResult() {
        ...
        if (getWifiEnabled() && (scanResults = ((WifiManager) Utils.getApp().getSystemService(a.a)).getScanResults()) != null) {
    ...
    public static void startScanWifiIfEnabled() {
        if (getWifiEnabled()) {
            ((WifiManager) Utils.getApp().getSystemService(a.a)).startScan();
        }
    }
