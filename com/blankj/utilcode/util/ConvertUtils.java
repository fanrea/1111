...
public final class ConvertUtils {
    ...
    */
    ...
    public static String byte2FitMemorySize(long j, int i) {
        ...
        if (j >= 0) {
            return j < 1024 ? String.format("%." + i + "fB", Double.valueOf(j)) : j < 1048576 ? String.format("%." + i + "fKB", Double.valueOf(j / 1024.0d)) : j < 1073741824 ? String.format("%." + i + "fMB", Double.valueOf(j / 1048576.0d)) : String.format("%." + i + "fGB", Double.valueOf(j / 1.073741824E9d));
        }
