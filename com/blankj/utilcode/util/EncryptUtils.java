...
public final class EncryptUtils {
    ...
    */
    ...
    public static byte[] encryptSHA1(byte[] bArr) {
        return hashTemplate(bArr, StringEncryptUtils.SHA_1);
    }
    ...
    public static byte[] encryptSHA256(byte[] bArr) {
        return hashTemplate(bArr, StringEncryptUtils.SHA_256);
    }
        ...
        if (bArr != null && bArr.length != 0 && bArr2 != null && bArr2.length != 0) {
            try {
                if (Build.VERSION.SDK_INT < 28) {
                    keyFactory = KeyFactory.getInstance(d.a, "BC");
                } else {
                    keyFactory = KeyFactory.getInstance(d.a);
                }
                if (z) {
