...
public class c extends gb {
    public c(com.bytedance.msdk.b.b.hc.d.d.hc hcVar, Function<SparseArray<Object>, Object> function) {
    ...
    public com.bytedance.sdk.openadsdk.w.b.hc.h d(Activity activity) {
        ...
        Object objApply = this.tc.apply(com.bytedance.sdk.openadsdk.w.c.d().d(6072).d(Object.class).d(20033, activity).hc());
        if (objApply == null) {
            return null;
        }
        final com.bytedance.sdk.openadsdk.mediation.hc.hc.an anVar = new com.bytedance.sdk.openadsdk.mediation.hc.hc.an(com.bytedance.sdk.openadsdk.j.b.d(objApply));
        return new com.bytedance.sdk.openadsdk.w.b.hc.h() { // from class: com.bytedance.msdk.b.d.d.c.1
            public boolean b() {
                return false;
            }
    ...
    public Integer an() {
        if (this.tc != null) {
            Integer numD = com.bytedance.sdk.openadsdk.core.ba.d.d.d(this.tc.apply(com.bytedance.sdk.openadsdk.w.c.d().d(8121).d(20068, 1).d(Object.class).hc()));
            if (numD != null) {
                return numD;
            }
        }
    ...
    public void d(View view, String str, int i) {
        if (e() instanceof com.bytedance.msdk.api.c.d.b.c) {
            try {
                ((com.bytedance.msdk.api.c.d.b.c) e()).d(view, str, i);
            } catch (Exception e) {
                mq.d(e);
            }
        }
    ...
    public void d(float f, float f2) {
        if (e() instanceof com.bytedance.msdk.api.c.d.b.c) {
            try {
                ((com.bytedance.msdk.api.c.d.b.c) e()).d(f, f2);
            } catch (Exception e) {
                mq.d(e);
            }
        }
    ...
    public void g() {
        d(new d() { // from class: com.bytedance.msdk.b.d.d.c.2
    ...
    public void xq() {
        hc(new d() { // from class: com.bytedance.msdk.b.d.d.c.3
            @Override // com.bytedance.msdk.b.d.d.d
            public void d() {
                if (c.this.e() != null) {
                    c.this.e().d();
    ...
    public <T> T applyFunction(int i, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i == 8134) {
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeRenderFail code:" + iIntValue + " msg:" + strStringValue + " view" + view);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeRenderSuccess width:" + fFloatValue + " height:" + fFloatValue2);
            d(fFloatValue, fFloatValue2);
        } else if (i == 8130) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeAdClick");
            g();
        } else if (i == 8113) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeAdShow");
            xq();
        } else if (i == 8145) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoStart");
            yl();
        } else if (i == 8146) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoPause");
            nz();
        } else if (i == 8150) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoResume");
            eh();
        } else if (i == 8118) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoCompleted");
            ua();
        } else if (i == 8117) {
            int iIntValue2 = pluginValueSet.intValue(8014);
            String strStringValue2 = pluginValueSet.stringValue(8015);
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoError code:" + iIntValue2 + " msg:" + strStringValue2);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeVideoError current:" + jLongValue + " duration:" + jLongValue2);
            d(jLongValue, jLongValue2);
        } else if (i == 8152) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnIdle");
            sz();
        } else if (i == 8187) {
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadActive totalBytes:" + jLongValue3 + " curlBytes:" + jLongValue4);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadPaused totalBytes:" + jLongValue5 + " curlBytes:" + jLongValue6 + " fileName:" + strStringValue3 + " appName:" + strStringValue4);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFailed totalBytes:" + jLongValue7 + " curlBytes:" + jLongValue8 + " fileName:" + strStringValue5 + " appName:" + strStringValue6);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFinished totalBytes:" + jLongValue9 + " fileName:" + strStringValue7 + " appName:" + strStringValue8);
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFinished  fileName:" + strStringValue9 + " appName:" + strStringValue10);
            d(strStringValue9, strStringValue10);
        } else if (i == 8185) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeDislikeShow");
            bq();
        } else if (i == 8184) {
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeDislikeCancel");
            ij();
        } else if (i != 6085) {
            if (i == 8110) {
                boolean zTj = tj();
                com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : isClientBiddingAd :".concat(String.valueOf(zTj)));
                return (T) Boolean.valueOf(zTj);
            }
            if (i == 8136) {
                boolean zOc = oc();
                com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : isServerBiddingAd :".concat(String.valueOf(zOc)));
                return (T) Boolean.valueOf(zOc);
            }
            if (i == 8160) {
                boolean zMt = mt();
                com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : isUseCustomVideo :".concat(String.valueOf(zMt)));
                return (T) Boolean.valueOf(zMt);
            }
            if (i == 8226) {
                int iHg = hg();
                com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : getBiddingType :".concat(String.valueOf(iHg)));
            ...
            if (i == 8132) {
                ...
                com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom draw ad : callNativeDislikeSelected postion:" + iIntValue3 + " value:" + strStringValue11);
