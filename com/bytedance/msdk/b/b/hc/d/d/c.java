...
public class c extends hc {
    public c(String str, com.bytedance.msdk.b.d.hc hcVar) {
        super(str, hcVar);
    }
    ...
    public void hc(List<Function<SparseArray<Object>, Object>> list) {
        if (list != null) {
            if (!hc()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new com.bytedance.msdk.b.d.d.u(this, it.next()));
                }
                d(arrayList);
                return;
            }
    ...
    public <T> T d(int i, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i == 8222) {
            boolean zB = b();
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom feed loader : isExpressRender: " + zB);
            return (T) Boolean.valueOf(zB);
        }
        if (i == 8223) {
            boolean zC = c();
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom feed loader : isNativeAd: " + zC);
        ...
        if (i == 8123) {
            ...
            com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom feed loader : callLoaderFail  code:" + iIntValue + " msg:" + strStringValue);
        ...
        com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "Adn custom feed loader : callLoadSucceed  list size:" + (list != null ? list.size() : 0));
        hc(list);
        return null;
    }
}
