...
public class tc extends hc {
    ...
    public tc(com.bytedance.msdk.b.d.hc hcVar) {
        super(hcVar);
    }
    ...
    private void d(z zVar, hc.d dVar) {
        ...
        new tt().d(this.b.d(), zVar, dVar.d(), this);
    }

    private void hc(z zVar, hc.d dVar) {
        com.bytedance.msdk.d.u.b.hc("TTMediationSDK", "PangleNativeLoader_loadNativeAd_renderControl:" + this.hc.cb());
        dVar.b(this.hc.cb());
        new gb().d(this.b.d(), zVar, dVar.d(), this);
    }
}
