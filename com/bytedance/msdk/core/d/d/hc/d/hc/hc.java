...
public class hc extends b {
    ...
    private int g() {
        try {
            Integer num = (Integer) an.d(new Callable<Integer>() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.1
    ...
    private int a() {
        try {
            Integer num = (Integer) an.d(new Callable<Integer>() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.7
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // java.util.concurrent.Callable
                public Integer call() throws Exception {
    ...
    private String ol() {
        try {
            String str = (String) an.d(new Callable<String>() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.8
                @Override // java.util.concurrent.Callable
    ...
    public void d(final Activity activity, final ViewGroup viewGroup, final List<View> list, final List<View> list2, final List<View> list3, final com.bytedance.msdk.api.c.d.h.tc tcVar, List<View> list4) {
        ...
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.9
    ...
    public View tc() {
        ...
        if (frameLayoutD != null) {
            ...
            if (frameLayoutD.getViewTreeObserver() != null) {
                frameLayoutD.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.10
    ...
    private Integer tl() {
        try {
            Integer num = (Integer) an.d(new Callable<Integer>() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.11
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // java.util.concurrent.Callable
                public Integer call() throws Exception {
                    return hc.this.nx();
    ...
    public void yo() {
        super.yo();
        an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.12
            @Override // java.lang.Runnable
            public void run() {
                hc.this.qa();
            }
    ...
    public void hc(Map<String, Object> map) {
        ...
        if (tcVar != null && tcVar.us()) {
            ...
            com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
            if (dVar != null && dVar.b()) {
                an.c(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.13
                    @Override // java.lang.Runnable
                    public void run() {
                        hc.this.yi(iKb);
                    }
    ...
    public void d(final Map<String, Object> map) {
        ...
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.c(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.14
                @Override // java.lang.Runnable
                public void run() {
    ...
    private String pk() {
        try {
            return (String) an.d(new Callable<String>() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.2
                @Override // java.util.concurrent.Callable
                public String call() throws Exception {
                    return hc.this.jw();
                }
    ...
    public void w() {
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.3
                @Override // java.lang.Runnable
                public void run() {
                    hc.this.le();
                }
    ...
    public void cb() {
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.4
                @Override // java.lang.Runnable
                public void run() {
                    hc.this.re();
                }
    ...
    public void d() {
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.5
                @Override // java.lang.Runnable
                public void run() {
                    hc.this.cs();
                }
    ...
    public void hc() {
        com.bytedance.msdk.core.d.d.hc.d dVar = this.mk;
        if (dVar != null && dVar.b()) {
            an.b(new Runnable() { // from class: com.bytedance.msdk.core.d.d.hc.d.hc.hc.6
                @Override // java.lang.Runnable
                public void run() {
                    hc.this.bk();
                }
