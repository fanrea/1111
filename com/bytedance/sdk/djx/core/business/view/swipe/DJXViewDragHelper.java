...
class DJXViewDragHelper {
    ...
    private static final String TAG = "DJXViewDragHelper";
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.bytedance.sdk.djx.core.business.view.swipe.DJXViewDragHelper.1
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: com.bytedance.sdk.djx.core.business.view.swipe.DJXViewDragHelper.2
        @Override // java.lang.Runnable
        public void run() {
            DJXViewDragHelper.this.setDragState(0);
        }
    };
    ...
    public static DJXViewDragHelper create(ViewGroup viewGroup, Callback callback) {
        return new DJXViewDragHelper(viewGroup.getContext(), viewGroup, callback);
    }

    public static DJXViewDragHelper create(ViewGroup viewGroup, float f, Callback callback) {
        DJXViewDragHelper dJXViewDragHelperCreate = create(viewGroup, callback);
        dJXViewDragHelperCreate.mTouchSlop = (int) (dJXViewDragHelperCreate.mTouchSlop * (1.0f / f));
        return dJXViewDragHelperCreate;
    }

    private DJXViewDragHelper(Context context, ViewGroup viewGroup, Callback callback) {
        if (viewGroup == null) {
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.djx.core.business.view.swipe.DJXViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [com.bytedance.sdk.djx.core.business.view.swipe.DJXViewDragHelper$Callback] */
