...
public class DJXRCircleView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        OvalShadow(int i) {
            DJXRCircleView.this.mShadowRadius = i;
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle(width, height, r0 - DJXRCircleView.this.mShadowRadius, paint);
        }

        private void updateRadialGradient(int i) {
            float f = i / 2;
            RadialGradient radialGradient = new RadialGradient(f, f, DJXRCircleView.this.mShadowRadius, new int[]{DJXRCircleView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
