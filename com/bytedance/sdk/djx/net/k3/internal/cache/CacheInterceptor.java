...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().getContentLength(), Okio.buffer(new Source() { // from class: com.bytedance.sdk.djx.net.k3.internal.cache.CacheInterceptor.1
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(strName) || !strValue.startsWith("1")) && (!isEndToEnd(strName) || headers2.get(strName) == null)) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (!"Content-Length".equalsIgnoreCase(strName2) && isEndToEnd(strName2)) {
