...
import com.bytedance.sdk.djx.net.k3.internal.publicsuffix.PublicSuffixDatabase;
...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, NumberFormatException, UnknownHostException {
        ...
        int i = AnonymousClass1.$SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult[parseResult.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i == 2) {
    ...
    /* renamed from: com.bytedance.sdk.djx.net.k3.HttpUrl$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult;

        static {
            int[] iArr = new int[Builder.ParseResult.values().length];
            $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult = iArr;
            try {
                iArr[Builder.ParseResult.SUCCESS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult[Builder.ParseResult.INVALID_HOST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult[Builder.ParseResult.UNSUPPORTED_SCHEME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult[Builder.ParseResult.MISSING_SCHEME.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$bytedance$sdk$djx$net$k3$HttpUrl$Builder$ParseResult[Builder.ParseResult.INVALID_PORT.ordinal()] = 5;
    ...
    public static final class Builder {
        ...
        ParseResult parse(HttpUrl httpUrl, String str) throws NumberFormatException {
    ...
    */
    static void percentDecode(com.bytedance.sdk.djx.net.io.Buffer r5, java.lang.String r6, int r7, int r8, boolean r9) {
        /*
        L0:
            if (r7 >= r8) goto L42
            ...
            int r2 = com.bytedance.sdk.djx.net.k3.internal.Util.decodeHexDigit(r2)
            char r3 = r6.charAt(r1)
            int r3 = com.bytedance.sdk.djx.net.k3.internal.Util.decodeHexDigit(r3)
            r4 = -1
            if (r2 == r4) goto L39
            if (r3 == r4) goto L39
            int r7 = r2 << 4
        ...
        L42:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.djx.net.k3.HttpUrl.percentDecode(com.bytedance.sdk.djx.net.io.Buffer, java.lang.String, int, int, boolean):void");
    }
