...
public final class ConnectionPool {
    ...
    private static final Executor defaultExecutor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkHttp ConnectionPool", false));
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        this.cleanupRunnable = new Runnable() { // from class: com.bytedance.sdk.djx.net.k3.ConnectionPool.1
