...
class Stats {
    ...
    private static final String STATS_THREAD_NAME = "DJXSdk-img-Stats";
    ...
    private static class StatsHandler extends Handler {
        ...
        public void handleMessage(final Message message) {
            ...
            if (i == 3) {
                ...
                Picasso.HANDLER.post(new Runnable() { // from class: com.bytedance.sdk.djx.net.img.Stats.StatsHandler.1
