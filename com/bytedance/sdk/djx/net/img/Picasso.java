...
import com.bytedance.sdk.djx.net.img.Action;
import com.bytedance.sdk.djx.net.img.RemoteViewsAction;
import java.io.File;
...
public class Picasso {
    ...
    static final Handler HANDLER = new Handler(Looper.getMainLooper()) { // from class: com.bytedance.sdk.djx.net.img.Picasso.1
    ...
    public interface RequestTransformer {
        public static final RequestTransformer IDENTITY = new RequestTransformer() { // from class: com.bytedance.sdk.djx.net.img.Picasso.RequestTransformer.1
            @Override // com.bytedance.sdk.djx.net.img.Picasso.RequestTransformer
        ...
        public void run() throws SecurityException, IllegalArgumentException {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new Runnable() { // from class: com.bytedance.sdk.djx.net.img.Picasso.CleanupThread.1
