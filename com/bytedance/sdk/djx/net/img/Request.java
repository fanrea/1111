...
public final class Request {
    ...
    public String toString() {
        ...
        if (this.targetWidth > 0) {
            sb.append(" resize(").append(this.targetWidth).append(StringUtil.COMMA).append(this.targetHeight).append(')');
        }
        if (this.centerCrop) {
        ...
        if (this.rotationDegrees != 0.0f) {
            ...
            if (this.hasRotationPivot) {
                sb.append(" @ ").append(this.rotationPivotX).append(StringUtil.COMMA).append(this.rotationPivotY);
            }
            sb.append(')');
        }
        if (this.config != null) {
