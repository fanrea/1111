...
public class d implements View.OnTouchListener {
    ...
    private SoftReference<ViewGroup> tc = new SoftReference<>(null);

    public d(com.bytedance.sdk.component.adexpress.dynamic.interact.gb gbVar, int i, final ViewGroup viewGroup) {
        this.u = b;
        this.c = gbVar;
        if (i > 0) {
            this.u = i;
        ...
        if (viewGroup != null) {
            viewGroup.post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.dynamic.interact.d.d.1
                ...
                public void run() {
                    d.this.tc = new SoftReference(viewGroup);
                }
            });
        }
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int i = this.u;
            if (fAbs >= i && fAbs2 >= i) {
                com.bytedance.sdk.component.adexpress.dynamic.interact.gb gbVar2 = this.c;
                if (gbVar2 != null) {
                    gbVar2.d();
                }
            } else if ((System.currentTimeMillis() - this.h < 200 || (fAbs < 3.0f && fAbs2 < 3.0f)) && (gbVar = this.c) != null) {
                gbVar.d();
            }
        }
        return true;
