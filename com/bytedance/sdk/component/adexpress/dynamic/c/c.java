...
public class c {
        ...
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                if (objOpt2 == null || objOpt2 == JSONObject.NULL) {
                    ...
                    jSONObject3.put(next, d((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONObject3.put(next, d((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
    ...
    private static JSONArray d(JSONArray jSONArray, JSONArray jSONArray2) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (objOpt2 == null || objOpt2 == JSONObject.NULL) {
                    ...
                    jSONArray3.put(i, d((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONArray3.put(i, d((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
