...
public class b {
    public static float[] d(List<Float> list, List<Float> list2, List<Float> list3, List<Float> list4, List<Float> list5, List<Float> list6) {
    ...
    public static int[][] d(List<JSONObject> list, long j, long j2) throws JSONException {
        int size = list.size();
        ...
        return new int[][]{d(dArr, j), d(dArr2, j2), d(dArr3, j2)};
    }

    public static int[] d(double[] dArr, long j) {
        if (j <= 0 || j > 360) {
            return new int[0];
        }
    ...
    public static int[] d(LinkedList<JSONObject> linkedList, int i) {
        int[] iArr = new int[i];
