...
public final class GameReportHelper {
    ...
    public static void onEventAccessAccount(String str, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("account_type", str);
            jSONObject.put("is_success", l0.b.a(z));
    ...
    public static void onEventAccessPaymentChannel(String str, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventAddCart(String str, String str2, String str3, int i, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventAddToFavorite(String str, String str2, String str3, int i, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("content_type", str);
            jSONObject.put("content_name", str2);
    ...
    public static void onEventCheckOut(String str, String str2, String str3, int i, boolean z, String str4, String str5, boolean z2, int i2) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("content_type", str);
            jSONObject.put("content_name", str2);
            jSONObject.put("content_id", str3);
            jSONObject.put("content_num", i);
            jSONObject.put("is_virtual_currency", l0.b.a(z));
            jSONObject.put("virtual_currency", str4);
            jSONObject.put("currency", str5);
            jSONObject.put("is_success", l0.b.a(z2));
    ...
    public static void onEventCreateGameRole(String str) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventLogin(String str, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventPurchase(String str, String str2, String str3, int i, String str4, String str5, boolean z, int i2) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("content_type", str);
            jSONObject.put("content_name", str2);
    ...
    public static void onEventQuest(String str, String str2, String str3, int i, boolean z, String str4) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventRegister(String str, boolean z) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(e.s, str);
            jSONObject.put("is_success", l0.b.a(z));
    ...
    public static void onEventUpdateLevel(int i) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void onEventViewContent(String str, String str2, String str3) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("content_type", str);
            jSONObject.put("content_name", str2);
