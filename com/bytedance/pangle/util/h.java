...
public class h {
    ...
    public static void d(InputStream inputStream, OutputStream outputStream) throws IOException {
        d(inputStream, outputStream, 0L, 1048576);
    }

    private static void d(InputStream inputStream, OutputStream outputStream, long j, int i) throws IOException {
    ...
    public static void d(ZipFile zipFile) throws IOException {
        if (zipFile != null) {
            try {
                zipFile.close();
            } catch (IOException unused) {
    ...
    public static String d(Context context) {
        File parentFile;
        if (d == null && (parentFile = context.getCacheDir().getParentFile()) != null) {
    ...
    public static String hc(Context context) {
        File parentFile;
        if (hc == null && (parentFile = context.getCacheDir().getParentFile()) != null) {
            try {
                hc = parentFile.getCanonicalPath();
            } catch (IOException e) {
    ...
    public static void d(RandomAccessFile randomAccessFile, RandomAccessFile randomAccessFile2, long j, long j2, String str) throws IOException {
        byte[] bArr;
        long j3 = 0;
        if (j < 0 || j2 < 0 || j > j2) {
    ...
    public static void hc(String str, String str2) throws Exception {
    ...
    public static boolean hc(File file) throws IOException {
