...
public class gb {
    ...
    private static void d(InputStream inputStream, OutputStream outputStream, int i) throws IOException {
        ...
        d(readableByteChannelNewChannel, writableByteChannelNewChannel, i);
    ...
    public static boolean d(String str, File file, StringBuilder sb) throws IOException {
        try {
    ...
    private static void d(ReadableByteChannel readableByteChannel, WritableByteChannel writableByteChannel, int i) throws IOException {
