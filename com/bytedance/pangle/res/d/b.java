...
public class b {
    public int d(File file, boolean z, StringBuilder sb) {
        String string;
        ...
        try {
            ...
            try {
                ...
                if (z) {
                    ...
                    string = com.bytedance.pangle.util.gb.d(file2);
                } else {
                    ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
                    com.bytedance.pangle.util.gb.d(zipFile2.getInputStream(entry), byteArrayOutputStream);
                ...
                final int[] iArr = {0};
                try {
                    d(file, hashSet, new gb() { // from class: com.bytedance.pangle.res.d.b.1
                        @Override // com.bytedance.pangle.res.d.gb
                        public int d(int i2) {
                            ...
                            if (identifier == 0) {
                                identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.split(" ")[1].replaceAll(Config.replace, "."), str2.split(" ")[0], Zeus.getAppApplication().getPackageName());
                            }
                            if (identifier == 0) {
                    ...
                    if (com.bytedance.pangle.util.gb.d(jSONObject2.toString(), new File(file.getParentFile(), "resMappingBak"), sb)) {
                        com.bytedance.pangle.util.h.d(zipFile2);
                        return 100;
                    }
    ...
    private void d(File file, HashSet<String> hashSet, gb gbVar) throws Throwable {
        MappedByteBuffer mappedByteBufferD = d(file);
        int iD = d(mappedByteBufferD);
        if (iD == -1) {
            throw new Throwable("endOfCentralPosition == -1");
        }
        int i = mappedByteBufferD.getInt(iD + 12);
        int i2 = mappedByteBufferD.getInt(iD + 16);
        int i3 = i + i2;
        while (i2 < i3) {
            if (mappedByteBufferD.getInt(i2) != 33639248) {
                throw new RuntimeException("Expected: 0x02014b50, got: " + mappedByteBufferD.getInt(i2));
            }
            int i4 = mappedByteBufferD.getShort(i2 + 28);
            short s = mappedByteBufferD.getShort(i2 + 30);
            byte[] bArr = new byte[i4];
            for (int i5 = 0; i5 < i4; i5++) {
                bArr[i5] = mappedByteBufferD.get(i2 + 46 + i5);
            }
            String str = new String(bArr);
            int i6 = mappedByteBufferD.getInt(i2 + 20);
            int i7 = mappedByteBufferD.getInt(i2 + 24);
            if (hashSet.contains(str)) {
                if (i6 != i7) {
                    throw new Throwable(str + " is compressed.");
                }
                com.bytedance.pangle.util.u<Integer, byte[]> uVarD = d(mappedByteBufferD, mappedByteBufferD.getInt(i2 + 42), str);
                try {
                    mk.d(str, uVarD.hc, gbVar);
                    for (int i8 = 0; i8 < uVarD.hc.length; i8++) {
                        mappedByteBufferD.put(uVarD.d.intValue() + i8, uVarD.hc[i8]);
                    }
                } catch (Throwable th) {
    ...
    private static com.bytedance.pangle.util.u<Integer, byte[]> d(MappedByteBuffer mappedByteBuffer, int i, String str) {
        ...
        return new com.bytedance.pangle.util.u<>(Integer.valueOf(i4), bArr);
    }
    ...
    public MappedByteBuffer d(File file) throws Throwable {
