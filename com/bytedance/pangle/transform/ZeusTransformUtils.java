...
public class ZeusTransformUtils {
    ...
    public static int mapRes(int i, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace(Config.replace, "."), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
    ...
    public static void requestPermissions(Object obj, String[] strArr, int i, String str) throws NoSuchFieldException {
