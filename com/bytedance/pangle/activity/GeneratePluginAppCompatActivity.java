...
public abstract class GeneratePluginAppCompatActivity extends AppCompatActivity implements IPluginActivity {
    ...
    public void attachBaseContext(Context context) {
        ...
        com.bytedance.pangle.util.d.d(this, this.mProxyActivity);
    }

    @Override // androidx.fragment.app.FragmentActivity, androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, android.app.Activity
    public void onCreate(Bundle bundle) {
        this.mProxyActivity.zeusSuperOnCreate(bundle);
        com.bytedance.pangle.res.hc.d(getLayoutInflater());
    }
    ...
    public void setContentView(int i) {
        ...
        ZeusTransformUtils.clearConstructorCache();
        b.d(this, findViewById(R.id.content));
    }
    ...
    public void setPluginProxyActivity(hc hcVar, Plugin plugin) {
        this.mProxyActivity = (GenerateProxyAppCompatActivity) hcVar;
        this.mPlugin = plugin;
    }
