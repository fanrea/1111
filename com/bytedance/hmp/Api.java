...
public class Api {
    ...
    static native void frame_unlock(Bitmap bitmap);
    ...
    static native long image_make(int width, int height, int channels, int cformat, int dtype, String device, boolean pinned_memory);
