...
public class JavaCallsUtils {
    ...
    public static <T> T callMethod(Object obj, String str, Object... objArr) {
        try {
            ...
            an.c(LOG_TAG, "Meet exception when call Method '" + str + "' in " + obj, e);
            return null;
        }
    }
    ...
    public static <T> T callStaticMethod(String str, String str2, Object... objArr) {
        try {
            ...
            an.c(LOG_TAG, "Meet exception when call Method '" + str2 + "' in " + str, e);
            return null;
        }
    }
    ...
    public static <T> T newEmptyInstance(Class<?> cls) {
        try {
            ...
            an.c(LOG_TAG, "Meet exception when make instance as a " + cls.getSimpleName(), e);
            return null;
        }
    }
    ...
    public static Object newInstance(String str, Object... objArr) {
        try {
            ...
            an.c(LOG_TAG, "Meet exception when make instance as a ".concat(String.valueOf(str)), e);
            return null;
        }
    }
