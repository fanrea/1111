...
public class ad extends RelativeLayout {
    ...
    public ad(Context context, AbstractData abstractData, u uVar) {
        ...
        this.H = 20;
        this.J = 12;
        this.f797K = Color.parseColor("#858585");
        this.L = 7;
        this.M = 11;
        this.N = 30;
        this.O = 20;
    ...
    private void aF() {
        this.I.setText("权限");
        this.I.setTextColor(this.f797K);
    ...
    private void aJ() {
        this.v = new i(this.ad, this.w, this.x, 20, 20);
        this.v.a(this.y);
    }
    ...
    private void aQ() {
        if (this.j != null && !TextUtils.isEmpty(this.j.getBrandName())) {
