    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!this.lastPossibleResultPoints.isEmpty()) {
            ...
            for (ResultPoint resultPoint : this.lastPossibleResultPoints) {
                canvas.drawCircle(((int) (resultPoint.getX() * fWidth)) + i, ((int) (resultPoint.getY() * fHeight)) + i2, 3.0f, this.paint);
            }
        ...
        if (!this.possibleResultPoints.isEmpty()) {
            ...
            for (ResultPoint resultPoint2 : this.possibleResultPoints) {
                canvas.drawCircle(((int) (resultPoint2.getX() * fWidth)) + i, ((int) (resultPoint2.getY() * fHeight)) + i2, 6.0f, this.paint);
            }
