...
public final class ji implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.o> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.o oVar, JSONObject jSONObject) {
        ...
        oVar.ajh = jSONObject.optBoolean("showConfirmDialog");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.o oVar, JSONObject jSONObject) {
        ...
        if (oVar.ajh) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "showConfirmDialog", oVar.ajh);
        }
        return jSONObject;
    }
}
