...
public final class cq implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.f> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.f fVar, JSONObject jSONObject) {
        ...
        fVar.aiX = jSONObject.optInt("closeDelaySeconds");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.f fVar, JSONObject jSONObject) {
        ...
        if (fVar.aiX != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "closeDelaySeconds", fVar.aiX);
        }
        return jSONObject;
    }
}
