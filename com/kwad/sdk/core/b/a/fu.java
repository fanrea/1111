...
public final class fu implements com.kwad.sdk.core.d<AdInfo.FullScreenVideoInfo> {
    ...
    private static JSONObject b(AdInfo.FullScreenVideoInfo fullScreenVideoInfo, JSONObject jSONObject) {
        ...
        if (fullScreenVideoInfo.fullScreenEndCardSwitch) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "fullScreenEndCardSwitch", fullScreenVideoInfo.fullScreenEndCardSwitch);
        }
        return jSONObject;
    }
}
