...
public final class cv implements com.kwad.sdk.core.d<AdMatrixInfo.ComponentParam> {
    ...
    private static JSONObject b(AdMatrixInfo.ComponentParam componentParam, JSONObject jSONObject) {
        ...
        if (componentParam.pageId != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "page_id", componentParam.pageId);
        }
        if (componentParam.endPageId != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "endcard_page_id", componentParam.endPageId);
        }
        return jSONObject;
    }
}
