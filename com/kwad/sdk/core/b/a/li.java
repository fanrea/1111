...
public final class li implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.r> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.r rVar, JSONObject jSONObject) {
        ...
        rVar.ajj = jSONObject.optBoolean("userForce");
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.r rVar, JSONObject jSONObject) {
        ...
        if (rVar.ajj) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "userForce", rVar.ajj);
        }
        if (rVar.type != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "type", rVar.type);
        }
        return jSONObject;
    }
}
