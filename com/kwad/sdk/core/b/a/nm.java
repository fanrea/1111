...
public final class nm implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.w> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.w wVar, JSONObject jSONObject) {
        ...
        wVar.ajl = jSONObject.optInt("rewardTaskState");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.w wVar, JSONObject jSONObject) {
        ...
        if (wVar.ajl != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "rewardTaskState", wVar.ajl);
        }
        return jSONObject;
    }
}
