...
public final class hi implements com.kwad.sdk.core.d<com.kwad.components.ad.interstitial.c.b> {
    ...
    private static void a(com.kwad.components.ad.interstitial.c.b bVar, JSONObject jSONObject) {
        ...
        bVar.nN = jSONObject.optInt("currentDailyAdShowCount");
        bVar.nO = jSONObject.optInt("currentDailyRetainShowCount");
    }
    ...
    private static JSONObject b(com.kwad.components.ad.interstitial.c.b bVar, JSONObject jSONObject) {
        ...
        if (bVar.nN != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "currentDailyAdShowCount", bVar.nN);
        }
        if (bVar.nO != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "currentDailyRetainShowCount", bVar.nO);
        }
        return jSONObject;
    }
}
