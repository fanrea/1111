...
public class Wrapper {
    ...
    public static Context wrapContextIfNeed(Context context) {
        Context context2 = (Context) com.kwad.sdk.api.b.g("WRC", context);
        if (context2 != null) {
            return context2;
        }
    ...
    private static boolean returnUnWrappedContext(Context context) {
        ...
        if (aVar != null) {
            if (aVar.bhH.get() != context || Math.abs(System.currentTimeMillis() - aVar.bhL) >= 150) {
                ...
                a.c(aVar);
                if (aVar.bhI >= (context instanceof Application ? 15 : 5) && needAutoUnWrap(context, aVar)) {
                    aVar.clear();
                    return true;
                }
            }
    ...
    private static boolean needAutoUnWrap(Context context, a aVar) {
        ...
        if (!containsAllElements(stackTrace, aVar.bhJ)) {
            if (aVar.bhJ != null) {
                aVar.clear();
                return false;
            }
    ...
    public static LayoutInflater wrapInflaterIfNeed(LayoutInflater layoutInflater) {
        LayoutInflater layoutInflater2 = (LayoutInflater) com.kwad.sdk.api.b.g("WRI", layoutInflater);
    ...
    public static Context unwrapContextIfNeed(Context context) {
        Context context2 = (Context) com.kwad.sdk.api.b.g("URC", context);
        if (context2 != null) {
            return context2;
        }
    ...
    static Resources.Theme replaceTheme(Resources.Theme theme, Resources.Theme theme2, int i) {
        Resources.Theme theme3 = (Resources.Theme) com.kwad.sdk.api.b.g("WRT", theme, theme2, Integer.valueOf(i));
        if (theme3 != null) {
            return theme3;
        }
        Resources externalResource = Loader.get().getExternalResource();
    ...
    static int getThemeResId(Context context) {
        if (context instanceof ContextThemeWrapper) {
            Object obj = ApiReflect.m(context).dH("getThemeResId").get();
            if (obj != null) {
