...
public class SceneImpl extends com.kwad.sdk.core.response.a.a implements KsScene, Serializable, Cloneable {
    ...
    public static void register() {
        c.h(KsScene.class, SceneImpl.class);
    }
    ...
    public void setPosId(long j) {
        this.posId = j;
        this.entryScene = j;
        if (!com.kwad.framework.a.a.qr.booleanValue() || bt.getPosId() == 0) {
            return;
        }
        this.posId = bt.getPosId();
        this.entryScene = bt.getPosId();
    }
    ...
    public void setAdNum(int i) {
        this.adNum = i;
        if (!com.kwad.framework.a.a.qr.booleanValue() || bt.aqp() == 0) {
            return;
        }
        this.adNum = (int) bt.aqp();
    }
