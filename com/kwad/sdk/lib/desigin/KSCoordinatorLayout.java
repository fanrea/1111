  ...
  0x002b: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:9:0x0022, B:5:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        L16:
            ...
            com.kwad.sdk.lib.desigin.KSCoordinatorLayout$LayoutParams r6 = (com.kwad.sdk.lib.desigin.KSCoordinatorLayout.LayoutParams) r6
            com.kwad.sdk.lib.desigin.KSCoordinatorLayout$Behavior r6 = r6.getBehavior()
            if (r6 == 0) goto L2b
        ...
        L57:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.desigin.KSCoordinatorLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private int getKeyline(int i) {
        ...
        if (iArr == null) {
            c.e(TAG, "No keylines defined for " + this + " - attempted index lookup " + i);
            return 0;
        }
        if (i < 0 || i >= iArr.length) {
            c.e(TAG, "Keyline index " + i + " out of range for " + this);
            return 0;
        }
        return iArr[i];
    }
        ...
        if (!layoutParams.mBehaviorResolved) {
            ...
            if (defaultBehavior != null) {
                try {
                    ...
                    c.e(TAG, "Default behavior class " + defaultBehavior.value().getName() + " could not be instantiated. Did you forget a default constructor?", e);
                }
            }
    ...
    */
    protected void onMeasure(int r31, int r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.desigin.KSCoordinatorLayout.onMeasure(int, int):void");
    }
    ...
    */
    final void onChildViewsChanged(int r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.desigin.KSCoordinatorLayout.onChildViewsChanged(int):void");
    }
    ...
    private void setupForInsets() {
        ...
        if (ViewCompat.getFitsSystemWindows(this)) {
            ...
            setSystemUiVisibility(SocketMessages.PayloadType.SC_LIVE_BULLET_CLOUD_PLAY_OPERATION_TYPE_NOTICE);
            return;
        }
