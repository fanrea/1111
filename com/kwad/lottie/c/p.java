...
final class p {
    ...
    /* renamed from: com.kwad.lottie.c.p$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                bpu[JsonToken.BEGIN_ARRAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                bpu[JsonToken.BEGIN_OBJECT.ordinal()] = 3;
    ...
    static PointF e(JsonReader jsonReader, float f) {
        int i = AnonymousClass1.bpu[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float f(JsonReader jsonReader) throws IOException {
        ...
        int i = AnonymousClass1.bpu[jsonTokenPeek.ordinal()];
        if (i == 1) {
