...
public final class i implements t {
    ...
    public final void c(com.kwad.sdk.core.webview.c.a aVar) {
        ...
        this.bcq.registerJsBridge(new b(aVar));
    }
    ...
    public final void b(com.kwad.sdk.core.webview.c.g gVar) {
        ...
        this.bcq.registerTKBridge(new f(gVar));
    }

    @Override // com.kwad.sdk.components.t
    public final void setCustomEnv(Map<String, Object> map) {
        this.bcq.setCustomEnv(map);
    }

    @Override // com.kwad.sdk.components.t
    public final void a(r rVar) {
        if (rVar != null) {
            this.bcq.registerHostActionHandler(new c(rVar));
        }
    }
    ...
    public final void a(k kVar) {
        if (kVar != null) {
            this.bcq.registerApkLoadCreator(new e(kVar));
        }
    }

    @Override // com.kwad.sdk.components.t
    public final int getUniqId() {
        return this.bcq.getUniqId();
    }
}
