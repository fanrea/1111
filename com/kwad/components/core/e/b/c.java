...
public final class c {
    ...
    private static long e(int i, int[] iArr, long j) {
        ...
        return ((i9 ^ b.Qt[(i3 ^ b.Qt[i9 ^ i6]) ^ i7]) << 8) | (b.Qt[i8 ^ r5] ^ r6);
    }
    ...
    private static long f(int i, int[] iArr, long j) {
        ...
        int i8 = iArr[i4 % 10];
        int i9 = b.Qt[i5 ^ i3] ^ i2;
        return (i9 ^ b.Qt[(i3 ^ b.Qt[i9 ^ i6]) ^ i7]) | ((b.Qt[i8 ^ r5] ^ r6) << 8);
    }

    public final String z(long j) {
        return com.kwad.sdk.core.a.c.ZX().encodeToString(ByteBuffer.allocate(8).putLong(a(j, this.Qu)).array());
    }

    public final long ao(String str) {
        byte[] bArrDecode = com.kwad.sdk.core.a.c.aaa().decode(str);
