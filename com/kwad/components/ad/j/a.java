...
public final class a {
    ...
    private void initView() {
        this.Dp = (Button) this.Iv.findViewById(R.id.ksad_reward_apk_info_install_action);
        this.Dq = (Button) this.Iv.findViewById(R.id.ksad_reward_apk_info_install_start);
        this.Do = this.Iv.findViewById(R.id.ksad_reward_apk_info_install_container);
    }

    public final void ji() throws Resources.NotFoundException {
        ...
        if (this.mm == null) {
            Animator animatorA = a(this.Dq, this.Dp, width, height, 1600L, 200L);
            this.mm = animatorA;
            animatorA.addListener(new com.kwad.components.ad.widget.tailframe.appbar.b() { // from class: com.kwad.components.ad.j.a.1
                ...
                public final void onAnimationEnd(final Animator animator) {
                    ...
                    if (a.this.Nv == null) {
                        a.this.Nv = new Runnable() { // from class: com.kwad.components.ad.j.a.1.1
                    ...
                    bx.a(a.this.Nv, null, 1600L);
                }
            });
        }
        com.kwad.sdk.core.d.c.d("ApkInstallAnimHelper", "mAnimator isStarted: " + this.mm.isStarted());
