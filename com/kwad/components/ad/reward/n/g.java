...
public final class g extends s implements View.OnClickListener {
    ...
    public final void a(final a aVar, long j) throws Resources.NotFoundException {
        ...
        if (animatorS == null) {
            ...
            this.xM.postDelayed(new bh() { // from class: com.kwad.components.ad.reward.n.g.2
    ...
    protected final void a(r rVar) {
        ...
        if (adTemplate == null || (str = com.kwad.sdk.core.response.b.b.dS(adTemplate).title) == null || (textView = this.mf) == null) {
            return;
        }
    ...
    public final void onClick(View view) {
        if (view.equals(this.xM)) {
            com.kwad.components.ad.reward.g gVar = this.vb;
