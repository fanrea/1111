...
public class RewardMonitorInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public boolean enableRewardLayoutOptimise = com.kwad.components.ad.reward.a.b.hR();
    public boolean enableFullscreenLayoutOptimise = com.kwad.components.ad.reward.a.b.hS();
    ...
    public void afterToJson(JSONObject jSONObject) {
        ...
        if (i != -1) {
            aa.putValue(jSONObject, WindAds.REWARD_TYPE, i);
        } else {
    ...
    public RewardMonitorInfo setAdTemplate(AdTemplate adTemplate) {
        ...
        rewardMonitorInfo.setOperationType(com.kwad.sdk.core.response.b.a.aU(adInfoEP));
        rewardMonitorInfo.setMaterialRenderType(com.kwad.components.ad.reward.model.d.m(adInfoEP));
        rewardMonitorInfo.setTKRenderType(com.kwad.sdk.core.response.b.b.a(iEJ == 2, adInfoEP));
