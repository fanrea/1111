...
public final class a extends com.kwad.components.ad.reward.presenter.b {
    private AdLiveHandleClickListener fN = new AdLiveHandleClickListener() { // from class: com.kwad.components.ad.reward.presenter.b.a.1
        ...
        public final void handleAdLiveClick(int i) {
            if (i == 1) {
                a.this.vb.a(1, a.this.getContext(), 115, 1);
            } else if (i == 2) {
                a.this.vb.a(1, a.this.getContext(), 117, 1);
            }
        }
    };
    ...
    public final void ay() {
        super.ay();
        if (this.vb.fq != null) {
            this.vb.fq.registerClickListener(this.fN);
        }
    }
    ...
    public final void onUnbind() {
        super.onUnbind();
        if (this.vb.fq != null) {
            this.vb.fq.unRegisterClickListener(this.fN);
        }
    }
}
