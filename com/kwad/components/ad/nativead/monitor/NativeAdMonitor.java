...
public final class NativeAdMonitor {
    private static void c(a aVar) {
        try {
            b.d(c.Wz().dW(ILoggerReporter.Category.APM_LOG).l(0.01d).V("ad_sdk_native_container_monitor", "state").b(BusinessType.AD_NATIVE).w(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.crg));
        } catch (Exception e) {
