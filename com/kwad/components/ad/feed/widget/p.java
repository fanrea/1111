...
public final class p extends a implements View.OnClickListener, com.kwad.sdk.widget.e {
    ...
    private void cs() {
        ...
        com.kwad.sdk.c.a.a.a(this, this.jt, this.ki, this.jA);
    ...
    private void d(View view, final int i) {
        if (view == this.jv) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0469a(getContext()).aE(5).aF(i).aC(this.mAdTemplate).b(this.mApkDownloadHelper).aG(view == this.jA ? 1 : 2).aq(view == this.jA).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.p.1
