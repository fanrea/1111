...
public final class b {
    ...
    private static com.kwad.components.core.widget.b a(Context context, FeedType feedType) {
        switch (AnonymousClass1.iz[feedType.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iA[FeedType.FeedDefaultType.FEED_VERTICAL_NOVEL_DEFAULT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iA[FeedType.FeedDefaultType.FEED_VERTICAL_BISERIAL_DEFAULT.ordinal()] = 3;
            ...
            try {
                iz[FeedType.FEED_TYPE_TEXT_ABOVE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iz[FeedType.FEED_TYPE_TEXT_BELOW.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iz[FeedType.FEED_TYPE_TEXT_LEFT.ordinal()] = 4;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iz[FeedType.FEED_TYPE_TEXT_RIGHT.ordinal()] = 5;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iz[FeedType.FEED_TYPE_VERTICAL_ORIGIN.ordinal()] = 6;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iz[FeedType.FEED_TYPE_VERTICAL_NOVEL.ordinal()] = 7;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iz[FeedType.FEED_TYPE_VERTICAL_BISERIAL.ordinal()] = 8;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                iz[FeedType.FEED_TYPE_TEXT_ABOVE_GROUP.ordinal()] = 9;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                iz[FeedType.FEED_TYPE_UNKNOWN.ordinal()] = 10;
    ...
    private static com.kwad.components.core.widget.b b(Context context, FeedType feedType) {
        ...
        int i = AnonymousClass1.iA[feedDefaultType.ordinal()];
        if (i == 1) {
            return new k(context);
        }
        if (i == 2) {
