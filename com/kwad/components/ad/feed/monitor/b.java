...
public final class b {
    ...
    public static void a(AdTemplate adTemplate, int i, int i2, long j, String str) {
        b(new FeedPageInfo().setStatus(5).setType(adTemplate.type).setMaterialType(com.kwad.sdk.core.response.b.a.bk(e.eP(adTemplate))).setRenderType(i).setLoadType(adTemplate.loadType).setExpectedRenderType(i2).setErrorMsg(str).setRenderDuration(j).setAdTemplate(adTemplate), (i == 2 || i == 3) ? false : true);
    }

    public static void a(int i, long j) {
        JSONObject jSONObject = new JSONObject();
        aa.putValue(jSONObject, "feedLoadOptimizeType", com.kwad.sdk.core.config.e.XA());
        aa.putValue(jSONObject, "feedLoadOptimizeExternalEnable", com.kwad.sdk.core.config.e.XD());
        aa.putValue(jSONObject, "isExternal", l.UL().TQ());
    ...
    public static void c(AdTemplate adTemplate, int i, int i2) {
        ...
        aa.putValue(jSONObject, "feedLoadOptimizeExternalEnable", com.kwad.sdk.core.config.e.XD());
        aa.putValue(jSONObject, "isExternal", l.UL().TQ());
        a(new FeedPageInfo().setStatus(7).setType(adTemplate.type).setLoadType(adTemplate.loadType).setMaterialType(com.kwad.sdk.core.response.b.a.bk(e.eP(adTemplate))).setRenderType(i).setExpectedRenderType(i2).setAbParams(jSONObject.toString()).setAdTemplate(adTemplate));
    }

    public static void a(AdTemplate adTemplate, int i, long j) {
        a(new FeedPageInfo().setStatus(8).setType(adTemplate.type).setMaterialType(com.kwad.sdk.core.response.b.a.bk(e.eP(adTemplate))).setRenderType(i).setConvertDuration(j).setAdTemplate(adTemplate));
    }
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar, boolean z) {
        try {
            com.kwad.sdk.commercial.b.d(c.Wz().dW(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).l(z ? 0.01d : 0.001d).V("ad_sdk_feed_load", "status").b(BusinessType.AD_FEED).w(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.crg));
        } catch (Exception e) {
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar) {
        try {
            com.kwad.sdk.commercial.b.d(c.Wz().dW(ILoggerReporter.Category.APM_LOG).l(0.01d).V("ad_sdk_feed_callback", "callback_type").b(BusinessType.AD_FEED).w(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.crg));
        } catch (Exception e) {
    ...
    public static void a(int i, AdTemplate adTemplate, String str, int i2) {
        b(new FeedPageInfo().setCallbackType(i).setMaterialType(com.kwad.sdk.core.response.b.a.bk(e.eP(adTemplate))).setMaterialUrl(str).setRenderType(i2).setAdTemplate(adTemplate));
    }
    ...
    public static void a(long j, List<KsFeedAd> list) {
        ...
        b(new FeedPageInfo().setCallbackType(1).setPosId(j).setMaterialInfoList(d(list)).setAdTemplate(((com.kwad.components.ad.feed.c) list.get(0)).getAdTemplate()));
    }

    private static void a(String str, FeedErrorInfo feedErrorInfo, double d) {
        try {
            com.kwad.sdk.commercial.b.d(c.Wz().dW(ILoggerReporter.Category.ERROR_LOG).b(BusinessType.AD_FEED).V(str, ILogConst.PLAY_SOURCE_DEFAULT).dX(str).a(com.kwai.adclient.kscommerciallogger.model.a.crg).w(feedErrorInfo).l(d));
        } catch (Exception e) {
    ...
    private static List<FeedPageInfo.a> d(List<KsFeedAd> list) {
        ArrayList arrayList = new ArrayList();
        for (KsFeedAd ksFeedAd : list) {
            if (ksFeedAd instanceof com.kwad.components.ad.feed.c) {
                AdInfo adInfoEP = e.eP(((com.kwad.components.ad.feed.c) ksFeedAd).getAdTemplate());
                arrayList.add(new FeedPageInfo.a().i(com.kwad.sdk.core.response.b.a.K(adInfoEP)).D(com.kwad.sdk.core.response.b.a.bk(adInfoEP)).t(com.kwad.sdk.core.response.b.a.bh(adInfoEP)));
            }
        }
        return arrayList;
    }
