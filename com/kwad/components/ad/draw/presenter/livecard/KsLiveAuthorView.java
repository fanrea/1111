...
public class KsLiveAuthorView extends FrameLayout implements cb.a {
    public final cb dC;
    protected ViewGroup fW;
    protected KSCornerImageView fX;
    protected KSCornerImageView fY;
    protected KSCornerImageView fZ;
    protected KSCornerImageView ga;
    private TextView gb;
    ...
    public void k(AdTemplate adTemplate) {
        ...
        String strCC = com.kwad.sdk.core.response.b.a.cC(adInfoEP);
        if (!TextUtils.isEmpty(strCC)) {
            KSImageLoader.loadImage(this.fY, strCC, adTemplate);
        }
        int iBm = com.kwad.sdk.core.response.b.a.bm(adInfoEP);
        if (com.kwad.sdk.core.response.b.a.df(e.eP(adTemplate))) {
            this.gb.setText("直播中");
            if (iBm == 8) {
            ...
            this.gb.setText(com.kwad.sdk.core.response.b.a.da(adInfoEP));
        }
    ...
    public final void a(f fVar) {
        l.a(fVar, this);
        this.gc.setImageResource(R.drawable.ksad_draw_follow_arrow_down);
    ...
    private void a(f fVar, Drawable drawable) {
        if (drawable instanceof GradientDrawable) {
            ((GradientDrawable) drawable).setStroke(getResources().getDimensionPixelSize(R.dimen.ksad_draw_author_icon_stroke_width), fVar.wH());
        }
    }
