...
public final class c extends com.kwad.components.ct.tube.channel.detail.b.a {
    ...
    private final KSPageLoadingView.a asf = new KSPageLoadingView.a() { // from class: com.kwad.components.ct.tube.channel.detail.c.c.1
    ...
    private final f awa = new g() { // from class: com.kwad.components.ct.tube.channel.detail.c.c.2
    ...
    public final void ay() {
        super.ay();
        this.amL = this.aVW.aFs;
        this.avY = this.aVW.avY;
        this.aFU = this.aVW.aFU;
        this.aFW = this.aVW.aFW;
        this.avY.a(this.awa);
        this.aFX.setRetryClickListener(this.asf);
        this.aFX.setScene(this.aVW.mSceneImpl);
    }
