...
public final class d extends com.kwad.components.ct.tube.history.b.a {
    private long aFZ;
    private String aGa;
    private com.kwad.components.core.widget.a.b amL;
    private boolean amM;
    private final com.kwad.sdk.core.j.c gZ = new com.kwad.sdk.core.j.c() { // from class: com.kwad.components.ct.tube.history.c.d.1
    ...
    public final void ay() {
        super.ay();
        com.kwad.components.core.widget.a.b bVar = this.aWQ.aFs;
        this.amL = bVar;
        if (bVar == null) {
            return;
        }
        bVar.a(this.gZ);
        this.mSceneImpl = this.aWQ.mSceneImpl;
        this.aGa = String.valueOf(this.aWQ.aGE.hashCode());
    }
