...
public final class c extends com.kwad.components.ct.feed.home.a.a.a implements com.kwad.components.ct.f.b {
    ...
    public final void onCreate() {
        super.onCreate();
        this.aFB = (ImageView) findViewById(R.id.ksad_feed_item_blur_bg);
    ...
    private void k(CtAdTemplate ctAdTemplate) {
        ...
        if (height > width) {
            this.aFw.setScaleType(ImageView.ScaleType.CENTER_CROP);
            this.aFB.setVisibility(8);
        } else {
            this.aFw.setScaleType(ImageView.ScaleType.FIT_CENTER);
            com.kwad.sdk.glide.c.h(((com.kwad.components.ct.feed.home.a.a.b) this.cdN).alG).hh(com.kwad.components.ct.response.a.a.be(ctAdTemplate)).b(this.aFB);
            this.aFB.setVisibility(0);
        }
        com.kwad.sdk.glide.c.h(((com.kwad.components.ct.feed.home.a.a.b) this.cdN).alG).hh(url).a(new com.kwad.components.ct.b.a(url, ctAdTemplate)).d(getContext().getResources().getDrawable(EZ().aGf)).f(getContext().getResources().getDrawable(EZ().aGf)).b(this.aFw);
    }
