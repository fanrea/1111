...
public final class e extends com.kwad.components.ct.horizontal.feed.item.a.b {
    ...
    private final m aMa = new m() { // from class: com.kwad.components.ct.horizontal.feed.item.presenter.play.e.1
        @Override // com.kwad.sdk.widget.m
        public final void E(View view) {
            e.this.Bz();
        }
    };
    private final m aMb = new m() { // from class: com.kwad.components.ct.horizontal.feed.item.presenter.play.e.2
        @Override // com.kwad.sdk.widget.m
        public final void E(View view) {
            e.this.Hy();
        }
    ...
    public final void onCreate() {
        super.onCreate();
        this.aMs = (KSRelativeLayout) findViewById(R.id.ksad_horizontal_feed_item_root);
