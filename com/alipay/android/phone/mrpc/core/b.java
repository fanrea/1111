...
public final class b implements HttpClient {
    ...
    public class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0043b c0043b = b.this.f;
            if (c0043b != null && C0043b.a(c0043b) && (httpRequest instanceof HttpUriRequest)) {
                C0043b.a(c0043b, b.a((HttpUriRequest) httpRequest));
            }
        }
    }
    ...
    public static class C0043b {
        ...
        public static /* synthetic */ void a(C0043b c0043b, String str) {
            Log.println(c0043b.b, c0043b.a, str);
        }

        public static /* synthetic */ boolean a(C0043b c0043b) {
            return Log.isLoggable(c0043b.a, c0043b.b);
        }
    }
    ...
    public static b a(String str) {
        ...
        schemeRegistry.register(new Scheme(com.alipay.sdk.m.l.a.r, PlainSocketFactory.getSocketFactory(), 80));
    ...
    public static /* synthetic */ String a(HttpUriRequest httpUriRequest) throws IOException {
        ...
        for (Header header : httpUriRequest.getAllHeaders()) {
            if (!header.getName().equals("Authorization") && !header.getName().equals(com.sigmob.sdk.base.e.b)) {
                sb.append("--header \"");
