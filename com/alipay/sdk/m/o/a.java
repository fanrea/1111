...
public final class a {
    ...
    public static final class C0055a {
        ...
        public C0055a(String str, Map<String, String> map, byte[] bArr) {
            this.a = str;
            this.b = bArr;
            this.c = map;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:110:0x01ad A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:114:0x01b2 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.alipay.sdk.m.o.a.b a(android.content.Context r11, com.alipay.sdk.m.o.a.C0055a r12) {
        /*
    ...
    public static String a(Context context) {
        try {
            ...
            if (networkInfoA != null && networkInfoA.isAvailable()) {
                return networkInfoA.getType() == 1 ? com.baidu.mobads.container.util.e.a.a : networkInfoA.getExtraInfo().toLowerCase();
            }
