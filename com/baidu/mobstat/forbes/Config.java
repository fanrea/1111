...
public class Config {
    public static final String ACTIVITY_LIFE_CYCLE_PART = "alc";
    ...
    public static final String BQT_MESSAGE = "bqtm";
    ...
    public static final String EVENT_AD_FEED_CLASS = "ad_class";
    public static final String EVENT_AD_PROD = "ad_prod";
    ...
    public static final String EVENT_LOGO_PROD = "logo_prod";
    ...
    public static final String EVENT_SDK_NAME = "sdk_name";
    public static final String EVENT_SDK_SHAKE = "sdk_shake";
    ...
    public static final int FULLTRACE_MAX_CACHE_JSON_CAPACITY = 51200;
    ...
    public static final String LOG_FULL_SEND_URL = "https://bes-mtj.baidu.com/auto.gif";
    ...
    public static final boolean SDK_FOR_BES = true;
    ...
    public static final boolean SDK_FOR_DUEROS = true;
    ...
    public static final int STAT_SDK_CHANNEL_VALUE = 25;
    public static final String STAT_SDK_TYPE = "st";
    public static final String STAT_SDK_VERSION = "v";
    public static final String STAT_SDK_VERSION_NUM = "4.1.0.9";
    ...
    static {
        ...
        String strReplace = name.substring(0, name.lastIndexOf(46)).replace(".", replace);
        RES_PREFIX = strReplace + replace;
        PREFIX_SEND_DATA = strReplace + "_sdk_send_data_";
        PREFIX_SEND_DATA_FULL = strReplace + "_track_send_data_";
