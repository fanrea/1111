...
public class al extends ai {
    private static final String a = Config.RES_PREFIX + "Baidu_Stat_SDK_SendRem";
    ...
    @Override // com.baidu.mobstat.forbes.ai
    ...
    public void l(Context context, String str) {
        b(context, Config.SID, str);
    }

    public String u(Context context) {
        return a(context, Config.SID, "");
    }
