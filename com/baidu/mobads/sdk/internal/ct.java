...
public class ct extends bj {
    ...
    public ct(Context context, RelativeLayout relativeLayout, String str, int i, CPUWebAdRequestParam cPUWebAdRequestParam) {
        super(context);
        this.q = str;
        ...
        if (this.m != null) {
            try {
                ...
                if (this.u != null) {
                    ...
                    m();
                    this.m.addEventListener("Update_fbReader_Setting", new cu(this));
                    this.m.addEventListener("closeInterstitialAd", new cv(this));
                    this.m.addEventListener("feOpenFbReader", new cw(this));
                    JSONObject jSONObjectA = m.a(this.a);
