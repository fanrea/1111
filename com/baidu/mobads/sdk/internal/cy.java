...
public class cy extends bj {
    ...
    private static final String J = "cy";
    ...
    private CPUNovelAd.CpuNovelListener f746K;
    private SoftReference<RelativeLayout> L;

    public cy(Context context, String str, CPUWebAdRequestParam cPUWebAdRequestParam) {
        super(context);
        this.E = 5;
        this.F = 60;
        this.G = 0;
    ...
    public void a() {
        ...
        try {
            ...
            m();
            this.m.addEventListener("Update_fbReader_Setting", new cz(this));
            this.m.addEventListener("closeInterstitialAd", new da(this));
    ...
    protected void h(IOAdEvent iOAdEvent) {
        CPUNovelAd.CpuNovelListener cpuNovelListener = this.f746K;
    ...
    public View w() {
        ...
        if (viewA instanceof FrameLayout) {
            ...
            if (bn.a((Context) null).a() >= 18) {
                relativeLayout.getViewTreeObserver().addOnWindowFocusChangeListener(new dc(this, relativeLayout));
            }
        }
        return viewA;
    }
