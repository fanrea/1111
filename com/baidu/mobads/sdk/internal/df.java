...
public class df extends bj {
    ...
    public df(Context context, String str, String str2, boolean z, int i) {
        super(context);
        this.C = false;
        this.H = 0;
        this.I = 0;
    ...
    protected void i(IOAdEvent iOAdEvent) {
        ...
        for (int i = 0; i < this.t.size(); i++) {
            br brVar = (br) this.t.get(i);
            if (TextUtils.equals(brVar.a(), str)) {
                brVar.a(view, iIntValue, iIntValue2);
            }
        }
    }
    ...
    */
    ...
    protected void a(String str, int i, String str2) {
        ...
        if (this.E != null) {
            br brVar = new br(this.i, this, null);
            brVar.a(str2);
            this.E.onNativeFail(i, str, brVar);
        }
    ...
    protected void f(IOAdEvent iOAdEvent) {
        ...
        if (this.D != null && data != null && this.a != null) {
            String str = (String) data.get(com.baidu.mobads.container.util.cm.Z);
            while (i < this.a.size()) {
                XAdNativeResponse xAdNativeResponse = (XAdNativeResponse) this.a.get(i);
        ...
        String str2 = (String) data.get(com.baidu.mobads.container.util.cm.Z);
        while (i < this.u.size()) {
            XAdEntryResponse xAdEntryResponse = (XAdEntryResponse) this.u.get(i);
    ...
    public JSONObject j() {
        ...
        try {
            ...
            jSONObject.put(com.baidu.mobads.container.components.h.b.e.f, this.H);
            if (this.H == 0) {
