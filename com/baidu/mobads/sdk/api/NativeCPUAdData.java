...
public class NativeCPUAdData implements IBasicCPUData, Observer {
    private static final String CLASS_NAME = z.l;
    ...
    public void setStatusListener(final IBasicCPUData.CpuNativeStatusCB cpuNativeStatusCB) throws IllegalArgumentException {
        ...
        try {
            this.remoteUtils.a(this.mInstance, "setStatusListener", Proxy.newProxyInstance(this.classLoader, new Class[]{av.a(z.n, this.classLoader)}, new InvocationHandler() { // from class: com.baidu.mobads.sdk.api.NativeCPUAdData.3
