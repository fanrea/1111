...
class az implements ab.b {
    ...
    public void a(boolean z) {
        if (z) {
            this.d.a(false, com.baidu.mobads.container.util.e.a.i(this.d.mAppContext).booleanValue(), this.a, this.b);
        }
        this.d.H = false;
        this.d.onResume();
        by.a.a(this.d.mAppContext).a(1046).a(this.d.mAdContainerCxt.z()).a(this.c).b(this.d.mAdContainerCxt.l()).a("msg", z ? "confirmed" : "cancel").a(com.baidu.mobads.container.components.command.j.F, z ? 0L : 1L).a("prod", "rvideo").a("dl_type", "ac_rvideo").a("confirmPolicy", this.d.Y).f();
    }
}
