...
public class a {
    ...
    public static final String G = "req_st";
    ...
    private String ag;
    private String ah;
    private String H = "baidu_cloudVersion";
    private String O = "";
    ...
    private a() {
        this.J.add("com.baidu.mobads.container");
        this.J.add("com.bd.mobpack");
        this.J.add(s);
        this.J.add("com.baidu.mobstat.forbes");
        this.f729K = true;
        this.L = false;
        this.M = true;
        this.N = false;
    ...
    public String a(Context context) {
        try {
            if (TextUtils.isEmpty(this.O) && context != null) {
                this.O = new SPUtils(context, this.H).getString("cloudVersion", "1.0");
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public void a(Context context, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                this.O = str;
                new SPUtils(context, this.H).putString("cloudVersion", str);
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public Object g(String str) {
        ...
        if (com.baidu.mobads.container.h.a.c.equals(str)) {
            return Integer.valueOf(this.T);
        }
        if (com.baidu.mobads.container.h.a.d.equals(str)) {
        ...
        if (com.baidu.mobads.container.h.a.i.equals(str)) {
        ...
        if (com.baidu.mobads.container.h.a.j.equals(str)) {
            return 0;
        }
        if (E.equals(str)) {
