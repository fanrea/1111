...
public class DownTaskActivity implements IActivityImpl {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (intent != null && intent.getBooleanExtra("dealWithDownload", false)) {
            ...
            com.baidu.mobads.container.components.e.f fVarA = com.baidu.mobads.container.components.e.f.a(this.mProxyActivity.getApplicationContext());
            com.baidu.mobads.container.components.e.b bVarB = fVarA.b(stringExtra);
            ...
            if (intExtra == b.a.COMPLETED.b()) {
                ...
                if (bVarB != null) {
                    bVarB.c();
                    new com.baidu.mobads.container.components.command.a().a(this.mProxyActivity.getApplicationContext(), stringExtra);
                }
