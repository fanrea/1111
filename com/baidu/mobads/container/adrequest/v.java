...
public class v implements l {
    ...
    public v(String str) {
        ...
        try {
            this.s = this.o.optInt("enc", 0);
            JSONArray jSONArrayOptJSONArray = this.o.optJSONArray("ad");
            if (this.s == 1) {
                String strOptString = this.o.optString("ad");
                if (!TextUtils.isEmpty(strOptString)) {
                    String strB = com.baidu.mobads.container.util.u.b(strOptString);
                    if (!TextUtils.isEmpty(strB)) {
                        jSONArrayOptJSONArray = new JSONArray(strB);
                        this.o.put("ad", jSONArrayOptJSONArray);
                    }
                }
            }
            ...
            this.c = Boolean.valueOf(this.o.optInt("m", 0) == 1);
