...
public class a {
    ...
    public static d.C0141d b(Context context) {
        float f2;
        d.C0141d c0141d = new d.C0141d();
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            new com.component.c.a(context).a(memoryInfo);
            float f3 = (memoryInfo.availMem / 1024.0f) / 1024.0f;
            boolean z = memoryInfo.lowMemory;
            if (Build.VERSION.SDK_INT < 16) {
                f2 = 0.0f;
            } else {
                f2 = (memoryInfo.totalMem / 1024.0f) / 1024.0f;
            }
            c0141d.a(z);
            c0141d.c(f3);
            c0141d.a(f2);
    ...
    public static d.C0141d c() throws Throwable {
        d.C0141d c0141d = new d.C0141d();
        a(new File(f), new b(c0141d));
        return c0141d;
    }
    ...
    private static void a(File file, InterfaceC0140a interfaceC0140a) throws Throwable {
