...
public class c {
    ...
    public void a(k kVar, j jVar, Boolean bool, HashMap<String, Object> map, boolean z2) throws JSONException {
        ...
        this.C = kVar.getAdContainerContext().s();
        if (this.C == null) {
            return;
        }
        com.baidu.mobads.container.components.h.c.f.a((Context) null).a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.a.AD_EVENT_CLICK);
        if (512 == jVar.getActionType()) {
            com.baidu.mobads.container.components.h.d.a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.a.EVENT_CLICK_APO);
        ...
        if (1 == jVar.getActionType()) {
            ...
            a(kVar);
            com.baidu.mobads.container.components.h.d.a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.a.EVENT_CLICK_LP);
            try {
                by.a aVarA = by.a.a(kVar.getAdContainerContext().t()).a(1047).a(jVar);
        ...
        com.baidu.mobads.container.components.h.c.f.a((Context) null).a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.b.a.f, String.valueOf(com.baidu.mobads.container.components.h.c.a.AD_CLICK_LP.b()));
        com.baidu.mobads.container.components.h.c.f.a((Context) null).a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.a.AD_EVENT_CLICK_RESPOND);
            ...
            if (!a(kVar, map, strK, jVar)) {
                ...
                if (map != null && map.containsKey("t_url")) {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        new com.baidu.mobads.container.components.g.f(1, strA).a();
                        strA = str;
                    }
                }
        ...
        if (z2) {
            this.C.dispatchEvent(new cm("AdUserClick", jVar.getUniqueId()));
        }
    }

    private void a(k kVar) {
        if ((kVar instanceof be) || (kVar instanceof com.baidu.mobads.container.v.a.a)) {
            com.baidu.mobads.container.activity.d.a().a(new e(this));
        }
    }

    private void a(k kVar, j jVar, int i2) {
        com.baidu.mobads.container.components.h.d.a(jVar.getUniqueId(), com.baidu.mobads.container.components.h.a.EVENT_CLICK_DL);
        b(kVar, jVar, i2);
        this.C.dispatchEvent(new cm("AdUserClick", jVar.getUniqueId()));
    }
    ...
    public void a(j jVar, int i2) {
        if (jVar != null) {
            ...
            com.baidu.mobads.container.components.h.a.a aVarA = com.baidu.mobads.container.components.h.a.a.a();
    ...
    public void a(j jVar, int i2, boolean z2) {
        if (jVar != null) {
            com.baidu.mobads.container.components.h.a.a.a().a(jVar.getQueryKey(), jVar.getAdId(), i2, z2);
        }
    }
    ...
    private int a(j jVar, boolean z2) {
        ...
        if (!TextUtils.isEmpty(jVar.getAppStoreLink())) {
            return 107;
        }
        return 102;
    }
    ...
    public void a(k kVar, j jVar, boolean z2) {
        ...
        for (int i2 = 0; i2 < listA.size(); i2++) {
            ...
            cc.a(kVar.getAdContainerContext().t(), strReplaceAll, cc.a.THIRDCLICK);
        }
    }
    ...
    private void b(k kVar, j jVar, int i2) {
        ...
        for (int i3 = 0; i3 < listA.size(); i3++) {
            ...
            a(strA);
            cc.a(kVar.getAdContainerContext().t(), strA, cc.a.THIRDCLICK);
        }
    }
    ...
    public void a(k kVar, j jVar, String str, int i2, String str2) {
        ...
        com.baidu.mobads.container.components.j.c.a().a(str3, strK, str4, jVar, str, "", "", i2, str2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void a(String str) {
        new com.baidu.mobads.container.components.g.f(1, str).a();
    }
    ...
    */
    private void a(com.baidu.mobads.container.k r28, com.baidu.mobads.container.adrequest.j r29, java.util.HashMap<java.lang.String, java.lang.Object> r30) {
        /*
            Method dump skipped, instructions count: 989
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.mobads.container.components.k.c.a(com.baidu.mobads.container.k, com.baidu.mobads.container.adrequest.j, java.util.HashMap):void");
    }
    ...
    */
    private int a(android.content.Context r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, com.baidu.mobads.container.adrequest.j r19, java.util.HashMap<java.lang.String, java.lang.Object> r20) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.mobads.container.components.k.c.a(android.content.Context, java.lang.String, java.lang.String, java.lang.String, com.baidu.mobads.container.adrequest.j, java.util.HashMap):int");
    }
    ...
    public void a(Context context, HashMap<String, Object> map, j jVar, String str, String str2, String str3, k kVar) {
        ...
        oVarA.f725K = jVar.getDownloadFinishTrackingUrls();
        if (kVar != null) {
            oVarA.d = a(oVarA.d, kVar);
        }
        bp.a().a(context, 525, "click", oVarA);
    ...
    private void a(k kVar, j jVar, Boolean bool, HashMap<String, Object> map, com.baidu.mobads.container.components.k.a aVar) {
    ...
    public void a(t tVar, j jVar) {
        try {
            ...
            jVar2.ag = jVar.getAdId();
            jVar2.ae = jVar.getQueryKey();
            ...
            if (jVar.getOriginJsonObject() != null) {
                jVar2.af = jVar.getOriginJsonObject().optString(com.baidu.mobads.container.components.command.j.f);
            }
            com.baidu.mobads.container.components.c.g.a().a(tVar.t(), jVar2);
        } catch (Throwable th) {
        }
    }
    ...
    class a extends com.baidu.mobads.container.d.a {
        ...
        protected Object a() {
            this.i += 500;
            if (!com.baidu.mobads.container.util.t.f(this.a, this.d)) {
                this.j = true;
            }
            if (this.i >= 5000) {
                c();
            ...
            if (com.baidu.mobads.container.util.t.f(this.a, this.d) && this.j) {
                c();
                try {
                    by.a aVarA = by.a.a(this.a).a(553).a("pk", this.c).a(this.b).c(this.e).a(this.g).a("msg", "asl_delay_download").a("canopen", true);
    ...
    public void a(Context context, j jVar, String str, String str2, String str3, String str4, String str5, boolean z2) {
        ...
        jVar2.aD = com.baidu.mobads.container.components.command.j.a(jVar);
        jVar2.ak = jVar.getAppName();
        jVar2.ad = jVar.isPopNotif();
        jVar2.av = str3;
        jVar2.aw = str2;
        jVar2.ax = z2;
        jVar2.ah = str5;
        ...
        jVar2.a(TextUtils.isEmpty(str2) ? com.baidu.mobads.container.components.command.j.B : "coop_" + str2, z2 ? 3 : 4);
        try {
            String appOpenStrs = jVar.getAppOpenStrs();
            if (!TextUtils.isEmpty(appOpenStrs)) {
                jVar2.au = new JSONObject(appOpenStrs).optString("page");
            }
        } catch (Throwable th) {
            bq.a().a(e, th);
        }
        jVar2.aA = jVar.getDelayOpenTime();
        jVar2.aB = jVar.getDetectInstallTime();
        try {
    ...
    private void a(Context context, com.baidu.mobads.container.components.command.j jVar, String str) {
        com.baidu.mobads.container.components.c.g gVarA = com.baidu.mobads.container.components.c.g.a();
    ...
    private void a(Context context) {
        ...
        try {
            ...
            if (eventType != null && eventType.size() > 0) {
                Iterator<IOAdEventListener> it = eventType.iterator();
                while (it.hasNext()) {
                    ad.a(context).addEventListener(b.F, it.next());
                }
            }
            if (eventType2 != null && eventType2.size() > 0) {
                Iterator<IOAdEventListener> it2 = eventType2.iterator();
                while (it2.hasNext()) {
                    ad.a(context).addEventListener(b.U, it2.next());
                }
            }
        } catch (Throwable th) {
            bq.a().c(e, th);
    ...
    private boolean b(j jVar) {
        ...
        if (jVar != null) {
            try {
                ...
                if (originJsonObject == null || (jSONObjectOptJSONObject = originJsonObject.optJSONObject("cloud_control")) == null || jSONObjectOptJSONObject.optInt("dl_detain", 0) != 1) {
                    return false;
                }
                return com.baidu.mobads.container.components.a.o.a().b();
            } catch (Throwable th) {
                th.printStackTrace();
            }
        }
    ...
    private int c(j jVar) {
        ...
        try {
            JSONObject originJsonObject = jVar.getOriginJsonObject();
            if (originJsonObject == null || (jSONObjectOptJSONObject = originJsonObject.optJSONObject("cloud_control")) == null || jSONObjectOptJSONObject.optInt("u_dl", 0) != 1 || !com.baidu.mobads.container.components.a.o.a().b()) {
                return -1;
            }
            return jSONObjectOptJSONObject.optInt("u_dl_st", 3) * 1000;
        } catch (Throwable th) {
            th.printStackTrace();
            return -1;
        }
