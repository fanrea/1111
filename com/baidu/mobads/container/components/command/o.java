...
public class o {
    ...
    public static o a(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            oVar.g = jSONObject.optString("icon", "");
            try {
    ...
    public boolean B() {
        ...
        if (this.L != null && (jSONObjectOptJSONObject = this.L.optJSONObject("cloud_control")) != null) {
