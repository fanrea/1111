...
public class a {
    ...
    public void a(RelativeLayout.LayoutParams layoutParams, String str, String str2, int i2, boolean z, int i3) {
        this.n = new b(a(str));
        int[] iArrB = this.n.b(a(str2, this.n.a(layoutParams, i2), z));
        if (iArrB != null && iArrB.length == 4) {
            layoutParams.setMargins(bv.a(this.k, iArrB[0]), bv.a(this.k, iArrB[1]), bv.a(this.k, iArrB[2]), bv.a(this.k, iArrB[3]) + i3);
        }
    }
    ...
    private String a(int[] iArr) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            if (i2 < iArr.length - 1) {
                sb.append(iArr[i2]).append(Config.replace);
            } else {
                sb.append(iArr[i2]);
            }
        }
