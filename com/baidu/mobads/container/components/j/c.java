...
public class c {
    ...
    private final com.baidu.mobads.container.components.j.a e;
    ...
    /* synthetic */ c(com.baidu.mobads.container.components.j.d dVar) {
        this();
    }

    private c() {
        this.e = new com.baidu.mobads.container.components.j.a();
        com.baidu.mobads.container.components.j.d dVar = null;
        this.f = new C0124c(this, dVar);
    ...
    public void a(String str, String str2, String str3, j jVar, String str4, String str5, String str6, String str7, int i, String str8) {
        ...
        a(str8, new com.baidu.mobads.container.components.j.d(this, jSONObject, System.currentTimeMillis()));
    }
    ...
    public void a(String str, com.baidu.mobads.container.components.g.a aVar) {
        ...
        com.baidu.mobads.container.components.g.e.a().a(aVarC.b()).a(aVar);
    }
    ...
    public void c() {
        this.e.a(this.g, com.baidu.mobads.container.h.a.a().a(d));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void a(JSONObject jSONObject, int i, com.baidu.mobads.container.components.g.a aVar) {
        if (jSONObject != null) {
            try {
                if (jSONObject.length() > 0) {
                    by.a aVarA = by.a.a(com.baidu.mobads.container.config.b.a().c()).a(1008).a("subtype", 809L);
                    ...
                    while (itKeys.hasNext()) {
                        ...
                        if ("url".equals(next)) {
                            if (strOptString.equals(d.e)) {
                                ...
                                strOptString2 = a(strOptString2, 6000);
                            }
    ...
    public void b(String str, int i) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (a(jSONObjectA) > com.baidu.mobads.container.h.a.a().c(5L)) {
                a(jSONObjectA, 3, (com.baidu.mobads.container.components.g.a) null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.baidu.mobads.container.components.j.c$c, reason: collision with other inner class name */
    class C0124c implements a.InterfaceC0123a {
        private C0124c() {
        }

        /* synthetic */ C0124c(c cVar, com.baidu.mobads.container.components.j.d dVar) {
            this();
        }

        @Override // com.baidu.mobads.container.components.j.a.InterfaceC0123a
    ...
    class a implements a.InterfaceC0123a {
        ...
        /* synthetic */ a(c cVar, com.baidu.mobads.container.components.j.d dVar) {
            this();
        }
