...
public class aw {
    ...
    private static String b(Context context) {
        String strE = x.a(context).e();
        if (TextUtils.isEmpty(strE) || strE.equalsIgnoreCase(h) || strE.equalsIgnoreCase(i)) {
            return a;
        }
        if (strE.equalsIgnoreCase(j) || strE.equalsIgnoreCase(k)) {
            return b;
        }
        if (strE.equalsIgnoreCase("VIVO")) {
            return c;
        }
        if (strE.equalsIgnoreCase("OPPO")) {
            return d;
        }
        if (!strE.equalsIgnoreCase(m)) {
            return strE.equalsIgnoreCase(l) ? g : a;
        }
        if (x.a(context).a() < 28) {
            return e;
        }
