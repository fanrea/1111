...
class p extends e.a {
    ...
    public void a(AnimatorSet animatorSet) {
        ...
        double d = this.b;
        Double.isNaN(d);
        objectAnimatorOfFloat.setDuration((long) (d * 0.1d));
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this.a, "alpha", 1.0f, 0.0f);
        double d2 = this.b;
        Double.isNaN(d2);
        objectAnimatorOfFloat2.setDuration((long) (d2 * 0.1d));
        ...
        ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(this.a, "rotation", this.e, this.f);
        AnimatorSet animatorSet2 = new AnimatorSet();
        animatorSet2.playTogether(objectAnimatorOfFloat3, objectAnimatorOfFloat4, objectAnimatorOfFloat5);
        double d3 = this.b;
        Double.isNaN(d3);
        animatorSet2.setDuration((long) (d3 * 0.8d));
