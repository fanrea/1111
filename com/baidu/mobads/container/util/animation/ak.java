...
public class ak {
    ...
    */
    ...
    public final void b(Activity activity, JSONObject jSONObject) {
        if (activity != null) {
            try {
                if (this.i != null && this.i.a() && com.baidu.mobads.container.util.x.a(null).a() >= 21) {
                    if (jSONObject == null) {
                        jSONObject = new JSONObject();
                    }
                    if (activity.getWindow().hasFeature(13) && this.i.c.filterEquals(activity.getIntent())) {
                        this.i.b.switchContext(activity);
                        this.k = new com.baidu.mobads.container.s.s(activity, this.i.b, jSONObject);
                        this.k.a(this.k.a(activity));
                        View viewA = this.k.a();
    ...
    public void a(View view, View view2) {
        ...
        try {
            ...
            int iMax = Math.max(iArr[0], i - iArr[0]);
            int iMax2 = Math.max(iArr[1], i2 - iArr[1]);
    ...
    private static int a(Activity activity) {
        ...
        boolean z = true;
        boolean z2 = (attributes.flags & 67108864) == 67108864;
        boolean z3 = (attributes.flags & 134217728) == 134217728;
