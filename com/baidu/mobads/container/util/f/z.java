...
public class z {
    ...
    public static String a(Context context) {
        if (!com.baidu.mobads.container.h.a.a().i() || com.baidu.mobads.container.util.x.a(context).a() < 23 || context == null) {
            return "";
        }
        try {
            if (k == null) {
            ...
            if (TextUtils.isEmpty(m)) {
                ...
                String strB = com.baidu.mobads.container.util.u.b(k.a("oaid"));
                if (strB.length() <= 256) {
                    m = strB;
                } else {
                    m = "";
    ...
    private static void d(Context context) {
        if (q.a()) {
            a(2592000000L, q.a(context.getApplicationContext()));
        }
        if (f.a(context)) {
            f.b(context);
        } else if (i.a(context)) {
    ...
    public static void a(long j2, String str) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str) || TextUtils.equals("invalid", str)) {
                str = com.baidu.mobads.container.util.u.b(k.a("oaid"));
            ...
            k.a("oaid", com.baidu.mobads.container.util.u.a(str));
    ...
    public static void b(Context context) {
        ...
        try {
            ...
            if (clsA != null) {
                ...
                if (objA != null) {
                    com.baidu.mobads.container.a.g.a(r, (Object) null, p, (Class<?>[]) new Class[]{Context.class, Boolean.TYPE, clsA}, context, true, objA);
                }
            } else {
                Class clsA2 = com.baidu.mobads.container.a.g.a(s);
                Object objA2 = com.baidu.mobads.container.a.g.a(s, new a(t, q));
                if (objA2 != null) {
                    com.baidu.mobads.container.a.g.a(r, (Object) null, p, (Class<?>[]) new Class[]{Context.class, Boolean.TYPE, clsA2}, context, true, objA2);
                }
            }
        } catch (Throwable th) {
    ...
    public static void a(Context context, String str) {
        ...
        if (str != null) {
            ...
            by.a.a(context).a(836).a("msg", str).f();
        }
    }
