    ...
    protected Object a() {
        ...
        try {
            ...
            if (!this.c.d.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ((g.a) it.next()).a("", this.a, com.baidu.mobads.container.util.d.c.i);
                }
            }
            th.printStackTrace();
            bq.a().a("Failed to save file. " + th);
        }
        if (iA < 1) {
            ...
            if (!this.c.d.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    ((g.a) it2.next()).a(name, this.a, cVarA);
                }
            }
            return null;
        }
        if (this.a.c() > this.c.e()) {
            ...
            if (!this.c.d.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    ((g.a) it3.next()).a(name, this.a, com.baidu.mobads.container.util.d.c.b);
                }
            }
            return null;
        }
        ...
        if (!this.c.d.isEmpty()) {
            ...
            while (it4.hasNext()) {
                ((g.a) it4.next()).a(name, this.a);
            }
        }
        this.c.e("File saved using " + (System.currentTimeMillis() - jCurrentTimeMillis) + "ms: [" + name + "]size: " + this.a.c() + "\nStatus:" + this.c.f());
        this.c.b();
        return null;
    }
}
