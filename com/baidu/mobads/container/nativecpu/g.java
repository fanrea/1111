...
public class g {
    ...
    static {
        ...
        if (com.baidu.mobads.container.h.a.a().e()) {
            str = "https://cpu-openapi.baidu.com/api/v2/aggregation/channels";
        } else {
            str = "http://cpu-openapi.baidu.com/api/v2/aggregation/channels";
        }
        a = str;
    }
    ...
    public void a(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            jSONObject2.put(com.alipay.sdk.m.t.a.k, jCurrentTimeMillis);
    ...
    public void a(int i, String str) {
        ...
        if (this.f != null) {
            this.f.a(com.baidu.mobads.container.components.k.b.S, map);
        }
    }
        ...
        try {
            ...
            if (iOptInt == 200) {
                ...
                if (jSONArrayOptJSONArray != null) {
                    ...
                    if (this.f != null) {
                        this.f.a(com.baidu.mobads.container.components.k.b.R, map);
                    }
                } else {
