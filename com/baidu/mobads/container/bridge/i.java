...
public abstract class i {
    ...
    boolean d;
    protected com.baidu.mobads.container.adrequest.t e;
    protected au g;
    private x k;
    private WebView l;
    ...
    public i(au auVar, WebView webView, x xVar, com.baidu.mobads.container.adrequest.t tVar) {
        this.g = auVar;
        this.k = xVar;
        this.e = tVar;
        this.l = webView;
    ...
    protected void d() {
        ...
        try {
            ...
            if (jSONObjectG != null) {
                sb.append(w.c).append("=").append(jSONObjectG.toString()).append(com.alipay.sdk.m.u.i.b);
            }
        } catch (Exception e) {
            this.f.a(e);
        }
        ...
        switch (n.a[yVar.ordinal()]) {
            ...
            case 4:
                ...
                if (com.baidu.mobads.container.util.j.b(contextT, queryParameter)) {
                    ...
                    String string = contextT.getSharedPreferences(com.baidu.mobads.container.util.j.a, 0).getString(queryParameter + com.baidu.mobads.container.components.command.j.b + bn.a().a(contextT), null);
                    if (string != null) {
            ...
            case 34:
                ...
                break;
            case 35:
                this.e.s().dispatchEvent(new cm(com.baidu.mobads.container.components.k.b.E));
                b().onClose();
                break;
            case 36:
                this.g.closeExpand();
    ...
    public void a(String str) {
        ...
        try {
            ...
            try {
                by.a.a(contextT).a(525).c(strK).a(this.e.z()).b(this.e.l()).a("pk", strOptString).a("msg", bp.a).g();
            } catch (Exception e) {
            }
    ...
    public void c(String str) {
        ...
        try {
            ...
            try {
                by.a.a(contextT).a(525).c(strK).a(this.e.z()).b(this.e.l()).a("pk", strOptString != null ? strOptString : "").a("msg", bp.a).g();
            } catch (Exception e) {
            }
            ...
            if (file.exists()) {
                ...
                if (jSONObject.optBoolean(com.baidu.mobads.container.components.command.j.c, false) && !TextUtils.isEmpty(strOptString)) {
                    ...
                    jVar.ac = true;
                    jVar.a("ac_" + strK, 0);
                    com.baidu.mobads.container.components.c.g.a().a(contextT, jVar);
                }
            }
            String strOptString2 = jSONObject.optString("apo", "");
            if (!TextUtils.isEmpty(strOptString2)) {
    ...
    protected int i() {
        ...
        if (!com.baidu.mobads.container.util.r.b(c())) {
            return 0;
        }
        return 6;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:107:0x01c0 A[Catch: Exception -> 0x02b6, TryCatch #10 {Exception -> 0x02b6, blocks: (B:10:0x004b, B:67:0x013b, B:95:0x018b, B:105:0x01b4, B:107:0x01c0, B:108:0x01c5, B:110:0x0202, B:111:0x0205, B:114:0x022e, B:116:0x0240, B:118:0x024a, B:121:0x0252, B:123:0x0260, B:125:0x026e, B:127:0x027c, B:104:0x01af, B:93:0x0182, B:99:0x01a0, B:101:0x01a6, B:96:0x0192), top: B:174:0x004b, inners: #1, #12 }] */
    /* JADX WARN: Removed duplicated region for block: B:110:0x0202 A[Catch: Exception -> 0x02b6, TryCatch #10 {Exception -> 0x02b6, blocks: (B:10:0x004b, B:67:0x013b, B:95:0x018b, B:105:0x01b4, B:107:0x01c0, B:108:0x01c5, B:110:0x0202, B:111:0x0205, B:114:0x022e, B:116:0x0240, B:118:0x024a, B:121:0x0252, B:123:0x0260, B:125:0x026e, B:127:0x027c, B:104:0x01af, B:93:0x0182, B:99:0x01a0, B:101:0x01a6, B:96:0x0192), top: B:174:0x004b, inners: #1, #12 }] */
    /* JADX WARN: Removed duplicated region for block: B:113:0x022c A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:140:0x02ea A[Catch: Exception -> 0x0350, TryCatch #0 {Exception -> 0x0350, blocks: (B:138:0x02d4, B:140:0x02ea, B:142:0x02f4, B:144:0x030b, B:146:0x0311, B:148:0x0333, B:150:0x034a), top: B:155:0x02d4 }] */
    /* JADX WARN: Removed duplicated region for block: B:158:0x014b A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:191:? A[RETURN, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:28:0x00c5  */
    /* JADX WARN: Removed duplicated region for block: B:36:0x00df A[Catch: Exception -> 0x0136, TRY_LEAVE, TryCatch #9 {Exception -> 0x0136, blocks: (B:34:0x00d7, B:36:0x00df), top: B:172:0x00d7 }] */
    /* JADX WARN: Removed duplicated region for block: B:63:0x0131  */
    /* JADX WARN: Removed duplicated region for block: B:89:0x0179  */
    /* JADX WARN: Removed duplicated region for block: B:95:0x018b A[Catch: Exception -> 0x02b6, TRY_LEAVE, TryCatch #10 {Exception -> 0x02b6, blocks: (B:10:0x004b, B:67:0x013b, B:95:0x018b, B:105:0x01b4, B:107:0x01c0, B:108:0x01c5, B:110:0x0202, B:111:0x0205, B:114:0x022e, B:116:0x0240, B:118:0x024a, B:121:0x0252, B:123:0x0260, B:125:0x026e, B:127:0x027c, B:104:0x01af, B:93:0x0182, B:99:0x01a0, B:101:0x01a6, B:96:0x0192), top: B:174:0x004b, inners: #1, #12 }] */
    /*
    ...
    */
    ...
    private com.baidu.mobads.container.adrequest.j u() throws NoSuchMethodException, SecurityException {
        try {
            ...
            Method declaredMethod = jVarQ.getClass().getDeclaredMethod("clone", new Class[0]);
            declaredMethod.setAccessible(true);
            return (com.baidu.mobads.container.adrequest.j) declaredMethod.invoke(jVarQ, new Object[0]);
        } catch (Exception e) {
            this.f.a(e);
            return null;
        }
    ...
    public void a(com.baidu.mobads.container.adrequest.j jVar, int i) {
        try {
            by.a.a(this.e.t()).a(i).c(this.e.k()).a(this.e.z()).a(jVar).a("from", "native-remote").f();
        } catch (Exception e) {
            this.f.a(e);
        }
    }
