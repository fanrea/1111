...
public class k {
    ...
    public ax a(Context context, boolean z) {
        ax.c cVar = new ax.c();
        cVar.a = !z;
        return ax.a(new MutableContextWrapper(context), bq.a(), true, true, cVar);
    }

    public void b(Context context) {
        if (b() && this.c.size() < this.e) {
            a(new l(this, context.getApplicationContext()));
        }
    }
    ...
    public void a(Context context, String str, String str2, com.baidu.mobads.container.adrequest.j jVar) {
        if (context != null && jVar != null && a(context)) {
            a(new m(this, context, jVar, str, str2));
        }
    }
    ...
    public void c() {
        try {
            Iterator<SoftReference<ax>> it = this.c.iterator();
            while (it.hasNext()) {
                b(it.next());
            }
            this.c.clear();
