    ...
    */
    ...
    public c d(int i, int i2) {
        ...
        while (true) {
            ...
            long[] jArr = cVar.g;
            long[] jArr2 = this.g;
            jArr[i4] = z ? jArr2[i7] : (jArr2[i7] >>> i) | (this.g[i7 + 1] << (-i));
            i4++;
            i7++;
        }
        long j2 = (-1) >>> (-i2);
        cVar.g[i3] = ((i2 - 1) & 63) < i8 ? ((this.g[i7 + 1] & j2) << (-i)) | (this.g[i7] >>> i) : (this.g[i7] & j2) >>> i;
        cVar.h = i6;
        cVar.i();
        cVar.h();
        return cVar;
    ...
    public void d(c cVar) {
        ...
        if (iMin < cVar.h) {
            System.arraycopy(cVar.g, iMin, this.g, iMin, cVar.h - iMin);
        }
        i();
        h();
    }
    ...
    public void e(c cVar) {
        for (int iMin = Math.min(this.h, cVar.h) - 1; iMin >= 0; iMin--) {
            long[] jArr = this.g;
            jArr[iMin] = jArr[iMin] & (cVar.g[iMin] ^ (-1));
        }
        i();
        h();
    }
