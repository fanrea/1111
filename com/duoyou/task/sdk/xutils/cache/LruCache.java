    ...
    */
    public void trimToSize(int r5) {
        ...
        L73:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.duoyou.task.sdk.xutils.cache.LruCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        i = this.hitCount;
        i2 = this.missCount + i;
        return String.format(Locale.getDefault(), "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i2 != 0 ? (i * 100) / i2 : 0));
    }
}
