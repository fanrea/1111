...
public class BadgeUtils {
    ...
    public static void attachBadgeDrawable(BadgeDrawable badgeDrawable, View view) throws Resources.NotFoundException {
        attachBadgeDrawable(badgeDrawable, view, (FrameLayout) null);
    }

    public static void attachBadgeDrawable(BadgeDrawable badgeDrawable, View view, FrameLayout frameLayout) throws Resources.NotFoundException {
    ...
    public static void detachBadgeDrawable(BadgeDrawable badgeDrawable, Toolbar toolbar, int i) throws Resources.NotFoundException {
        if (badgeDrawable == null) {
            return;
        }
        ActionMenuItemView actionMenuItemView = ToolbarUtils.getActionMenuItemView(toolbar, i);
    ...
    public static void setBadgeDrawableBounds(BadgeDrawable badgeDrawable, View view, FrameLayout frameLayout) throws Resources.NotFoundException {
        Rect rect = new Rect();
