...
final class Cam16 {
    ...
    static Cam16 fromIntInViewingConditions(int i, ViewingConditions viewingConditions) {
        ...
        float fPow = (float) Math.pow((viewingConditions.getFl() * Math.abs(f7)) / 100.0d, 0.42d);
        float fPow2 = (float) Math.pow((viewingConditions.getFl() * Math.abs(f8)) / 100.0d, 0.42d);
        float fPow3 = (float) Math.pow((viewingConditions.getFl() * Math.abs(f9)) / 100.0d, 0.42d);
        ...
        double d = fSignum3;
        float f10 = ((float) (((fSignum * 11.0d) + (fSignum2 * (-12.0d))) + d)) / 11.0f;
        float f11 = ((float) ((fSignum + fSignum2) - (d * 2.0d))) / 9.0f;
    ...
    public static Cam16 fromUcsInViewingConditions(float f, float f2, float f3, ViewingConditions viewingConditions) {
        double d = f2;
        double d2 = f3;
        double dExpm1 = (Math.expm1(Math.hypot(d, d2) * 0.02280000038444996d) / 0.02280000038444996d) / viewingConditions.getFlRoot();
