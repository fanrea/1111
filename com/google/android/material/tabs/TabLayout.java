...
public class TabLayout extends HorizontalScrollView {
    ...
    private void addTabFromItemView(TabItem tabItem) throws Resources.NotFoundException {
    ...
    public void removeTabAt(int i) throws Resources.NotFoundException {
        Tab tab = this.selectedTab;
    ...
    public void setTabTextColors(int i, int i2) throws Resources.NotFoundException {
    ...
    public void setTabIconTintResource(int i) throws Resources.NotFoundException {
    ...
    private void setupWithViewPager(ViewPager viewPager, boolean z, boolean z2) throws Resources.NotFoundException {
    ...
    @Deprecated
    public void setTabsFromPagerAdapter(PagerAdapter pagerAdapter) throws Resources.NotFoundException {
    ...
    void setPagerAdapter(PagerAdapter pagerAdapter, boolean z) throws Resources.NotFoundException {
    ...
    @Override // android.widget.HorizontalScrollView, android.view.ViewGroup
    public void addView(View view, int i) throws Resources.NotFoundException {
        addViewInternal(view);
    }
    ...
    private void addViewInternal(View view) throws Resources.NotFoundException {
    ...
    */
    ...
    private void removeTabViewAt(int i) throws Resources.NotFoundException {
    ...
    public static class Tab {
        ...
        public Tab setIcon(Drawable drawable) throws Resources.NotFoundException {
            this.icon = drawable;
        ...
        public Tab setText(CharSequence charSequence) throws Resources.NotFoundException {
        ...
        public Tab setTabLabelVisibility(int i) throws Resources.NotFoundException {
        ...
        public Tab setContentDescription(CharSequence charSequence) throws Resources.NotFoundException {
    ...
    public final class TabView extends LinearLayout {
        ...
        private void addOnLayoutChangeListener(final View view) {
            ...
            view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.google.android.material.tabs.TabLayout.TabView.1
                ...
                public void onLayoutChange(View view2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) throws Resources.NotFoundException {
        ...
        private void tryAttachBadgeToAnchor(View view) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void tryUpdateBadgeDrawableBounds(View view) throws Resources.NotFoundException {
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(ViewPager viewPager, PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2) throws Resources.NotFoundException {
