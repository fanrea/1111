...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets(boolean z) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
    ...
    private void calculateUsingTextSize(float f, boolean z) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
        boolean z2;
        float f2;
        boolean z3;
        if (this.text == null) {
    ...
    public void recalculate(boolean z) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
