...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            ...
            case 58:
                return new AI013x0x1xDecoder(bitArray, "310", PointType.SIGMOB_REPORT_TRACKING);
            case 59:
                return new AI013x0x1xDecoder(bitArray, "320", PointType.SIGMOB_REPORT_TRACKING);
            case 60:
                return new AI013x0x1xDecoder(bitArray, "310", "15");
            case 61:
                return new AI013x0x1xDecoder(bitArray, "320", "15");
            case 62:
                return new AI013x0x1xDecoder(bitArray, "310", PointType.LOAD_READY);
            case 63:
                return new AI013x0x1xDecoder(bitArray, "320", PointType.LOAD_READY);
            default:
