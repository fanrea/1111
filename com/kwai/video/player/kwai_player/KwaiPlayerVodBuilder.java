...
public final class KwaiPlayerVodBuilder extends KwaiPlayerBaseBuilder<KwaiPlayerVodBuilder> {
    ...
    protected final void applyTo(KwaiMediaPlayer kwaiMediaPlayer) {
        ...
        if (this.mDisableVodAudio) {
            kwaiMediaPlayer.setOption(4, a.u, 1L);
        }
    ...
    public final KwaiPlayerVodBuilder setStartTime(long j) {
    ...
    public final KwaiPlayerVodBuilder setEnableSeekForwardOffset(boolean z) {
    ...
    public final KwaiPlayerVodBuilder setDisableVodAudio(boolean z) {
    ...
    public final KwaiPlayerVodBuilder setVodManifestSwitchCode(int i) {
        this.mSwitchCode = i;
        return this;
    }

    public final KwaiPlayerVodBuilder setVodManifestMaxResolution(int i) {
        this.mVodManifestMaxResolution = i;
        return this;
    }

    public final KwaiPlayerVodBuilder setManifestType(int i) {
        this.mManifestType = i;
        return this;
    }

    public final KwaiPlayerVodBuilder setMaxBufferStrategy(int i) {
        if (i > 0 && i <= 2) {
