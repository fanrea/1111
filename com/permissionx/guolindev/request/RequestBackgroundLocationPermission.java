...
public final class RequestBackgroundLocationPermission extends BaseTask {
    ...
    public void request() {
        if (this.pb.shouldRequestBackgroundLocationPermission()) {
            ...
            boolean zIsGranted = PermissionX.isGranted(this.pb.getActivity(), "android.permission.ACCESS_FINE_LOCATION");
            boolean zIsGranted2 = PermissionX.isGranted(this.pb.getActivity(), g.h);
            if (zIsGranted || zIsGranted2) {
                if (this.pb.explainReasonCallback != null || this.pb.explainReasonCallbackWithBeforeParam != null) {
                    List<String> listMutableListOf = CollectionsKt.mutableListOf(new String[]{ACCESS_BACKGROUND_LOCATION});
