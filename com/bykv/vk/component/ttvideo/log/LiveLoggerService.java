...
public class LiveLoggerService implements Handler.Callback {
    ...
    public void onUpdateMetaData(String str) {
        ...
        try {
            ...
            if (jSONObject.has(MetricsSQLiteCacheKt.METRICS_START_TIME)) {
                this.mPushClientStartTime = jSONObject.getString(MetricsSQLiteCacheKt.METRICS_START_TIME);
            }
    ...
    public void onUpdateSeiInfo(String str) throws JSONException {
        ...
        try {
            ...
            if (jSONObject2.has(j.s)) {
                long j = jSONObject2.getLong(j.s);
    ...
    public void onFirstFrameFail(int i) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "first_frame_failed").put(MetricsSQLiteCacheKt.METRICS_START_TIME, System.currentTimeMillis()).put("reason", i);
    ...
    public void onRenderStall(long j, int i, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            if (jSONObjectCreateCommonLog != null) {
                try {
                    jSONObjectCreateCommonLog.put("event_key", "render_stall").put("type", z ? "video" : "audio").put("render_stall_time", j).put(KwaiQosInfo.VIDEO_BUFFER_TIME, this.mLogBundle.videoBufferTime).put(KwaiQosInfo.AUDIO_BUFFER_TIME, this.mLogBundle.audioBufferTime);
                    this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                    long j2 = this.mLogTotalCount;
                    if (j2 > 0) {
                        this.mLogTotalCount = j2 + 1;
    ...
    public void onError(int i, String str) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", com.component.feed.a.i).put("code", i).put(Config.LAUNCH_INFO, str);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    */
    public void onPrepare(int r12) {
        ...
        L26:
            ...
            r8 = 0
            if (r1 <= 0) goto L3d
            long r9 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> Lc7
        ...
        L3e:
            ...
            java.lang.String r5 = "prepare_result"
            org.json.JSONObject r4 = r0.put(r4, r5)     // Catch: org.json.JSONException -> Lc7
        ...
        L51:
            r9 = r2
        L52:
            org.json.JSONObject r4 = r4.put(r5, r9)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r5 = "result"
            org.json.JSONObject r12 = r4.put(r5, r12)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r4 = "sdk_params"
            java.lang.String r5 = r11.mSdkParams     // Catch: org.json.JSONException -> Lc7
            if (r5 != 0) goto L63
            goto L64
        L63:
            r2 = r5
        L64:
            org.json.JSONObject r12 = r12.put(r4, r2)     // Catch: org.json.JSONException -> Lc7
        ...
        L6e:
            r1 = r8
        L6f:
            org.json.JSONObject r12 = r12.put(r2, r1)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "first_audio_packet_dts"
            long r4 = r11.mFirstAudioPacketDTS     // Catch: org.json.JSONException -> Lc7
            org.json.JSONObject r12 = r12.put(r1, r4)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "previous_audio_packet_dts"
            long r4 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> Lc7
            org.json.JSONObject r12 = r12.put(r1, r4)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "stream_type"
            com.bykv.vk.component.ttvideo.log.LogBundle r2 = r11.mLogBundle     // Catch: org.json.JSONException -> Lc7
            int r2 = r2.mStreamType     // Catch: org.json.JSONException -> Lc7
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "suggest_format"
            java.lang.String r2 = r11.mSuggestFormat     // Catch: org.json.JSONException -> Lc7
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "suggest_protocol"
            java.lang.String r2 = r11.mSuggestProtocol     // Catch: org.json.JSONException -> Lc7
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc7
            java.lang.String r1 = "nnsr_enabled"
            com.bykv.vk.component.ttvideo.VideoLiveManager r2 = r11.mLiveEngine     // Catch: org.json.JSONException -> Lc7
            boolean r2 = r2.getSRState()     // Catch: org.json.JSONException -> Lc7
            if (r2 != 0) goto Lb1
            com.bykv.vk.component.ttvideo.VideoLiveManager r2 = r11.mLiveEngine     // Catch: org.json.JSONException -> Lc7
            boolean r2 = r2.getSharpenState()     // Catch: org.json.JSONException -> Lc7
            if (r2 == 0) goto Lb0
            goto Lb1
        Lb0:
            r3 = r8
        Lb1:
            r12.put(r1, r3)     // Catch: org.json.JSONException -> Lc7
        ...
        Lc7:
            r12 = move-exception
            com.bytedance.sdk.component.utils.mq.d(r12)
        Lcb:
            return
        */
    ...
    private void onLink(boolean z) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "link").put(Config.LAUNCH_INFO, z ? "start" : PointCategory.END);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    public void onIllegalAPICall(String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "illegal_call").put(com.alipay.sdk.m.p.e.k, str);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onCallNotInMainThread(String str) {
        ...
        try {
            jSONObjectCreateCommonLog.put("event_key", "call_not_in_main_thread").put(com.alipay.sdk.m.p.e.k, str);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j = this.mLogTotalCount;
            if (j > 0) {
                this.mLogTotalCount = j + 1;
    ...
    public void onErrorRecovered() {
        this.mIsInErrorRecovering = false;
        mq.d(TAG, "recover from error time ".concat(String.valueOf(System.currentTimeMillis() - this.mErrorStartTime)));
        ...
        public MyNTPTask(final LiveLoggerService liveLoggerService) {
            ...
            this.mHandler = new Handler(this.mHandlerThread.getLooper()) { // from class: com.bykv.vk.component.ttvideo.log.LiveLoggerService.MyNTPTask.1
                ...
                public void handleMessage(Message message) {
                    if (message == null || liveLoggerService.mHostNTPUrl == null || liveLoggerService.mHostNTPUrl.equals(ILogConst.CACHE_PLAY_REASON_NULL)) {
                        return;
                    }
