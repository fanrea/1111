...
public abstract class MediaPlayerClient {
    ...
    public void rotateCamera(float f, float f2) {
        mq.d("ttplayer", "<MediaPlayerClient.java,rotateCamera,55>rotateCamera is not implemented");
    }

    public int setIntOption(int i, int i2) {
        mq.d("ttplayer", "<MediaPlayerClient.java,setIntOption,65>set os player is not inval");
        return -1;
    }
}
