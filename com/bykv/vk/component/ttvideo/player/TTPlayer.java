...
public class TTPlayer {
        ...
        public boolean onLoadNativeLibs(List<String> list) {
            for (String str : list) {
                try {
                    ...
                    mq.c(TTPlayer.TAG, "load lib failed = " + th.getMessage());
                    return false;
                }
            }
            return true;
    ...
    public int setIntOption(int i, int i2) throws RemoteException {
        if (i == 22) {
            if (i2 == 0) {
                mq.d("ttplayer", "will occur anr crash");
            } else if (i2 == 2) {
                mq.d("ttplayer", "will occur native crash");
            } else if (i2 == 1) {
                Process.killProcess(Process.myPid());
                System.exit(0);
                mq.d("ttplayer", "will occur java crash");
                String str = null;
                str.endsWith("java");
                throw null;
            }
