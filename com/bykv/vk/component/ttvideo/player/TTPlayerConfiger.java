...
public final class TTPlayerConfiger {
    ...
    public static final String getAppFilesPath(Context context) {
        ...
        try {
            String absolutePath = hc.d(context.getApplicationContext()).getAbsolutePath();
    ...
    public static final String getAppCrashFilePath2(Context context) {
        if (context != null && APP_PATH == null) {
            APP_PATH = hc.d(context.getApplicationContext()).getAbsolutePath();
        }
        if (CRASH_FILE_PATH == null) {
            ...
            if (isPrintInfo()) {
                mq.d("ttplayer", "<TTPlayerConfigure.java,getAppCrashFilePath2,211>app files path:" + APP_PATH);
            }
            if (APP_PATH != null) {
        ...
        if (isPrintInfo()) {
            mq.d("ttplayer", "<TTPlayerConfigure.java,getAppCrashFileStorePath,195>carsh file path:" + CRASH_FILE_PATH);
        }
    ...
    public static final String getAppCrashFileStorePath(Context context) {
        ...
        if (CRASH_FILE_PATH == null) {
            ...
            if (isPrintInfo()) {
                mq.d("ttplayer", "<TTPlayerConfigure.java,getAppCrashFileStorePath,245>app files path:" + APP_PATH);
            }
            if (APP_PATH != null) {
                return APP_PATH + File.separatorChar + CRASH_FILE_NAME;
            }
        ...
        if (isPrintInfo()) {
            mq.d("ttplayer", "<TTPlayerConfigure.java,getAppCrashFileStorePath,253>carsh file path:" + CRASH_FILE_PATH);
        }
        return CRASH_FILE_PATH;
    }
    ...
    public static final String getAppCrashFilePath(Context context) {
        ...
        if (isPrintInfo()) {
            mq.d("ttplayer", "<TTPlayerConfigure.java,getAppCrashFileStorePath,278>carsh file path:" + CRASH_FILE_PATH);
        }
        return CRASH_FILE_PATH;
    }
    ...
    */
    public static final boolean copyFile(java.lang.String r4, java.lang.String r5, boolean r6, boolean r7) throws java.lang.Throwable {
        ...
        L86:
            ...
            goto L8f
        L8c:
            com.bytedance.sdk.component.utils.mq.d(r5)
        L8f:
            throw r4
        L90:
            r6 = r4
