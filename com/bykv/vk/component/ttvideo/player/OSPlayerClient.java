...
public class OSPlayerClient extends MediaPlayerClient {
    ...
    public void releaseAsync() {
        new b(new Runnable() { // from class: com.bykv.vk.component.ttvideo.player.OSPlayerClient.1
    ...
    public MediaPlayer.TrackInfo[] getTrackInfo() {
        if (this.mPlayer != null) {
            MediaPlayer.TrackInfo[] trackInfo = Build.VERSION.SDK_INT >= 16 ? this.mPlayer.getTrackInfo() : null;
            if (trackInfo != null) {
