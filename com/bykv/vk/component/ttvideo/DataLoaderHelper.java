...
public class DataLoaderHelper implements AVMDLDataLoaderListener, AVMDLStartCompleteListener {
    ...
    public class c {
        ...
        public class a {
            ...
            public boolean a() {
                ...
                List<C0154a> list = this.d;
                C0154a c0154a = list != null ? list.get(list.size() - 1) : null;
                if (this.f == null) {
                    return c0154a != null && this.b > 0 && c0154a.a + c0154a.b >= jMin;
                }
                return true;
            }
    ...
    private class d {
        ...
        public b b(b bVar) {
            ...
            while (it.hasNext() && (bVarC = c(it.next().a)) == null) {
            }
            return bVarC;
        }
    ...
    private void a(b bVar) {
        ...
        if (!z || (arrayListA = a(bVar.a)) == null || arrayListA.size() == 0) {
            return;
        }
    ...
    private boolean c(String str) {
        ...
        return (lowerCase.startsWith("http://127.0.0.1") || lowerCase.startsWith("http://localhost") || lowerCase.startsWith(MDL_PREFIX) || lowerCase.startsWith(UriUtils.FILE_PREFIX) || lowerCase.startsWith("/") || lowerCase.endsWith(".mpd") || lowerCase.contains(".mpd?")) ? false : true;
    }
