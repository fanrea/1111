...
public final class DnsHelper {
    ...
    public void configure(boolean z, String str) {
        this.mIsForceHttp = (!z || this.mNetworkClient == null || TextUtils.isEmpty(str) || str.equals(ILogConst.CACHE_PLAY_REASON_NULL)) ? false : true;
        this.mHttpDNSServerHost = str;
        mq.d(TAG, this.mIsForceHttp + this.mHttpDNSServerHost);
    }
    ...
    public void doLocalDns(String str) throws UnknownHostException {
        try {
            ...
            if (byName == null) {
                notifyParseComplete(false, str, null, new LiveError(-100010, "", null), true);
                return;
            }
            ...
            notifyParseComplete(false, str, null, new LiveError(-100010, "Unknown Host", map), true);
        }
    }
    ...
    public static String hostToIPUrl(String str, String str2) {
        ...
        boolean zStartsWith = str.startsWith(a.r);
