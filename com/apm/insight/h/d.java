...
public class d implements c {
    ...
    public void a(final long j, final Thread thread, final Throwable th, final String str, File file, final String str2, final boolean z) {
        ...
        com.apm.insight.entity.a aVarA = f.a().a(CrashType.JAVA, null, new c.a() { // from class: com.apm.insight.h.d.1
            long a = 0;
            ...
            public com.apm.insight.entity.a a(int i, com.apm.insight.entity.a aVar) {
                ...
                if (i != 0) {
                    if (i == 1) {
                        ...
                        if (zC) {
                            com.apm.insight.o.a.a(d.this.a, aVar.h());
                        }
                        ...
                        if (i == 5) {
                            ...
                            h.a(p.k(com.apm.insight.g.f()), CrashType.JAVA, "");
                        }
                    } else if (!zC) {
                        com.apm.insight.o.a.a(d.this.a, aVar.h());
                    }
