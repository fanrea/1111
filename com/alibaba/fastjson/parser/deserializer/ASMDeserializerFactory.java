...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig parserConfig, JavaBeanInfo javaBeanInfo) throws Exception {
        ...
        String str2 = "FastjsonASMDeserializer_" + this.seed.incrementAndGet() + Config.replace + cls.getSimpleName();
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        MethodWriter methodWriter = new MethodWriter(classWriter, 1, "deserialzeArrayMapping", sbAppend.append(str).append(";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;").toString(), null, null);
        ...
        methodWriter.visitMethodInsn(182, ASMUtils.type(JavaBeanDeserializer.class), "deserialzeArrayMapping", "(L" + str + ";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
            ...
            if (cls == Byte.TYPE || cls == Short.TYPE || cls == Integer.TYPE) {
                ...
                if (cls == Byte.class) {
                    ...
                    if (cls == String.class) {
                        ...
                        methodWriter.visitVarInsn(25, context.var("lexer"));
                        methodWriter.visitVarInsn(16, i6);
                        methodWriter.visitMethodInsn(182, ASMUtils.type(JavaBeanDeserializer.class), "scanEnum", "(L" + str8 + ";C)Ljava/lang/Enum;");
                        ...
                        if (Collection.class.isAssignableFrom(cls)) {
                            ...
                            if (collectionItemClass == String.class) {
                                ...
                                methodWriter.visitMethodInsn(182, str10, NetworkDefine.PARAM_TOKEN, "()I");
                                methodWriter.visitVarInsn(54, context.var(NetworkDefine.PARAM_TOKEN));
                                methodWriter.visitVarInsn(21, context.var(NetworkDefine.PARAM_TOKEN));
                                int i10 = i9 == 0 ? 14 : 16;
                                ...
                                methodWriter.visitVarInsn(25, 3);
                                c3 = 184;
                                methodWriter.visitMethodInsn(184, ASMUtils.type(JavaBeanDeserializer.class), "parseArray", "(Ljava/util/Collection;" + ASMUtils.desc((Class<?>) ObjectDeserializer.class) + "L" + str11 + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)V");
                            }
                            i = i4;
                            c2 = c3;
                            i2 = i7;
                            ...
                            methodWriter.visitVarInsn(25, context.var("lexer"));
                            methodWriter.visitMethodInsn(182, JSONLexerBase, NetworkDefine.PARAM_TOKEN, "()I");
    ...
    /* JADX WARN: Removed duplicated region for block: B:135:0x0edb  */
    /* JADX WARN: Removed duplicated region for block: B:136:0x0eff  */
    /*
    ...
    */
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor methodVisitor, Label label) {
        ...
        methodVisitor.visitMethodInsn(182, JSONLexerBase, NetworkDefine.PARAM_TOKEN, "()I");
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int i) {
        ...
        Label label4 = new Label();
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(182, str6, NetworkDefine.PARAM_TOKEN, "()I");
        ...
        methodVisitor.visitMethodInsn(185, strType, "deserialze", sbAppend.append(str7).append(";Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;").toString());
        ...
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(182, str2, NetworkDefine.PARAM_TOKEN, "()I");
