...
public class SerializeConfig {
    ...
    public void config(Class<?> cls, SerializerFeature serializerFeature, boolean z) throws SecurityException, ClassNotFoundException {
    ...
    public ObjectSerializer getObjectWriter(Class<?> cls, boolean z) throws SecurityException, ClassNotFoundException {
