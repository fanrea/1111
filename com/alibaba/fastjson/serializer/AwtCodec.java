...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (obj instanceof Point) {
            ...
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Color.class, '{'), t.k, color.getRed());
            serializeWriter.writeFieldValue(StringUtil.COMMA, "g", color.getGreen());
            serializeWriter.writeFieldValue(StringUtil.COMMA, t.l, color.getBlue());
            if (color.getAlpha() > 0) {
