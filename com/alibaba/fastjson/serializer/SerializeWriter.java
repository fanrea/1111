...
public final class SerializeWriter extends Writer {
    ...
    public SerializeWriter append(CharSequence charSequence) throws IOException {
        String string = charSequence == null ? ILogConst.CACHE_PLAY_REASON_NULL : charSequence.toString();
    ...
    public SerializeWriter append(CharSequence charSequence, int i, int i2) throws IOException {
        if (charSequence == null) {
            charSequence = ILogConst.CACHE_PLAY_REASON_NULL;
        }
    ...
    public void writeNull() {
        write(ILogConst.CACHE_PLAY_REASON_NULL);
    }
    ...
    */
    ...
    protected void writeStringWithSingleQuote(String str) {
        ...
        if (str == null) {
            ...
            ILogConst.CACHE_PLAY_REASON_NULL.getChars(0, 4, this.buf, this.count);
            this.count = i2;
            return;
        }
        int length = str.length();
