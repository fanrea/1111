...
public class ASMSerializerFactory implements Opcodes {
    ...
    static {
        ...
        ObjectSerializer_desc = "L" + strType + i.b;
        String strType2 = ASMUtils.type(SerializeWriter.class);
        SerializeWriter = strType2;
        SerializeWriter_desc = "L" + strType2 + i.b;
        JavaBeanSerializer = ASMUtils.type(JavaBeanSerializer.class);
        JavaBeanSerializer_desc = "L" + ASMUtils.type(JavaBeanSerializer.class) + i.b;
    ...
    public JavaBeanSerializer createJavaBeanSerializer(SerializeBeanInfo serializeBeanInfo) throws Exception {
        ...
        String str7 = "ASMSerializer_" + this.seed.incrementAndGet() + Config.replace + cls.getSimpleName();
        ...
        while (true) {
            ...
            int i7 = i6;
            MethodWriter methodWriter2 = new MethodWriter(classWriter3, 1, str5, sbAppend.append(str10).append(";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V").toString(), null, new String[]{"java/io/IOException"});
        ...
        if (z7) {
            ...
            StringBuilder sbAppend2 = new StringBuilder().append("(L");
            String str13 = JSONSerializer;
            str3 = "entity";
            MethodWriter methodWriter3 = new MethodWriter(classWriter5, 1, "writeUnsorted", sbAppend2.append(str13).append(";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V").toString(), null, new String[]{"java/io/IOException"});
        ...
        for (int i9 = 3; i8 < i9; i9 = i9) {
            ...
            StringBuilder sbAppend3 = new StringBuilder().append("(L");
            String str14 = JSONSerializer;
            MethodWriter methodWriter4 = new MethodWriter(classWriter5, 1, str4, sbAppend3.append(str14).append(";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V").toString(), null, new String[]{"java/io/IOException"});
                ...
                if (cls3 == Long.TYPE) {
                    ...
                    if (cls3.isEnum()) {
                        ...
                        if (List.class.isAssignableFrom(cls3)) {
                            ...
                            methodVisitor.visitMethodInsn(185, str29, "write", sbAppend.append(str30).append(str2).toString());
    ...
    private void generateWriteMethod(Class<?> cls, MethodVisitor methodVisitor, FieldInfo[] fieldInfoArr, Context context) throws Exception {
        ...
        if (!context.nonContext) {
            ...
            methodVisitor.visitMethodInsn(182, str5, "getContext", sbAppend.append(str6).toString());
        ...
        if (!context.writeDirect) {
            ...
            methodVisitor.visitMethodInsn(182, str7, "checkValue", sbAppend2.append(str8).append(")Z").toString());
    ...
    private void _writeObject(MethodVisitor methodVisitor, FieldInfo fieldInfo, Context context, Label label) {
        ...
        if (!Modifier.isPublic(cls.getModifiers()) || ParserConfig.isPrimitive2(cls)) {
            ...
            methodVisitor.visitMethodInsn(182, str2, str3, sbAppend.append(str4).append(";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V").toString());
            methodVisitor.visitJumpInsn(167, label8);
            methodVisitor.visitLabel(label7);
            methodVisitor.visitVarInsn(25, context.var("fied_ser"));
            methodVisitor.visitVarInsn(25, 1);
    ...
    private void _processValue(MethodVisitor methodVisitor, FieldInfo fieldInfo, Context context, Label label) {
        ...
        methodVisitor.visitMethodInsn(182, str, "processValue", "(L" + JSONSerializer + i.b + ASMUtils.desc((Class<?>) BeanContext.class) + "Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
        methodVisitor.visitVarInsn(58, Context.processValue);
        methodVisitor.visitVarInsn(25, Context.original);
        methodVisitor.visitVarInsn(25, Context.processValue);
