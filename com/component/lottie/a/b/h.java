...
public class h extends i<Integer> {
    public h(List<com.component.lottie.h.a<Integer>> list) {
        super(list);
    }
    ...
    int c(com.component.lottie.h.a<Integer> aVar, float f) {
        Integer num;
        ...
        return com.component.lottie.g.f.a(aVar.h(), aVar.i(), f);
    }
