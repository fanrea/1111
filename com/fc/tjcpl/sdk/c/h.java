...
public class h implements com.fc.tjcpl.sdk.e.c {
    public com.fc.tjcpl.sdk.c.b a;
    public com.fc.tjcpl.sdk.c.a b;
    public d g;
    ...
    public class b implements Runnable {
        ...
        public class a extends CountDownTimer {
            ...
            public void onFinish() {
                ...
                if (gVar != null) {
                    com.fc.tjcpl.sdk.i.c.c("DownloadTaskManager", "taskKey:" + b.this.a + ",retry download");
                    gVar.a(true);
        ...
        public void run() {
            ...
            if (hVar.a.d.f > 1000) {
                ...
                com.fc.tjcpl.sdk.i.c.c("DownloadTaskManager", "taskKey:" + this.a + ",retry download:" + h.this.a.d.f + " ms later");
                h.this.e.put(this.a, countDownTimerStart);
            } else {
                g gVar = hVar.d.get(this.a);
                if (gVar != null) {
                    com.fc.tjcpl.sdk.i.c.c("DownloadTaskManager", "taskKey:" + this.a + ",retry download");
                    gVar.a(true);
                    h.this.a.d.i.execute(gVar);
                }
            }
    ...
    public h(com.fc.tjcpl.sdk.c.a aVar) {
        this.b = aVar;
        this.a = new com.fc.tjcpl.sdk.c.b(aVar);
        this.g = new d(aVar.a);
        a();
    }
    ...
    public final String a(String str, String str2) {
        ...
        return com.fc.tjcpl.sdk.g.b.a(sbAppend.append(str2).toString());
    }
