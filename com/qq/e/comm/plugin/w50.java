...
class w50 extends x7.a {
    private final Property<w40, Float> b = new a(Float.class, "width");
    ...
    class a extends Property<w40, Float> {
        ...
        public Float get(w40 w40Var) {
            return Float.valueOf(w40Var.A() == null ? 0.0f : r1.getWidth());
        }
    }
    ...
    private static final class b extends Property<w40, Float> {
        ...
        public void set(w40 w40Var, Float f) {
            ...
            w40Var.l(Float.valueOf(f.floatValue() * this.b).intValue());
        }
    }
