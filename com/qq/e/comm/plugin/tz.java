...
public class tz implements yl {
    ...
    private Animator a(View view) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, "scaleX", 1.0f, 1.5f);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, "scaleY", 1.0f, 2.8f);
        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(view, "alpha", a());
    ...
    private Animator a(View view, float f) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, "scaleX", 1.0f, f, 1.0f);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, "scaleY", 1.0f, f, 1.0f);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void a(String str) {
        LinearLayout linearLayoutA = vp.a(this.b, str, c, 17, true);
        this.a = linearLayoutA;
        linearLayoutA.setId(10);
    }

    @Override // com.qq.e.comm.plugin.yl
