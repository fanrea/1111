...
public class DownloadService extends Service {
        ...
        public void run() {
            try {
                ...
                if (aPKDownloadServiceDelegate == null) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new RunnableC0692a(aPKDownloadServiceDelegate));
                }
            } catch (Throwable th) {
    ...
    public IBinder onBind(Intent intent) {
        ...
        new StringBuilder().append("DownloadService.onBind,appID=").append(stringExtra);
