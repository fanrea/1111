...
public class m extends RelativeLayout {
    ...
    public m(Context context, BaseAdUnit adUnit, final String title, String actionStr, float rating, String desc, int animType, int styleType, final String iconUrl, final int buttonColor, final int buttonTextColor, int click_type, final int barColor, final int barAlp, final float height) {
        super(context);
        this.a = Dips.asIntPixels(height, context);
    ...
    public void a(String logoUrl) {
        ...
        com.sigmob.sdk.base.common.g.a().getBitmap(logoUrl, new ImageManager.BitmapLoadedListener() { // from class: com.sigmob.sdk.base.views.m.4
