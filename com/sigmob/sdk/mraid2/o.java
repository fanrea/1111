    ...
    */
    public /* synthetic */ void a(boolean r3, int r4, int r5, com.sigmob.sdk.mraid2.g r6) {
        ...
        L26:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sigmob.sdk.mraid2.o.a(boolean, int, int, com.sigmob.sdk.mraid2.g):void");
    }
    ...
    public void a(final g view, int x, int y) {
        ...
        post(new Runnable() { // from class: com.sigmob.sdk.mraid2.o$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.a(zA, i, height, view);
            }
        });
    }
    ...
    public void b(int x, int y) {
        final int i = this.f - y;
        final int height = getChildAt(0).getHeight();
        post(new Runnable() { // from class: com.sigmob.sdk.mraid2.o$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.c(i, height);
            }
