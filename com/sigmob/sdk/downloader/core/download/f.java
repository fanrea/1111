...
public class f implements Runnable {
    ...
    void k() throws IOException {
        ...
        this.c = 0;
        a.InterfaceC0732a interfaceC0732aN = n();
        if (this.m.k()) {
            throw com.sigmob.sdk.downloader.core.exception.c.a;
        }
        aVarB.a().a(this.k, this.j, a());
        com.sigmob.sdk.downloader.core.interceptor.b bVar = new com.sigmob.sdk.downloader.core.interceptor.b(this.j, interfaceC0732aN.e(), g(), this.k);
        this.b.add(dVar);
        this.b.add(aVar);
        this.b.add(bVar);
        this.d = 0;
    ...
    public a.InterfaceC0732a n() throws IOException {
        if (this.m.k()) {
            throw com.sigmob.sdk.downloader.core.exception.c.a;
        }
