...
public final class e extends ScrollView implements ViewTreeObserver.OnGlobalLayoutListener, a, com.tk.core.component.c {
    ...
    public e(Context context) {
        ...
        this.UN = true;
        this.UO = true;
        this.UP = new Runnable() { // from class: com.tk.component.scroll.e.1
            @Override // java.lang.Runnable
            public final void run() {
                if (e.this.TA) {
                    return;
                }
                e.this.UL.aD(e.this.UC, e.this.UD);
            }
        };
        this.UQ = new Runnable() { // from class: com.tk.component.scroll.e.6
            @Override // java.lang.Runnable
            public final void run() {
                if (e.this.TA) {
                    return;
                }
                if (!e.this.TD && !e.this.UG) {
    ...
    public final void fling(int i) {
        ...
        postOnAnimationDelayed(new Runnable() { // from class: com.tk.component.scroll.e.2
            ...
            public final void run() {
                boolean z = true;
                if (e.this.Ux) {
                    if (e.this.UE && !this.US) {
                        this.US = true;
                        e.this.dg(0);
                        z = false;
                    }
                    if (z) {
                        com.tk.component.scroll.a.b bVar = e.this.UL;
                        e eVar = e.this;
                        bVar.f(eVar, eVar.UI, e.this.UJ);
                        e.this.setScrollState(0);
                        return;
                    }
    ...
    public final void a(final int i, int i2, long j) {
        ...
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(getScrollY(), i2);
        valueAnimatorOfInt.setDuration(j);
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tk.component.scroll.e.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                e.this.scrollTo(i, ((Integer) valueAnimator.getAnimatedValue()).intValue());
            }
        });
        valueAnimatorOfInt.addListener(new Animator.AnimatorListener() { // from class: com.tk.component.scroll.e.4
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                e eVar = e.this;
                eVar.postOnAnimationDelayed(eVar.UQ, 60L);
            }
