...
public final class c implements com.tk.core.manager.a.a<b>, com.tk.core.manager.a.c {
    ...
    public final String hG() {
        return "2#position#0,2#eventState#1,2#motionType#2,2#data#3,2#type#4,";
    }
    ...
    */
    public final boolean g(java.lang.String r7) {
        ...
        L4b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tk.core.e.b.c.g(java.lang.String):boolean");
    }
    ...
    public final boolean b(Object obj, String str, Object obj2) {
        ...
        try {
            ...
            if (c == 0) {
                bVar.o((HashMap) V8ObjectUtilsQuick.getValue(obj2));
            } else if (c == 1 || c == 2) {
                bVar.setState(com.tk.core.manager.a.f.h((Number) obj2));
            } else if (c == 3) {
                bVar.n((HashMap) V8ObjectUtilsQuick.getValue(obj2));
            } else if (c == 4) {
                bVar.bX((String) obj2);
            } else {
                if (!t.isDebug()) {
                ...
                Log.e("TKDownEvent", "call applyProp() with unsupported prop: " + str);
                return false;
            }
            return true;
        } catch (Exception e) {
            throw new RuntimeException("TKDownEvent apply " + str + " error: " + e.getLocalizedMessage() + "\narg: " + com.tk.core.bridge.b.z(obj2), e);
        }
    }
    ...
    */
    public final java.lang.Object a(java.lang.Object r6, java.lang.String r7) {
        /*
            r5 = this;
            com.tk.core.e.b.b r6 = (com.tk.core.e.b.b) r6
            int r0 = r7.hashCode()
            r1 = 4
            r2 = 3
            r3 = 2
        ...
        L41:
            ...
            java.lang.String r7 = "TKDownEvent"
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tk.core.e.b.c.a(java.lang.Object, java.lang.String):java.lang.Object");
    }
    ...
    public final Map<String, Object> I(Object obj) {
        ...
        b bVar = (b) obj;
        map.put("position", bVar.ahR);
        map.put("eventState", Integer.valueOf(bVar.ahQ));
        map.put("motionType", Integer.valueOf(bVar.state));
        map.put("data", bVar.ahP);
        map.put("type", bVar.type);
        return map;
    }
}
