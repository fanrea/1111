...
public class GLHDR2SDRFilter extends GLDefaultFilter {
    ...
    public int init(Bundle bundle) {
        ...
        int iGlGetUniformLocation = GLES20.glGetUniformLocation(this.mProgram, "uCMSmatrix");
        this.mCMSmatrixHandle = iGlGetUniformLocation;
        GLES20.glUniformMatrix3fv(iGlGetUniformLocation, 1, false, this.mREC2020toREC709Matrix, 0);
        ...
        TextureRenderLog.i(this.mTexType, LOG_TAG, "init bundle:" + bundle.toString());
        return 0;
    }
    ...
    public void setOption(int i, int i2) {
        if (i == 8) {
            this.mHDRType = i2;
            TextureRenderLog.i(this.mTexType, LOG_TAG, "mHDRType:" + i2);
        } else {
