...
final class AudioTrackPositionTracker {
    ...
    private void maybeUpdateLatency(long j) {
        ...
        try {
            long jIntValue = (((Integer) method.invoke(this.audioTrack, new Object[0])).intValue() * 1000) - this.bufferSizeUs;
            ...
            if (jMax > 5000000) {
                Listener listener = this.listener;
                if (listener != null) {
                    listener.onInvalidLatency(jMax);
                }
                this.latencyUs = 0L;
            }
    ...
    private long getPlaybackHeadPosition() {
        ...
        long playbackHeadPosition = C00oOOo.f362O8oO888 & audioTrack.getPlaybackHeadPosition();
        if (this.needsPassthroughWorkarounds) {
