...
public class DownloadHandleService extends Service {
    private static final String d = "DownloadHandleService";
    ...
    private void d(Intent intent) {
        ...
        if (action.equals("com.ss.android.downloader.action.DOWNLOAD_WAKEUP")) {
            com.ss.android.socialbase.downloader.downloader.b.mk().execute(new Runnable() { // from class: com.ss.android.socialbase.downloader.impls.DownloadHandleService.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        com.ss.android.socialbase.downloader.downloader.c.d().uo(intExtra);
                    } catch (Exception e) {
            ...
            com.ss.android.socialbase.downloader.downloader.c.d().k(intExtra);
