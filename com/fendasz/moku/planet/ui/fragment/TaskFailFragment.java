...
public class TaskFailFragment extends BaseFragment {
    ...
    private void initListener() {
        ...
        taskRecordDataListAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() { // from class: com.fendasz.moku.planet.ui.fragment.TaskFailFragment$$ExternalSyntheticLambda0
            @Override // com.fendasz.moku.planet.ui.base.adapter.BaseRecyclerAdapter.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.m441x4b516308(taskRecordDataListAdapter, view, i);
            }
        });
        this.mPullToRefreshView.setStatus(Status.I_KNOW);
        this.mPullToRefreshView.initData(taskRecordDataListAdapter, new RefreshableRecyclerView.RefreshListener() { // from class: com.fendasz.moku.planet.ui.fragment.TaskFailFragment.1
            @Override // com.fendasz.moku.planet.ui.customview.RefreshableRecyclerView.RefreshListener
            public void refresh() {
                TaskFailFragment.this.getTaskList();
            }
        });
    }

    /* renamed from: lambda$initListener$0$com-fendasz-moku-planet-ui-fragment-TaskFailFragment, reason: not valid java name */
    /* synthetic */ void m441x4b516308(TaskRecordDataListAdapter taskRecordDataListAdapter, View view, int i) {
