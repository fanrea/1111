...
public final class SCInteractiveChatApply extends MessageNano {
    private static volatile SCInteractiveChatApply[] _emptyArray;
    ...
    public final SCInteractiveChatApply clear() {
    ...
    public final int computeSerializedSize() {
        ...
        return !this.operationId.equals("") ? iComputeSerializedSize + CodedOutputByteBufferNano.computeStringSize(9, this.operationId) : iComputeSerializedSize;
    }

    @Override // com.google.protobuf.nano.MessageNano
    public final SCInteractiveChatApply mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCInteractiveChatApply parseFrom(byte[] bArr) {
        return (SCInteractiveChatApply) MessageNano.mergeFrom(new SCInteractiveChatApply(), bArr);
    }

    public static SCInteractiveChatApply parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
