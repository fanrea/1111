    ...
    public JSONObject a() throws JSONException {
        ...
        try {
            ...
            try {
                ...
                if (hVar.b(df.aL, 1) == 1) {
                    String strAeG = com.kwad.sdk.e.b.aeR().aeG();
                    if (!TextUtils.isEmpty(strAeG)) {
                        jSONObject.put("11102", strAeG);
                    }
                    jSONObject.put("11104", com.kwad.sdk.e.b.aeR().aeN());
                    jSONObject.put("11105", com.kwad.sdk.e.b.aeR().getDeviceId());
                    jSONObject.put("11106", com.kwad.sdk.e.b.aeR().getIccId());
                    jSONObject.put("11107", com.kwad.sdk.e.b.aeR().aeF());
                    jSONObject.put("11108", com.kwad.sdk.e.b.aeR().aeI());
                    jSONObject.put("11109", com.kwad.sdk.e.b.aeR().aeJ());
                    jSONObject.put("11110", com.kwad.sdk.e.b.aeR().aeK());
                    jSONObject.put("11111", com.kwad.sdk.e.b.aeR().getIp());
                    jSONObject.put("11112", com.kwad.sdk.e.b.aeR().getLocation());
                    jSONObject.put("11113", com.kwad.sdk.e.b.aeR().getOaid());
                    jSONObject.put("11114", com.kwad.sdk.e.b.aeR().aeH());
                    jSONObject.put("11115", com.kwad.sdk.e.b.aeR().aeM());
                    jSONObject.put("11116", com.kwad.sdk.e.b.aeR().aeL());
                    jSONObject.put("11202", bh.b(com.kwad.sdk.e.b.aeR().aeG()));
                    jSONObject.put("11204", bh.b(com.kwad.sdk.e.b.aeR().aeN()));
                    jSONObject.put("11205", bh.b(com.kwad.sdk.e.b.aeR().getDeviceId()));
                    jSONObject.put("11206", bh.b(com.kwad.sdk.e.b.aeR().getIccId()));
                    jSONObject.put("11207", bh.b(com.kwad.sdk.e.b.aeR().aeF()));
                    jSONObject.put("11208", bh.b(com.kwad.sdk.e.b.aeR().aeI()));
                    jSONObject.put("11209", bh.b(com.kwad.sdk.e.b.aeR().aeJ()));
                    jSONObject.put("11210", bh.b(com.kwad.sdk.e.b.aeR().aeK()));
                    jSONObject.put("11211", bh.b(com.kwad.sdk.e.b.aeR().getIp()));
                    jSONObject.put("11212", bh.b(com.kwad.sdk.e.b.aeR().getLocation()));
                    jSONObject.put("11213", bh.b(com.kwad.sdk.e.b.aeR().getOaid()));
                    jSONObject.put("11214", bh.b(com.kwad.sdk.e.b.aeR().aeH()));
                    jSONObject.put("11215", bh.b(com.kwad.sdk.e.b.aeR().aeM()));
                    jSONObject.put("11216", bh.b(com.kwad.sdk.e.b.aeR().aeL()));
                    jSONObject.put("11301", bh.c(com.kwad.sdk.e.b.aeR().aeQ()));
                    jSONObject.put("11302", bh.c(com.kwad.sdk.e.b.aeR().getSdkVersion()));
                    jSONObject.put("11303", bh.c(com.kwad.sdk.e.b.aeR().getAppId()));
                }
            ...
            try {
                ...
                String string3 = Settings.System.getString(cnVar.a.getContentResolver(), "power_on_times");
                if (!TextUtils.isEmpty(string3)) {
                    jSONObject.put("03091", string3);
                }
                String string4 = Settings.System.getString(cnVar.a.getContentResolver(), "first_boot_flag");
