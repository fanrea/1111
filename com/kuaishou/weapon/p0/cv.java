...
public class cv {
    ...
    public static String a(Context context) {
        ...
        for (Map.Entry entry : mapD.entrySet()) {
            str = str + com.alipay.sdk.m.s.a.n + ((String) entry.getKey()) + "=" + ((String) entry.getValue());
        }
        return str.substring(1);
    }
    ...
    public static JSONObject b(Context context) throws JSONException {
        try {
            ...
            jSONObject.put(com.baidu.mobads.upgrade.remote.gray.c.l, cm.b(context));
            jSONObject.put("iv", com.alipay.sdk.m.x.c.c);
            return jSONObject;
        } catch (Exception unused) {
            return null;
        }
