...
public final class SCVoicePartyVideoClosed extends MessageNano {
    private static volatile SCVoicePartyVideoClosed[] _emptyArray;
    public String liveStreamId;
    public LiveStreamMessages.MicSeatDetailInfo[] micSeatDetailInfo;
    public int micSeatsVersion;
    public String voicePartyId;

    public static SCVoicePartyVideoClosed[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCVoicePartyVideoClosed[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCVoicePartyVideoClosed() {
        clear();
    }

    public final SCVoicePartyVideoClosed clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCVoicePartyVideoClosed mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCVoicePartyVideoClosed parseFrom(byte[] bArr) {
        return (SCVoicePartyVideoClosed) MessageNano.mergeFrom(new SCVoicePartyVideoClosed(), bArr);
    }

    public static SCVoicePartyVideoClosed parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCVoicePartyVideoClosed().mergeFrom(codedInputByteBufferNano);
    }
}
