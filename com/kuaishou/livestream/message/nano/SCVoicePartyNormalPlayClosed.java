...
public final class SCVoicePartyNormalPlayClosed extends MessageNano {
    private static volatile SCVoicePartyNormalPlayClosed[] _emptyArray;
    public String liveStreamId;
    public LiveStreamMessages.MicSeatDetailInfo[] micSeatDetailInfo;
    public int micSeatsVersion;
    public String voicePartyId;

    public static SCVoicePartyNormalPlayClosed[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCVoicePartyNormalPlayClosed[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCVoicePartyNormalPlayClosed() {
        clear();
    }

    public final SCVoicePartyNormalPlayClosed clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCVoicePartyNormalPlayClosed mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCVoicePartyNormalPlayClosed parseFrom(byte[] bArr) {
        return (SCVoicePartyNormalPlayClosed) MessageNano.mergeFrom(new SCVoicePartyNormalPlayClosed(), bArr);
    }

    public static SCVoicePartyNormalPlayClosed parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCVoicePartyNormalPlayClosed().mergeFrom(codedInputByteBufferNano);
    }
}
