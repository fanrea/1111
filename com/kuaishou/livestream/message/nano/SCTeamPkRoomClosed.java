...
public final class SCTeamPkRoomClosed extends MessageNano {
    private static volatile SCTeamPkRoomClosed[] _emptyArray;
    ...
    public static SCTeamPkRoomClosed[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCTeamPkRoomClosed[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCTeamPkRoomClosed() {
        clear();
    }

    public final SCTeamPkRoomClosed clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
        this.pkRoomId = "";
    ...
    public final int computeSerializedSize() {
        ...
        if (micSeatDetailInfoArr != null && micSeatDetailInfoArr.length > 0) {
            ...
            while (true) {
                ...
                LiveStreamMessages.MicSeatDetailInfo micSeatDetailInfo = micSeatDetailInfoArr2[i];
                if (micSeatDetailInfo != null) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(4, micSeatDetailInfo);
                }
                i++;
            }
        }
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCTeamPkRoomClosed mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCTeamPkRoomClosed parseFrom(byte[] bArr) {
        return (SCTeamPkRoomClosed) MessageNano.mergeFrom(new SCTeamPkRoomClosed(), bArr);
    }

    public static SCTeamPkRoomClosed parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCTeamPkRoomClosed().mergeFrom(codedInputByteBufferNano);
    }
}
