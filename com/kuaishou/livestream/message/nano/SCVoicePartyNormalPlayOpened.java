...
public final class SCVoicePartyNormalPlayOpened extends MessageNano {
    private static volatile SCVoicePartyNormalPlayOpened[] _emptyArray;
    ...
    public static SCVoicePartyNormalPlayOpened[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCVoicePartyNormalPlayOpened[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCVoicePartyNormalPlayOpened() {
        clear();
    }

    public final SCVoicePartyNormalPlayOpened clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCVoicePartyNormalPlayOpened mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCVoicePartyNormalPlayOpened parseFrom(byte[] bArr) {
        return (SCVoicePartyNormalPlayOpened) MessageNano.mergeFrom(new SCVoicePartyNormalPlayOpened(), bArr);
    }

    public static SCVoicePartyNormalPlayOpened parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCVoicePartyNormalPlayOpened().mergeFrom(codedInputByteBufferNano);
    }
}
