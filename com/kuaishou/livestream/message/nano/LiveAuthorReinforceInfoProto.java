...
public interface LiveAuthorReinforceInfoProto {
    ...
    public static final class SCLiveAuthorReinforceInfo extends MessageNano {
        ...
        public final SCLiveAuthorReinforceInfo clear() {
            this.id = 0L;
            this.biz = "";
            this.priority = 0;
        ...
        @Override // com.google.protobuf.nano.MessageNano
        public final SCLiveAuthorReinforceInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
            while (true) {
        ...
        public static SCLiveAuthorReinforceInfo parseFrom(byte[] bArr) {
            return (SCLiveAuthorReinforceInfo) MessageNano.mergeFrom(new SCLiveAuthorReinforceInfo(), bArr);
        }

        public static SCLiveAuthorReinforceInfo parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
