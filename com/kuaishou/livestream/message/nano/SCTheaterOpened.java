...
public final class SCTheaterOpened extends MessageNano {
    private static volatile SCTheaterOpened[] _emptyArray;
    ...
    public static SCTheaterOpened[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCTheaterOpened[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCTheaterOpened() {
        clear();
    }

    public final SCTheaterOpened clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
        this.theaterId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCTheaterOpened mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCTheaterOpened parseFrom(byte[] bArr) {
        return (SCTheaterOpened) MessageNano.mergeFrom(new SCTheaterOpened(), bArr);
    }

    public static SCTheaterOpened parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCTheaterOpened().mergeFrom(codedInputByteBufferNano);
    }
}
