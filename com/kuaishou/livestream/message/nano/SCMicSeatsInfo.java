...
public final class SCMicSeatsInfo extends MessageNano {
    private static volatile SCMicSeatsInfo[] _emptyArray;
    ...
    public final SCMicSeatsInfo clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCMicSeatsInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
