...
public final class SCTeamPkStart extends MessageNano {
    private static volatile SCTeamPkStart[] _emptyArray;
    ...
    public static SCTeamPkStart[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SCTeamPkStart[0];
                }
            }
        }
        return _emptyArray;
    ...
    public SCTeamPkStart() {
        clear();
    }

    public final SCTeamPkStart clear() {
        this.liveStreamId = "";
        this.voicePartyId = "";
        this.pkRoomId = "";
        this.pkId = "";
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final SCTeamPkStart mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static SCTeamPkStart parseFrom(byte[] bArr) {
        return (SCTeamPkStart) MessageNano.mergeFrom(new SCTeamPkStart(), bArr);
    }

    public static SCTeamPkStart parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new SCTeamPkStart().mergeFrom(codedInputByteBufferNano);
    }
}
