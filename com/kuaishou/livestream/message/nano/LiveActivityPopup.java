...
public final class LiveActivityPopup extends MessageNano {
    private static volatile LiveActivityPopup[] _emptyArray;
    ...
    public final LiveActivityPopup clear() {
    ...
    @Override // com.google.protobuf.nano.MessageNano
    public final LiveActivityPopup mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws InvalidProtocolBufferNanoException {
        while (true) {
    ...
    public static LiveActivityPopup parseFrom(byte[] bArr) {
        return (LiveActivityPopup) MessageNano.mergeFrom(new LiveActivityPopup(), bArr);
    }

    public static LiveActivityPopup parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
