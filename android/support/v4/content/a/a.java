    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayA = a(resources, theme, attributeSet, a.b.ColorStateListItem);
                int color = typedArrayA.getColor(a.b.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (typedArrayA.hasValue(a.b.ColorStateListItem_android_alpha)) {
                    f = typedArrayA.getFloat(a.b.ColorStateListItem_android_alpha, 1.0f);
                } else if (typedArrayA.hasValue(a.b.ColorStateListItem_alpha)) {
                    f = typedArrayA.getFloat(a.b.ColorStateListItem_alpha, 1.0f);
                }
                typedArrayA.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != a.C0002a.alpha) {
                        int i5 = i3 + 1;
                ...
                iArrA = c.a(iArrA, i2, a(color, f));
                iArr = (int[][]) c.a(iArr, i2, iArrTrimStateSet);
                i2++;
            }
            i = 1;
        }
