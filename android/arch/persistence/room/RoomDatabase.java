...
public abstract class RoomDatabase {
    ...
    public enum JournalMode {
        ...
        final JournalMode resolve(Context context) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && (activityManager = (ActivityManager) context.getSystemService("activity")) != null && !b.a(activityManager)) {
    ...
    public static class MigrationContainer {
        private l<l<Migration>> mMigrations = new l<>();
        ...
        private void addMigration(Migration migration) {
            ...
            l<Migration> lVar = this.mMigrations.get(i);
            if (lVar == null) {
                lVar = new l<>();
                this.mMigrations.put(i, lVar);
            }
            Migration migration2 = lVar.get(i2);
            if (migration2 != null) {
                Log.w(androidx.room.Room.LOG_TAG, "Overriding migration " + migration2 + " with " + migration);
            }
            lVar.append(i2, migration);
        }
        ...
        */
        private java.util.List<android.arch.persistence.room.migration.Migration> findUpMigrationPath(java.util.List<android.arch.persistence.room.migration.Migration> r11, boolean r12, int r13, int r14) {
            ...
            Lc:
                if (r13 <= r14) goto L4d
            Le:
                android.support.v4.d.l<android.support.v4.d.l<android.arch.persistence.room.migration.Migration>> r3 = r10.mMigrations
                java.lang.Object r3 = r3.get(r13)
                android.support.v4.d.l r3 = (android.support.v4.d.l) r3
                r4 = 0
                if (r3 != 0) goto L1a
                return r4
            L1a:
