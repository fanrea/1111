...
public class TableInfo {
        ...
        try {
            if (cursorQuery.getColumnCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    map.put(string, new Column(string, cursorQuery.getString(columnIndex2), cursorQuery.getInt(columnIndex3) != 0, cursorQuery.getInt(columnIndex4)));
                }
            }
            return map;
        } finally {
    ...
    public static class Column {
        ...
        public int hashCode() {
            return (((((this.name.hashCode() * 31) + this.affinity) * 31) + (this.notNull ? SocketMessages.PayloadType.SC_LIVE_QUIZ3_PARTICIPATE_WINNER_CALCULATION : SocketMessages.PayloadType.SC_LIVE_CNY2024_BULLET_PLAY_WATCH_TASK_INFO)) * 31) + this.primaryKeyPosition;
        }
